(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-sidebar",ev:"0.2",l:false,f:(function(AMP,_){
(function() {
  ...
  var AmpSidebar = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    AmpSidebar2.prerenderAllowed = function prerenderAllowed() {
      return true;
    };
    ...
    _proto.dismiss_ = function dismiss_(immediate, trust) {
      var _this9 = this;
      if (!this.opened_) {
        return false;
      }
    ...
    _proto.handleSwipe_ = function handleSwipe_(data) {
      if (data.first) {
