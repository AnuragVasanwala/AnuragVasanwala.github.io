(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-redbull-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpRedBullPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    var _proto = AmpRedBullPlayer2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      return isLayoutSizeDefined(layout);
    };
    _proto.buildCallback = function buildCallback() {
      var element = this.element;
      userAssert2(element.getAttribute("data-param-videoid"), "The data-param-videoid attribute is required for %s", element);
  ...
  AMP.registerElement(TAG2, AmpRedBullPlayer);
})();
