(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-instagram",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  // build/amp-instagram-0.1.css.js
  var CSS2 = "amp-instagram.amp-instagram-default-framing{border:1px solid #dbdbdb!important}\n/*# sourceURL=/extensions/amp-instagram/0.1/amp-instagram.css*/";
  ...
  var AmpInstagram = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpInstagram2, _AMP$BaseElement);
    var _super = _createSuper(AmpInstagram2);
    function AmpInstagram2(element) {
      var _this;
    ...
    _proto.preconnectCallback = function preconnectCallback(opt_onLayout) {
      ...
      Services.preconnectFor(this.win).url(this.getAmpDoc(), "https://instagram.fsnc1-1.fna.fbcdn.net", opt_onLayout);
    };
    _proto.renderOutsideViewport = function renderOutsideViewport() {
      return false;
    };
    _proto.buildCallback = function buildCallback() {
      this.shortcode_ = userAssert2(this.element.getAttribute("data-shortcode") || this.element.getAttribute("shortcode"), "The data-shortcode attribute is required for <amp-instagram> %s", this.element);
    ...
    _proto.handleInstagramMessages_ = function handleInstagramMessages_(event) {
      var _this3 = this;
      ...
      if (data["type"] == "MEASURE" && data["details"]) {
        ...
        this.getVsync().measure(function() {
          if (_this3.iframe_ && _this3.iframe_.offsetHeight !== height) {
  ...
  AMP.registerElement("amp-instagram", AmpInstagram, CSS2);
})();
