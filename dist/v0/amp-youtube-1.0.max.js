(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-youtube",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-youtube/1.0/component.js
  var _excluded3 = ["autoplay", "loop", "videoid", "liveChannelid", "onLoad", "params", "credentials"];
  function _extends9() {
  ...
  function BentoYoutubeWithRef(_ref, ref) {
    var autoplay = _ref.autoplay, loop = _ref.loop, videoid = _ref.videoid, liveChannelid = _ref.liveChannelid, onLoad = _ref.onLoad, _ref$params = _ref.params, params = _ref$params === void 0 ? {} : _ref$params, credentials = _ref.credentials, rest = _objectWithoutPropertiesLoose6(_ref, _excluded3);
    var datasourceExists = !(videoid && liveChannelid) && (videoid || liveChannelid);
    if (!datasourceExists) {
      throw new Error("Exactly one of data-videoid or data-live-channelid should be present for <amp-youtube>");
    }
    ...
    var onMessage = function onMessage2(_ref2) {
      var currentTarget = _ref2.currentTarget, data = _ref2.data;
      ...
      if (event == "infoDelivery" && playerState == 0 && loop) {
        currentTarget.contentWindow.postMessage(JSON.stringify(dict({
          "event": "command",
          "func": "playVideo"
        })), "*");
      }
      if (event == "infoDelivery" && playerState != void 0) {
        dispatchVideoEvent(currentTarget, PlayerStates[playerState.toString()]);
      }
      if (event == "infoDelivery" && parsedInfo["muted"]) {
        dispatchVideoEvent(currentTarget, mutedOrUnmutedEvent(parsedInfo["muted"]));
        return;
      }
    };
  ...
  function getEmbedUrl(credentials, videoid, liveChannelid) {
    ...
    if (videoid) {
      ...
      descriptor = "live_stream?channel=" + encodeURIComponent(liveChannelid || "") + "&";
    }
  ...
  var BentoYoutube = forwardRef(BentoYoutubeWithRef);
  BentoYoutube.displayName = "BentoYoutube";
  ...
  // extensions/amp-youtube/1.0/base-element.js
  ...
  BaseElement3["Component"] = BentoYoutube;
  ...
  // build/amp-youtube-1.0.css.js
  var CSS4 = "amp-youtube{display:block;overflow:hidden;position:relative}amp-youtube:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-youtube/1.0/amp-youtube.css*/";
  ...
  var TAG2 = "amp-youtube";
  var AmpYoutube = /* @__PURE__ */ function(_BaseElement) {
    _inherits6(AmpYoutube2, _BaseElement);
    var _super = _createSuper6(AmpYoutube2);
    function AmpYoutube2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpYoutube2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-youtube"), 'expected global "bento" or specific "bento-youtube" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpYoutube2;
  }(BaseElement3);
  AMP.registerElement(TAG2, AmpYoutube, CSS4);
})();
...
//# sourceMappingURL=amp-youtube-1.0.max.js.map
