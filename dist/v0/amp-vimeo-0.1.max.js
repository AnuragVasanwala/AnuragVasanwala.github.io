(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-vimeo",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TAG2 = "amp-vimeo";
  var AmpVimeo = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpVimeo2, _AMP$BaseElement);
    var _super = _createSuper(AmpVimeo2);
    function AmpVimeo2(element) {
      var _this;
      _this = _super.call(this, element);
      _this.iframe_ = null;
      _this.onReadyOnce_ = once(function() {
    ...
    _proto.preconnectCallback = function preconnectCallback(onLayout) {
      ...
      preconnect.url(ampdoc2, "https://player.vimeo.com", onLayout);
      preconnect.url(ampdoc2, "https://i.vimeocdn.com", onLayout);
      preconnect.url(ampdoc2, "https://f.vimeocdn.com", onLayout);
    };
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      var videoid = userAssert2(element.getAttribute("data-videoid"), "The data-videoid attribute is required for <amp-vimeo> %s", element);
      return this.isAutoplay_().then(function(isAutoplay) {
        return _this2.buildIframe_(getVimeoIframeSrc(videoid, isAutoplay, _this2.element.hasAttribute("do-not-track")));
      });
    };
    _proto.buildIframe_ = function buildIframe_(src) {
    ...
    _proto.isAutoplay_ = function isAutoplay_() {
    ...
    _proto.sendCommand_ = function sendCommand_(method, params) {
  ...
  AMP.registerElement(TAG2, AmpVimeo);
})();
