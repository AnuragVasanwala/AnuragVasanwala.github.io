(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-mathml",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  // build/amp-mathml-0.1.css.js
  var CSS2 = "amp-mathml[inline]{display:inline-block;vertical-align:middle}\n/*# sourceURL=/extensions/amp-mathml/0.1/amp-mathml.css*/";
  ...
  var AmpMathml = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpMathml2, _AMP$BaseElement);
    var _super = _createSuper(AmpMathml2);
    function AmpMathml2(element) {
      var _this;
    ...
    _proto.layoutCallback = function layoutCallback() {
      var _this3 = this;
      var iframe = getIframe(this.win, this.element, "mathml");
      ...
      listenFor(iframe, "embed-size", function(data) {
        ...
        Services.mutatorForDoc(_this3.getAmpDoc()).forceChangeSize(_this3.element, data["height"], data["width"]);
      }, true);
  ...
  AMP.registerElement("amp-mathml", AmpMathml, CSS2);
})();
