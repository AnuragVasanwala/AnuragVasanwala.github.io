(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-mowplayer",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpMowplayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpMowplayer2, _AMP$BaseElement);
    var _super = _createSuper(AmpMowplayer2);
    function AmpMowplayer2(element) {
      var _this;
      ...
      _this.baseUrl_ = "https://mowplayer.com/watch/";
      _this.pauseHelper_ = new PauseHelper(_this.element);
      return _this;
    }
    var _proto = AmpMowplayer2.prototype;
    ...
    _proto.buildCallback = function buildCallback() {
      this.mediaid_ = userAssert2(this.element.getAttribute("data-mediaid"), "/The data-mediaid attribute is required for <amp-mowplayer> %s", this.element);
      var deferred = new Deferred();
    ...
    _proto.getVideoIframeSrc_ = function getVideoIframeSrc_() {
      ...
      return this.videoIframeSrc_ = this.baseUrl_ + encodeURIComponent(this.mediaid_);
    };
    _proto.layoutCallback = function layoutCallback() {
      var _this2 = this;
      var iframe = createFrameFor(this, this.getVideoIframeSrc_());
      this.iframe_ = iframe;
      this.unlistenMessage_ = listen(this.win, "message", this.handleMowMessage_.bind(this));
    ...
    _proto.sendCommand_ = function sendCommand_(command, opt_args) {
      ...
      this.playerReadyPromise_.then(function() {
        if (_this3.iframe_ && _this3.iframe_.contentWindow) {
          ...
          _this3.iframe_.contentWindow.postMessage(message, "https://mowplayer.com");
        }
      });
    };
    _proto.handleMowMessage_ = function handleMowMessage_(event) {
      ...
      if (eventType === "set_aspect_ratio") {
        this.attemptChangeHeight(info["new_height"]).catch(function() {
        });
      }
    ...
    _proto.listenToFrame_ = function listenToFrame_() {
      ...
      this.sendCommand_("listening", ["amp", window.location.href, window.location.origin, true]);
    };
    _proto.supportsPlatform = function supportsPlatform() {
      return true;
    };
    ...
    return AmpMowplayer2;
  }(AMP.BaseElement);
  AMP.registerElement(TAG2, AmpMowplayer);
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
})});
//# sourceMappingURL=amp-mowplayer-0.1.max.js.map
