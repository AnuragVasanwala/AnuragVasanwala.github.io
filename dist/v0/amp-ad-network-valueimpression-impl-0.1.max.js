(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-ad-network-valueimpression-impl",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-ad-network-valueimpression-impl/0.1/flexible-ad-slot-utils.js
  ...
  var Expander = /* @__PURE__ */ function() {
    ...
    _proto.evaluateBinding_ = function evaluateBinding_(bindingInfo, opt_args) {
      ...
      if (bindingInfo.prioritized != void 0) {
        ...
        user().error(TAG3, "ignoring async replacement key: ", bindingInfo.name);
        binding = "";
      } else {
    ...
    _proto.evaluateBindingSync_ = function evaluateBindingSync_(binding, name, opt_args) {
      try {
        ...
        if (value && typeof value.then == "function") {
          user().error(TAG3, "ignoring async macro resolution");
          result = "";
  ...
  var VariableSource = /* @__PURE__ */ function() {
    ...
    _proto.getExpr = function getExpr(opt_bindings, opt_allowlist) {
      ...
      var all = _extends4({}, this.replacements_, opt_bindings);
  ...
  var GlobalVariableSource = /* @__PURE__ */ function(_VariableSource) {
        ...
        return Services.cidForDoc(_this3.ampdoc).then(function(cid) {
          ...
          if (cid && cookieName == "_ga") {
            if (typeof cid === "string") {
              ...
              dev().error(TAG4, "non-string cid, what is it?", Object.keys(cid));
            }
          }
          clientIds[scope] = cid;
          return cid;
    ...
    _proto.getAccessValue_ = function getAccessValue_(getter, expr) {
      ...
      return Promise.all([Services.accessServiceForDocOrNull(element), Services.subscriptionsServiceForDocOrNull(element)]).then(function(services) {
        ...
        if (!service) {
          user().error(TAG4, "Access or subsciptions service is not installed to access: ", expr);
          return null;
        }
  ...
  var UrlReplacements = /* @__PURE__ */ function() {
    ...
    _proto2.ensureProtocolMatches_ = function ensureProtocolMatches_(url, replacement) {
      ...
      if (newProtocol != oldProtocol) {
        user().error(TAG4, "Illegal replacement of the protocol: ", url);
        return url;
      }
  ...
  var A4AVariableSource = /* @__PURE__ */ function(_VariableSource) {
    ...
    _proto.htmlAttributeBinding_ = function htmlAttributeBinding_(cssSelector, var_args) {
      ...
      if (attributeNames.length > HTML_ATTR_MAX_ATTRS) {
        user().error(TAG16, "At most " + HTML_ATTR_MAX_ATTRS + " may be requested.");
        return "[]";
      }
      ...
      try {
        ...
        user().error(TAG16, "Invalid selector: " + cssSelector);
        return "[]";
      }
      if (elements2.length > HTML_ATTR_MAX_ELEMENTS_TO_TRAVERSE) {
        user().error(TAG16, "CSS selector may match at most " + (HTML_ATTR_MAX_ELEMENTS_TO_TRAVERSE + " elements."));
        return "[]";
      }
      var result = [];
    ...
    _proto.getScopedCid = function getScopedCid(apiKey, scope) {
      ...
      return this.cidPromise_[scope] = this.timer_.poll(200, function() {
        ...
        return _this.fetchCid_(dev().assertString(url), scope, token).then(function(response) {
          ...
          if (e && e.response) {
            e.response.json().then(function(res) {
              dev().error(TAG8, JSON.stringify(res));
            });
          } else {
            dev().error(TAG8, e);
          }
  ...
  function installGlobalNavigationHandlerForDoc(ampdoc2) {
    registerServiceBuilderForDoc(ampdoc2, TAG9, Navigation, true);
  }
  var Navigation = /* @__PURE__ */ function() {
    ...
    _proto.navigateTo = function navigateTo(win, url, opt_requestedBy, options) {
      ...
      if (!urlService.isProtocolValid(url)) {
        user().error(TAG9, "Cannot navigate to invalid protocol: " + url);
        return;
      }
    ...
    _proto.removeViewerQueryBeforeNavigation_ = function removeViewerQueryBeforeNavigation_(win, fromLocation, target) {
      dev().info(TAG9, "Removing iframe query string before navigation:", fromLocation.search);
      ...
      var restoreQuery = function restoreQuery2() {
        ...
        if (currentHref == noQuery) {
          dev().info(TAG9, "Restored iframe URL with query string:", original);
          win.history.replaceState(null, "", original);
        } else {
          dev().error(TAG9, "Unexpected iframe URL change:", currentHref, noQuery);
        }
      };
      if (target === "_blank") {
    ...
    _proto.scrollToElement_ = function scrollToElement_(elem, hash) {
      ...
      if (elem) {
        ...
        dev().warn(TAG9, "failed to find element with id=" + hash + " or a[name=" + hash + "]");
      }
    };
  ...
  var StandardActions = /* @__PURE__ */ function() {
      ...
      switch (method) {
        ...
        case "optoutOfCid":
          return Services.cidForDoc(this.ampdoc).then(function(cid) {
            ...
            dev().error(TAG10, "Failed to opt out of CID", reason);
          });
      }
    ...
    _proto.handleShow_ = function handleShow_(invocation) {
      ...
      if (target.classList.contains(getLayoutClass(Layout_Enum.NODISPLAY))) {
        user().warn(TAG10, "Elements with layout=nodisplay cannot be dynamically shown.", target);
        return null;
      }
      this.mutator_.measureElement(function() {
        if (computedStyle(ownerWindow, target).display == "none" && !isShowable(target)) {
          user().warn(TAG10, 'Elements can only be dynamically shown when they have the "hidden" attribute set or when they were dynamically hidden.', target);
        }
      });
    ...
    _proto.getStore_ = function getStore_() {
      if (!this.storePromise_) {
        this.storePromise_ = this.binding_.loadBlob(this.origin_).then(function(blob) {
          ...
          dev().expectedError(TAG11, "Failed to load store: ", reason);
          return {};
        }).then(function(obj) {
    ...
    _proto.listenToBroadcasts_ = function listenToBroadcasts_() {
      ...
      this.viewer_.onBroadcast(function(message) {
        if (message["type"] == "amp-storage-reset" && message["origin"] == _this2.origin_) {
          dev().fine(TAG11, "Received reset message");
          _this2.storePromise_ = null;
        }
      });
    };
    _proto.broadcastReset_ = function broadcastReset_() {
      dev().fine(TAG11, "Broadcasted reset message");
  ...
  var ViewerStorageBinding = /* @__PURE__ */ function() {
    ...
    _proto5.saveBlob = function saveBlob(origin, blob) {
      return this.viewer_.sendMessageAwaitResponse("saveStore", dict({
        ...
        throw dev().createExpectedError(TAG11, "Failed to save store: ", reason);
      });
    };
  ...
  function installTimerInEmbedWindow(embedWin) {
    registerServiceBuilderInEmbedWin(embedWin, TAG12, Timer);
  }
  ...
  function onDocumentFormSubmit_(e) {
    ...
    if (method == "GET") {
      ...
      if (action) {
        var TAG16 = "form";
        user().error(TAG16, "action attribute is invalid for method=POST: %s", form);
      }
      if (!actionXhr) {
        e.preventDefault();
  ...
  function applySandbox(iframe) {
    ...
    for (var i = 0; i < requiredFlags.length; i++) {
      ...
      if (!iframe.sandbox.supports(flag)) {
        dev().info(TAG13, "Iframe doesn't support %s", flag);
        return;
      }
    }
  ...
  var AmpA4A = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.buildCallback = function buildCallback() {
      ...
      dev().info(TAG14, "upgradeDelay " + this.element.getAttribute("type") + ": " + upgradeDelayMs);
    ...
    _proto.shouldInitializePromiseChain_ = function shouldInitializePromiseChain_() {
      ...
      if (fixedSizeZeroHeightOrWidth || this.element.hasAttribute("hidden") || this.element.classList.contains("i-amphtml-hidden-by-media-query")) {
        dev().fine(TAG14, "onLayoutMeasure canceled due height/width 0", this.element);
        return false;
      }
      if (!this.uiHandler.isStickyAd() && !isAdPositionAllowed(this.element, this.win)) {
        user().warn(TAG14, "<" + this.element.tagName + "> is not allowed to be " + ("placed in elements with position: fixed or sticky: " + this.element));
        return false;
      }
      if (!this.isValidElement()) {
        user().warn(TAG14, this.element.getAttribute("type"), "Amp ad element ignored as invalid", this.element);
        return false;
      }
      return true;
    };
      ...
      this.adPromise_ = this.getAmpDoc().whenFirstVisible().then(function() {
        ...
        if (consentPolicyId) {
          var consentStatePromise = getConsentPolicyState(_this4.element, consentPolicyId).catch(function(err) {
            user().error(TAG14, "Error determining consent state", err);
          ...
          var consentStringPromise = getConsentPolicyInfo(_this4.element, consentPolicyId).catch(function(err) {
            user().error(TAG14, "Error determining consent string", err);
            return null;
          });
          var consentMetadataPromise = getConsentMetadata(_this4.element, consentPolicyId).catch(function(err) {
            user().error(TAG14, "Error determining consent metadata", err);
            return null;
          });
        ...
        if (getMode().localDev && _this4.win.location && _this4.win.location.search) {
          ...
          if (match && match[1]) {
            dev().info(TAG14, "Using debug exp features: " + match[1]);
      ...
      return this.keysetPromise_.then(function() {
        ...
        switch (status) {
          ...
          case VerificationStatus.ERROR_SIGNATURE_MISMATCH:
            user().error(TAG14, _this8.element.getAttribute("type"), "Signature verification failed");
    ...
    _proto.populatePostAdResponseExperimentFeatures_ = function populatePostAdResponseExperimentFeatures_(input) {
      ...
      input.split(",").forEach(function(line) {
        ...
        if (parts.length != 2 || !parts[0]) {
          dev().warn(TAG14, "invalid experiment feature " + line);
          return;
        }
    ...
    _proto.promiseErrorHandler_ = function promiseErrorHandler_(error, opt_ignoreStack) {
      ...
      if (error.message.indexOf(TAG14 + ": " + type + ":") != 0) {
        error.message = TAG14 + ": " + type + ": " + error.message;
      }
      assignAdUrlToError(error, this.adUrl_);
      if (getMode().development || getMode().localDev || logHashParam()) {
        user().error(TAG14, error);
      } else {
        user().warn(TAG14, error);
        if (Math.random() < 0.01) {
    ...
    _proto.attemptToRenderCreative = function attemptToRenderCreative() {
      ...
      if (!this.adPromise_) {
        if (this.shouldInitializePromiseChain_()) {
          dev().error(TAG14, "Null promise in layoutCallback");
        }
        return resolvedPromise();
      }
      var checkStillCurrent = this.verifyStillCurrent();
      return Promise.all([this.adPromise_, this.uiHandler.getScrollPromiseForStickyAd()]).then(function(values) {
        ...
        return friendlyRenderPromise.catch(function(err) {
          checkStillCurrent();
          user().warn(TAG14, _this12.element.getAttribute("type"), "Error injecting creative in friendly frame", err);
          return _this12.renderNonAmpCreative();
        });
      }).catch(function(error) {
    ...
    _proto.tearDownSlot = function tearDownSlot() {
      ...
      if (this.originalSlotSize_) {
        _AMP$BaseElement.prototype.attemptChangeSize.call(this, this.originalSlotSize_.height, this.originalSlotSize_.width).then(function() {
          ...
          dev().warn(TAG14, "unable to revert to original size", err);
        });
      }
    ...
    _proto.getBlockRtc_ = function getBlockRtc_() {
      ...
      return Services.geoForDocOrNull(this.element).then(function(geoService) {
        userAssert(geoService, "%s: requires <amp-geo> to use `block-rtc`", TAG14);
    ...
    _proto.extractSize = function extractSize(responseHeaders) {
      ...
      if (!match) {
        user().error(TAG14, "Invalid size header: " + headerValue);
        return null;
      }
      return {
    ...
    _proto.onCrossDomainIframeCreated = function onCrossDomainIframeCreated(iframe) {
      dev().info(TAG14, this.element.getAttribute("type"), "onCrossDomainIframeCreated " + iframe);
    };
    ...
    _proto.sendXhrRequest = function sendXhrRequest(adUrl) {
      ...
      return Services.xhrFor(this.win).fetch(adUrl, xhrInit).catch(function(error) {
        ...
        if (networkFailureHandlerResult.frameGetDisabled) {
          dev().info(TAG14, "frame get disabled as part of network failure handler");
          _this16.resetAdUrl();
        } else {
    ...
    _proto.renderNonAmpCreative = function renderNonAmpCreative(throttleApplied) {
      ...
      if (this.element.getAttribute("disable3pfallback") == "true") {
        user().warn(TAG14, this.element.getAttribute("type"), "fallback to 3p disabled");
        return Promise.resolve(false);
      }
      dev().warn(TAG14, "fallback to 3p");
      ...
      if ((method == XORIGIN_MODE.SAFEFRAME || method == XORIGIN_MODE.NAMEFRAME) && this.creativeBody_) {
        ...
        user().warn(TAG14, this.element.getAttribute("type"), "No creative or URL available -- A4A can't render any ad");
      }
    ...
    _proto.makeFieVisible_ = function makeFieVisible_(friendlyIframeEmbed, creativeMetaData, checkStillCurrent) {
      ...
      protectFunctionWrapper(this.onCreativeRender, this, function(err) {
        dev().error(TAG14, _this21.element.getAttribute("type"), "Error executing onCreativeRender", err);
    ...
    _proto.iframeRenderHelper_ = function iframeRenderHelper_(attributes) {
      ...
      protectFunctionWrapper(this.onCreativeRender, this, function(err) {
        dev().error(TAG14, _this22.element.getAttribute("type"), "Error executing onCreativeRender", err);
      })(null);
    ...
    _proto.getAmpAdMetadata = function getAmpAdMetadata(creative) {
      ...
      if (metadataStart < 0) {
        dev().warn(TAG14, this.element.getAttribute("type"), "Could not locate start index for amp meta data in: %s", creative);
        return null;
      }
      var metadataEnd = creative.lastIndexOf("<\/script>");
      if (metadataEnd < 0) {
        dev().warn(TAG14, this.element.getAttribute("type"), "Could not locate closing script tag for amp meta data in: %s", creative);
        return null;
      }
      try {
        ...
        dev().warn(TAG14, this.element.getAttribute("type"), "Invalid amp metadata: %s", creative.slice(metadataStart + metadataString.length, metadataEnd));
        if (this.isSinglePageStoryAd) {
          throw err;
        }
        return null;
  ...
  // extensions/amp-ad-network-valueimpression-impl/0.1/amp-ad-network-valueimpression-impl.js
  ...
  var TAG15 = "amp-ad-network-valueimpression-impl";
  ...
  var RTC_SUCCESS = "2";
  var AmpAdNetworkValueimpressionImpl = /* @__PURE__ */ function(_AmpA4A) {
    _inherits5(AmpAdNetworkValueimpressionImpl2, _AmpA4A);
    var _super = _createSuper5(AmpAdNetworkValueimpressionImpl2);
    function AmpAdNetworkValueimpressionImpl2(element) {
      var _this;
      _this = _super.call(this, element);
      _this.getAdUrlDeferred = new Deferred();
      _this.remoteSettings = null;
      _this.flexibleAdSlotData_ = null;
      _this.refreshManager_ = null;
      _this.ifi_ = 0;
      return _this;
    }
    var _proto = AmpAdNetworkValueimpressionImpl2.prototype;
    _proto.isValidElement = function isValidElement() {
    ...
    _proto.onCreativeRender = function onCreativeRender(creativeMetaData, opt_onLoadPromise) {
      ...
      this.iframe.setAttribute("width", Number(this.element.getAttribute("width")));
      this.iframe.setAttribute("height", Number(this.element.getAttribute("height")));
      if (this.remoteSettings.refreshInterval !== false && this.remoteSettings.refreshInterval > 0) {
    ...
    _proto.getCustomRealTimeConfigMacros_ = function getCustomRealTimeConfigMacros_() {
      ...
      return {
        autoCollect: function autoCollect() {
          var data = {
            "href": _this2.win.location.href,
            "canonical_url": Services.documentInfoForDoc(_this2.element).canonicalUrl,
            "width": _this2.element.getAttribute("width"),
            "height": _this2.element.getAttribute("height"),
            "element_pos": getPageLayoutBoxBlocking(_this2.element).top,
            "scroll_top": Services.viewportForDoc(_this2.getAmpDoc()).getScrollTop(),
            "page_height": Services.viewportForDoc(_this2.getAmpDoc()).getScrollHeight(),
            "bkg_state": _this2.getAmpDoc().isVisible() ? "visible" : "hidden"
          };
    ...
    _proto.generateAdKey_ = function generateAdKey_(size, slot) {
    ...
    _proto.getAdUrl = function getAdUrl(opt_consentTuple, opt_rtcResponsesPromise, opt_serveNpaSignal) {
      ...
      var consentString = consentTuple.consentString, gdprApplies = consentTuple.gdprApplies;
      var win = this.win;
      ...
      var rtcParamsPromise = opt_rtcResponsesPromise.then(function(results) {
        ...
        results.forEach(function(rtcResponse) {
          if (rtcResponse) {
      ...
      var startTime = Date.now();
      Promise.all([rtcParamsPromise, referrerPromise, getOrCreateAdCid(ampDoc, "AMP_ECID_GOOGLE", "_ga")]).then(function(results) {
        var clientId = results[2];
        var referrer = results[1];
        _this3.remoteSettings = results[0];
        if (!_this3.remoteSettings) {
          return _this3.getAdUrlDeferred.resolve("");
        }
        if (!_this3.remoteSettings.dfpSlot) {
          if (_this3.remoteSettings.targeting && _this3.remoteSettings.targeting.hb_cache_id && _this3.remoteSettings.targeting.hb_cache_host && _this3.remoteSettings.targeting.hb_cache_path) {
            return _this3.getAdUrlDeferred.resolve("https://" + _this3.remoteSettings.targeting.hb_cache_host + _this3.remoteSettings.targeting.hb_cache_path + "?showAdm=1&uuid=" + _this3.remoteSettings.targeting.hb_cache_id);
          } else {
            return _this3.getAdUrlDeferred.resolve("");
          }
        }
        var width = Number(_this3.element.getAttribute("width"));
        var height = Number(_this3.element.getAttribute("height"));
        var size = width + "x" + height;
        var adKey = _this3.generateAdKey_(size, _this3.remoteSettings.dfpSlot);
        var msz = null;
        var psz = null;
        var fws = null;
        _this3.flexibleAdSlotData_ = getFlexibleAdSlotData(_this3.win, _this3.element.parentElement);
        var _this3$flexibleAdSlot = _this3.flexibleAdSlotData_, fwSignal = _this3$flexibleAdSlot.fwSignal, parentWidth = _this3$flexibleAdSlot.parentWidth, slotWidth = _this3$flexibleAdSlot.slotWidth;
        if (_this3.uiHandler.isStickyAd()) {
          msz = "0x-1";
          psz = "0x-1";
        } else {
        ...
        var domLoading = ampDoc.getParam("visibilityState") ? ampDoc.getLastVisibleTime() : getNavigationTiming(win, "domLoading");
        var screen = win.screen;
        ...
        var targeting = {
          "vli_sf": 1,
          "vli_adslot": _this3.remoteSettings.zoneID,
          "vli_adtype": "display"
        };
        Object.assign(targeting, _this3.remoteSettings.targeting);
        _this3.win["ampAdGoogleIfiCounter"] = _this3.win["ampAdGoogleIfiCounter"] || 1;
        _this3.ifi_ = _this3.isRefreshing && _this3.ifi_ || _this3.win["ampAdGoogleIfiCounter"]++;
        var parameters = {
          "iu": _this3.remoteSettings.dfpSlot,
          "adk": adKey,
          "sz": size,
          "output": "html",
          "impl": "ifr",
          ...
          "psz": psz,
          "fws": fws,
          "scp": Object.keys(targeting).map(function(key) {
            return key + "=" + targeting[key];
          }).join("&"),
          "gdfp_req": 1,
          "sfv": "1-0-37",
          ...
          "ati": ati,
          "ard": ard,
          "is_amp": _this3.isXhrAllowed() ? AmpAdImplementation.AMP_AD_XHR_TO_IFRAME_OR_AMP : AmpAdImplementation.AMP_AD_IFRAME_GET,
          "amp_v": version(),
          "d_imp": 1,
        ...
        var adUrl = buildUrl(DOUBLECLICK_BASE_URL, parameters, MAX_URL_LENGTH2 - 10, TRUNCATION_PARAM);
        _this3.getAdUrlDeferred.resolve(adUrl);
      });
      return this.getAdUrlDeferred.promise;
    };
    return AmpAdNetworkValueimpressionImpl2;
  }(AmpA4A);
  AMP.registerElement(TAG15, AmpAdNetworkValueimpressionImpl);
...
//# sourceMappingURL=amp-ad-network-valueimpression-impl-0.1.max.js.map
