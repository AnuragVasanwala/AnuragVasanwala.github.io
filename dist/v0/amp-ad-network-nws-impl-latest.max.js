(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-ad-network-nws-impl",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-ad-network-nws-impl/0.1/amp-ad-network-nws-impl.js
  ...
  var URL2 = "https://svr.nws.ai/a4a";
  var NWS_HEADER = "X-NWS";
  var AmpAdNetworkNwsImpl = /* @__PURE__ */ function(_AmpA4A) {
    _inherits5(AmpAdNetworkNwsImpl2, _AmpA4A);
    var _super = _createSuper5(AmpAdNetworkNwsImpl2);
    function AmpAdNetworkNwsImpl2(element) {
      var _this;
      _this = _super.call(this, element);
    ...
    var _proto = AmpAdNetworkNwsImpl2.prototype;
    _proto.extractAmpAnalyticsConfig = function extractAmpAnalyticsConfig(responseHeaders) {
      if (!responseHeaders.has(NWS_HEADER)) {
        return null;
      }
      try {
        var responseConfig = parseJson(responseHeaders.get(NWS_HEADER));
        var analyticsConfig = responseConfig["ampAnalytics"];
        var config = {
          "transport": {
            "beacon": true,
            "xhrpost": true,
        ...
        dev().error("AMP-A4A", "Invalid analytics", err, responseHeaders.get(NWS_HEADER));
      }
    };
    _proto.getAdUrl = function getAdUrl(unusedConsentState, opt_rtcResponsesPromise) {
      var dataSlot = this.element.getAttribute("data-slot");
      var url = URL2 + "?slot=" + encodeURIComponent(dataSlot);
      return url;
    };
    _proto.extractSize = function extractSize(responseHeaders) {
    ...
    _proto.onCreativeRender = function onCreativeRender(creativeMetaData, opt_onLoadPromise) {
      ...
      if (this.ampAnalyticsConfig_) {
        this.ampAnalyticsElement_ = insertAnalyticsElement(this.element, this.ampAnalyticsConfig_, true, false);
      }
    };
    return AmpAdNetworkNwsImpl2;
  }(AmpA4A);
  AMP.registerElement("amp-ad-network-nws-impl", AmpAdNetworkNwsImpl);
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
})});
//# sourceMappingURL=amp-ad-network-nws-impl-0.1.max.js.map
