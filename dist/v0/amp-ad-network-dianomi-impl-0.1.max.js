(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-ad-network-dianomi-impl",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var REQUEST_PARAM_ID = new RegExp(/^.[0-9]*$/);
  var TYPES = ["smartads", "recirc", "context"];
  var ENVIRONMENTS = {
    dev: "dev",
    live: "www"
  };
  var AmpAdNetworkDianomiImpl = /* @__PURE__ */ function(_AmpA4A) {
    _inherits5(AmpAdNetworkDianomiImpl2, _AmpA4A);
    var _super = _createSuper5(AmpAdNetworkDianomiImpl2);
    function AmpAdNetworkDianomiImpl2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpAdNetworkDianomiImpl2.prototype;
    _proto.getAdUrl = function getAdUrl(consentTuple) {
      var consentVars = {
        consentState: void 0,
        consentString: void 0,
        consentStringType: void 0,
        gdprApplies: void 0,
        additionalConsent: void 0
      };
      if (consentTuple && consentTuple.consentState === CONSENT_POLICY_STATE.UNKNOWN) {
        return "";
      }
      if (consentTuple) {
        consentVars = {
      ...
      var paramId = this.element.getAttribute("data-request-param-id");
      var typeAttr = this.element.getAttribute("data-dianomi-type");
      var type = TYPES[0];
      var envAttr = this.element.getAttribute("data-dianomi-env");
      var env2 = ENVIRONMENTS["live"];
      if (envAttr) {
        elementExistsInArray(Object.keys(ENVIRONMENTS), envAttr.toLowerCase(), "env");
        env2 = ENVIRONMENTS[envAttr.toLowerCase()];
      }
      if (typeAttr) {
        elementExistsInArray(TYPES, typeAttr.toLowerCase(), "type");
        type = typeAttr.toLowerCase();
      }
      userAssert(REQUEST_PARAM_ID.test(paramId), "The Dianomi request parameter ID provided is invalid");
      var params = _extends7({
        format: "a4a",
        id: paramId
      }, consentVars);
      return addParamsToUrl("https://" + env2 + ".dianomi.com/" + type + ".pl", params);
    };
    return AmpAdNetworkDianomiImpl2;
  }(AmpA4A);
  function elementExistsInArray(arr, value, type) {
    userAssert(arr.includes(value), "The Dianomi " + type + " parameter '" + value + "' is not a valid input");
  }
  AMP.registerElement("amp-ad-network-dianomi-impl", AmpAdNetworkDianomiImpl);
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
})});
//# sourceMappingURL=amp-ad-network-dianomi-impl-0.1.max.js.map
