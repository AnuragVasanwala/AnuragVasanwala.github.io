(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-date-countdown",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-date-countdown/1.0/messages.js
  ...
  var LOCALE_WORD = {
    ...
    "es": ["a\xF1os", "meses", "d\xEDas", "horas", "minutos", "segundos"],
    ...
    "tr": ["y\u0131l", "ay", "g\xFCn", "saat", "dakika", "saniye"],
    "vi": ["n\u0103m", "th\xE1ng", "ng\xE0y", "gi\u1EDD", "ph\xFAt", "gi\xE2y"],
    "zh-cn": ["\u5E74", "\u6708", "\u5929", "\u5C0F\u65F6", "\u5206\u949F", "\u79D2"],
    "zh-tw": ["\u5E74", "\u6708", "\u5929", "\u5C0F\u6642", "\u5206\u9418", "\u79D2"]
  };

  // extensions/amp-date-countdown/1.0/component.js
  var _excluded2 = ["datetime", "whenEnded", "locale", "biggestUnit", "countUp", "render"];
  function _extends8() {
  ...
  function BentoDateCountdown(_ref) {
    ...
    useEffect(function() {
      ...
      var interval = win.setInterval(function() {
        ...
        if (whenEnded === DEFAULT_WHEN_ENDED && newTimeleft < 1e3) {
          win.clearInterval(interval);
        }
      }, DELAY);
      return function() {
  ...
  function getDataForTemplate(timeleft, biggestUnit, localeStrings, countUp) {
    return _extends8({}, getYDHMSFromMs(timeleft, biggestUnit, countUp), localeStrings);
  }
  function getLocaleWord(locale) {
    if (getLocaleStrings(locale) === void 0) {
      displayWarning("Invalid locale " + locale + ", defaulting to " + DEFAULT_LOCALE + ". " + NAME);
  ...
  function getYDHMSFromMs(ms, biggestUnit, countUp) {
    ...
    var d2 = TimeUnit[biggestUnit] == TimeUnit.DAYS ? supportBackDate(Math.floor(ms / MILLISECONDS_IN_DAY)) : 0;
    var h3 = TimeUnit[biggestUnit] == TimeUnit.HOURS ? supportBackDate(Math.floor(ms / MILLISECONDS_IN_HOUR)) : TimeUnit[biggestUnit] < TimeUnit.HOURS ? supportBackDate(Math.floor(ms % MILLISECONDS_IN_DAY / MILLISECONDS_IN_HOUR)) : 0;
    var m3 = TimeUnit[biggestUnit] == TimeUnit.MINUTES ? supportBackDate(Math.floor(ms / MILLISECONDS_IN_MINUTE)) : TimeUnit[biggestUnit] < TimeUnit.MINUTES ? supportBackDate(Math.floor(ms % MILLISECONDS_IN_HOUR / MILLISECONDS_IN_MINUTE)) : 0;
    var s3 = TimeUnit[biggestUnit] == TimeUnit.SECONDS ? supportBackDate(Math.floor(ms / MILLISECONDS_IN_SECOND)) : supportBackDate(Math.floor(ms % MILLISECONDS_IN_MINUTE / MILLISECONDS_IN_SECOND));
    return dict({
      "d": d2,
      "dd": padStart(d2),
      "h": h3,
  ...
  // extensions/amp-date-countdown/1.0/base-element.js
  ...
  BaseElement2["Component"] = BentoDateCountdown;
  BaseElement2["layoutSizeDefined"] = true;
  BaseElement2["lightDomTag"] = "div";
  BaseElement2["usesTemplate"] = true;
  BaseElement2["props"] = {
    "datetime": {
      attrs: ["end-date", "timeleft-ms", "timestamp-ms", "timestamp-seconds", "offset-seconds"],
  ...
  function parseDateAttrs2(element) {
    return parseDateAttrs(element, ["end-date", "timeleft-ms", "timestamp-ms", "timestamp-seconds"]);
  }

  // extensions/amp-date-countdown/1.0/amp-date-countdown.js
  ...
  var TAG2 = "amp-date-countdown";
  var AmpDateCountdown = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpDateCountdown2, _BaseElement);
    var _super = _createSuper4(AmpDateCountdown2);
    function AmpDateCountdown2(element) {
      var _this;
      _this = _super.call(this, element);
    ...
    var _proto = AmpDateCountdown2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-date-countdown"), 'expected global "bento" or specific "bento-date-countdown" experiment to be enabled');
    ...
    return AmpDateCountdown2;
  }(BaseElement2);
  AMP.registerElement(TAG2, AmpDateCountdown);
})();
...
//# sourceMappingURL=amp-date-countdown-1.0.max.js.map
