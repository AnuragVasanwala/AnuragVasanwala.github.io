(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-yotpo",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-yotpo/0.1/amp-yotpo.js
  ...
  var AmpYotpo = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpYotpo2, _AMP$BaseElement);
    var _super = _createSuper(AmpYotpo2);
    function AmpYotpo2(element) {
      var _this;
    ...
    var _proto = AmpYotpo2.prototype;
    ...
    _proto.buildCallback = function buildCallback() {
      userAssert2(this.element.getAttribute("data-app-key"), "The data-app-key attribute is required for <amp-yotpo> %s", this.element);
      userAssert2(this.element.getAttribute("data-widget-type"), "The data-widget-type attribute is required for <amp-yotpo> %s", this.element);
    };
    ...
    _proto.layoutCallback = function layoutCallback() {
      var _this2 = this;
      var iframe = getIframe(this.win, this.element, "yotpo");
      iframe.title = this.element.title || "Yotpo widget";
      applyFillContent(iframe);
      var unlisten = listenFor(iframe, "embed-size", function(data) {
