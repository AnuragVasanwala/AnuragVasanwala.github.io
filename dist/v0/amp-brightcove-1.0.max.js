(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-brightcove",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function VideoWrapperWithRef(_ref, ref) {
    ...
    return createElement(ContainWrapper, {
      ...
      layout: true,
      paint: true
    }, load && createElement(Component, _extends3({}, rest, {
      ref: playerRef,
      loading: loading,
      muted: muted,
      loop: loop,
  ...
  function VideoIframeInternalWithRef(_ref, ref) {
    ...
    return createElement("iframe", _extends4({}, rest, {
      ref: iframeRef,
  ...
  function VideoIframeWithRef(props, ref) {
    return createElement(VideoWrapper, _extends4({
      ref: ref
    }, props, {
  ...
  function getBrightcoveIframeSrc(account, player, embed, playlistId, videoId, referrer, additionalParams) {
    var playlistOrVideoParam = "";
    if (playlistId) {
      playlistOrVideoParam = "&playlistId=" + encodeId(playlistId);
    } else if (videoId) {
      playlistOrVideoParam = "&videoId=" + encodeId(videoId);
    }
    return addParamsToUrl("https://players.brightcove.net/" + encodeURIComponent(account) + ("/" + encodeURIComponent(player)) + ("_" + encodeURIComponent(embed) + "/index.html") + "?amp=1" + playlistOrVideoParam, _extends5({}, additionalParams, {
      referrer: referrer,
      playsinline: true,
      autoplay: void 0
    }));
  ...
  // extensions/amp-brightcove/1.0/component.js
  var _excluded3 = ["account", "autoplay", "embed", "muted", "player", "playlistId", "referrer", "videoId", "onPlayingState", "urlParams", "onLoad"];
  function _extends6() {
  ...
  function BentoBrightcoveWithRef(props, ref) {
    var account = props.account, autoplay = props.autoplay, _props$embed = props.embed, embed = _props$embed === void 0 ? DEFAULT : _props$embed, mutedProp = props.muted, _props$player = props.player, player = _props$player === void 0 ? DEFAULT : _props$player, playlistId = props.playlistId, referrer = props.referrer, videoId = props.videoId, onPlayingState = props.onPlayingState, urlParams = props.urlParams, onLoad = props.onLoad, rest = _objectWithoutPropertiesLoose6(props, _excluded3);
    var playerStateRef = useRef({});
    var onLoadRef = useValueRef(onLoad);
    var _useState = useState(mutedProp), muted = _useState[0], setMuted = _useState[1];
    var src = useMemo(function() {
      return getBrightcoveIframeSrc(account, player, embed, playlistId, videoId, referrer, urlParams);
    }, [account, embed, player, playlistId, referrer, urlParams, videoId]);
    var onMessage = useCallback(function(_ref) {
      var currentTarget = _ref.currentTarget, data = _ref.data;
      var eventType = data == null ? void 0 : data.event;
      switch (eventType) {
        case "ready":
    ...
    return createElement(VideoIframe, _extends6({
      ref: ref
    }, rest, {
      autoplay: autoplay,
      controls: true,
  ...
  function makeMessage(method) {
    ...
    return JSON.stringify({
      "command": (_methods$method = methods[method]) != null ? _methods$method : method,
      "args": arg
    });
  }
  function checkProps(_ref2) {
    var account = _ref2.account;
    if (!account) {
      console.warn("account is required for <Brightcove>");
      return false;
    }
    return true;
  }
  var BentoBrightcove = forwardRef(BentoBrightcoveWithRef);
  BentoBrightcove.displayName = "BentoBrightcove";
  ...
  function createSlot(element, name, defaultProps, as) {
    ...
    if (!as) {
      return createElement(Slot, _extends8({}, defaultProps || EMPTY, {
        name: name
      }));
    }
  ...
  function Slot(props) {
    ...
    return createElement("slot", _extends8({}, props, {
      ref: ref
    }));
  }
  ...
  function collectProps(Ctor, element, ref, defaultProps, mediaQueryProps) {
    ...
    var props = _extends9({}, defaultProps, {
      ref: ref
    });
    if (lightDomTag) {
  ...
  function createParseAttrsWithPrefix(prefix) {
    ...
    var parseAttrs2 = function parseAttrs3(element) {
      var currObj;
  ...
  // extensions/amp-brightcove/1.0/base-element.js
  ...
  BaseElement3["Component"] = BentoBrightcove;
  BaseElement3["props"] = {
    "account": {
      attr: "data-account"
    },
    ...
    "player": {
      ...
      parseAttrs: function parseAttrs(element) {
        var _element$dataset = element.dataset, player = _element$dataset["player"], playerId = _element$dataset["playerId"];
  ...
  // build/amp-brightcove-1.0.css.js
  var CSS4 = "amp-brightcove{display:block;overflow:hidden;position:relative}amp-brightcove:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-brightcove/1.0/amp-brightcove.css*/";
  ...
  function experimentToggles(win) {
    ...
    var buildExperimentConfigs = _extends11({}, (_win$AMP_CONFIG3 = win.AMP_CONFIG) != null ? _win$AMP_CONFIG3 : {}, (_win$AMP_EXP = win.AMP_EXP) != null ? _win$AMP_EXP : parseJson(((_win$__AMP_EXP = win.__AMP_EXP) == null ? void 0 : _win$__AMP_EXP.textContent) || "{}"));
    ...
    if (isArray(allowedDocOptIn) && allowedDocOptIn.length) {
      ...
      if (meta) {
        ...
        for (var _iterator = _createForOfIteratorHelperLoose5(optedInExperiments), _step; !(_step = _iterator()).done; ) {
    ...
    if (isArray(allowedUrlOptIn) && allowedUrlOptIn.length) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose5(allowedUrlOptIn), _step2; !(_step2 = _iterator2()).done; ) {
  ...
  function getExperimentToggles(win) {
    ...
    var toggles = map();
    for (var _iterator3 = _createForOfIteratorHelperLoose5(tokens), _step3; !(_step3 = _iterator3()).done; ) {
  ...
  // extensions/amp-brightcove/1.0/amp-brightcove.js
  function _extends12() {
  ...
  var AmpBrightcove = /* @__PURE__ */ function(_BaseElement) {
    _inherits6(AmpBrightcove2, _BaseElement);
    var _super = _createSuper6(AmpBrightcove2);
    function AmpBrightcove2() {
      return _super.apply(this, arguments);
    }
    AmpBrightcove2.getPreconnects = function getPreconnects() {
      return ["https://players.brightcove.net"];
    };
    var _proto = AmpBrightcove2.prototype;
    _proto.init = function init() {
      var _this = this;
      _BaseElement.prototype.init.call(this);
      userAssert(this.element.getAttribute("data-account"), "The data-account attribute is required for <amp-brightcove> %s", this.element);
      var consentPolicy = this.getConsentPolicy();
      if (!consentPolicy) {
        return;
      }
      Promise.all([getConsentPolicyState(this.element, consentPolicy), getConsentPolicyInfo(this.element, consentPolicy), getConsentPolicySharedData(this.element, consentPolicy)]).then(function(arr) {
        var consentState = arr[0], consentString = arr[1], consentSharedData = arr[2];
        var urlParams = _extends12({}, _this.getProp("urlParams"), dict({
    ...
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-brightcove"), 'expected global "bento" or specific "bento-brightcove" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpBrightcove2;
  }(BaseElement3);
  AMP.registerElement(TAG2, AmpBrightcove, CSS4);
  function getReferrerFromElement(element) {
    return element.hasAttribute("data-referrer") ? Services.urlReplacementsForDoc(element).expandUrlSync(element.getAttribute("data-referrer")) : void 0;
  }
  AmpBrightcove["props"] = _extends12({}, BaseElement3["props"], {
    "referrer": {
      attrs: ["data-referrer"],
...
//# sourceMappingURL=amp-brightcove-1.0.max.js.map
