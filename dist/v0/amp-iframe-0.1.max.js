(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-iframe",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpIframe = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      if (this.isTrackingFrame_) {
        if (!this.getAmpDoc().registerSingleton(AMPDOC_SINGLETON_NAME_ENUM.TRACKING_IFRAME)) {
    ...
    _proto.getLayoutPriority = function getLayoutPriority() {
      if (this.isAdLike_) {
        return LayoutPriority_Enum.ADS;
      }
      if (this.isTrackingFrame_) {
    ...
    _proto.registerIframeMessaging_ = function registerIframeMessaging_() {
      ...
      var listener = function listener2(e) {
        ...
        actionService.trigger(_this6.element, "message", event, ActionTrust_Enum.HIGH);
      };
