(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-mathml",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-mathml/1.0/component.jss.js
  var $inline = "inline-91960b0";
  var CSS2 = ".inline-91960b0{display:inline-block;vertical-align:middle}";
  ...
  // extensions/amp-mathml/1.0/utils.js
  var TYPE = "mathml";

  // extensions/amp-mathml/1.0/component.js
  var _excluded4 = ["formula", "inline", "onLoad", "title"];
  function _extends10() {
  ...
  var ORIGIN_MATCHER = function ORIGIN_MATCHER2() {
    return true;
  };
  function BentoMathmlWithRef(props, ref) {
    var _objStr;
    var formula = props.formula, _props$inline = props.inline, inline = _props$inline === void 0 ? false : _props$inline, onLoad = props.onLoad, _props$title = props.title, title = _props$title === void 0 ? "MathML formula" : _props$title, rest = _objectWithoutPropertiesLoose6(props, _excluded4);
    var onLoadRef = useValueRef(onLoad);
    var messageHandler = useCallback(function(e3) {
      var _tryParseJson;
      var data = (_tryParseJson = tryParseJson(e3.data)) != null ? _tryParseJson : deserializeMessage(e3.data);
      if (data["type"] == MessageType_Enum.EMBED_SIZE) {
        onLoadRef.current == null ? void 0 : onLoadRef.current();
      }
    }, [onLoadRef]);
    var iframeOptions = useMemo(function() {
      return {
        formula: formula
      };
    }, [formula]);
    ...
    return createElement(ProxyIframeEmbed, _extends10({
      class: obj_str_default((_objStr = {}, _objStr[$inline] = inline, _objStr)),
  ...
  var BentoMathml = forwardRef(BentoMathmlWithRef);
  BentoMathml.displayName = "BentoMathml";
  function validProps(_ref) {
    var formula = _ref.formula;
    if (!formula) {
      console.warn("formula is required for <BentoMathml>");
      return false;
    }
    return true;
  }

  // extensions/amp-mathml/1.0/base-element.js
  ...
  BaseElement2["Component"] = BentoMathml;
  BaseElement2["props"] = {
    "inline": {
      attr: "inline",
      type: "boolean",
  ...
  // build/amp-mathml-1.0.css.js
  var CSS3 = "amp-mathml{display:block;overflow:hidden;position:relative}amp-mathml[inline]{display:inline-block;vertical-align:middle}\n/*# sourceURL=/extensions/amp-mathml/1.0/amp-mathml.css*/";

  // extensions/amp-mathml/1.0/amp-mathml.js
  ...
  var TAG2 = "amp-mathml";
  var AmpMathml = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpMathml2, _BaseElement);
    var _super = _createSuper4(AmpMathml2);
    function AmpMathml2() {
      return _super.apply(this, arguments);
    }
    AmpMathml2.getPreconnects = function getPreconnects(element) {
    ...
    var _proto = AmpMathml2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-mathml"), 'expected global "bento" or specific "bento-mathml" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpMathml2;
  }(BaseElement2);
  AMP.registerElement(TAG2, AmpMathml, CSS3);
})();
...
//# sourceMappingURL=amp-mathml-1.0.max.js.map
