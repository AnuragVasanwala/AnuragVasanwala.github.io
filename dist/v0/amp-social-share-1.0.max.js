(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-social-share",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function checkProps(type, endpoint, target, width, height, params) {
    ...
    var currentParams = Object.entries(typeConfig.defaultParams || {}).reduce(function(newParams, _ref2) {
      ...
      return _extends8({}, newParams, (_extends22 = {}, _extends22[key] = value.replace("TITLE", document.title).replace("CANONICAL_URL", ((_document$querySelect = document.querySelector("link[rel='canonical']")) == null ? void 0 : _document$querySelect.href) || location.href), _extends22));
    }, params || {});
  ...
  var CSS3 = "amp-social-share{display:inline-block;overflow:hidden;position:relative;box-sizing:border-box;width:60px;height:44px}amp-social-share:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}amp-social-share:focus{outline:2px solid #0389ff;outline-offset:2px}amp-social-share::part(button):focus{outline:none!important;outline-offset:0!important}.amp-social-share-twitter{color:#fff;background-color:#1da1f2}.amp-social-share-facebook{color:#1877f2;background-color:#fff}.amp-social-share-pinterest{color:#e60023;background-color:#fff}.amp-social-share-linkedin{color:#fff;background-color:#0a66c2}.amp-social-share-tumblr{color:#fff;background-color:#001935}.amp-social-share-email{color:#fff;background-color:#000}.amp-social-share-whatsapp{color:#fff;background-color:#25d366}.amp-social-share-line{color:#fff;background-color:#00b900}.amp-social-share-sms,.amp-social-share-system{color:#fff;background-color:#000}\n/*# sourceURL=/extensions/amp-social-share/1.0/amp-social-share.css*/";
  ...
  var DEFAULT_RESPONSIVE_DIMENSIONS = dict({
    "width": "100%",
    "height": "100%"
  });
  var getTypeConfigOrUndefined = function getTypeConfigOrUndefined2(element) {
    var viewer = Services.viewerForDoc(element);
    var platform = Services.platformFor(getWin(element));
    var type = userAssert2(element.getAttribute("type"), "The type attribute is required. %s", element);
    if (type === "system") {
  ...
  var AmpSocialShare = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpSocialShare2, _BaseElement);
    var _super = _createSuper4(AmpSocialShare2);
    ...
    _proto.mutationObserverCallback = function mutationObserverCallback(mutations) {
    ...
    _proto.isLayoutSupported = function isLayoutSupported() {
      userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-social-share"), 'expected global "bento" or specific "bento-social-share" experiment to be enabled');
      return true;
    };
    _proto.renderWithHrefAndTarget_ = function renderWithHrefAndTarget_(typeConfig) {
      var _this2 = this;
  ...
  AMP.registerElement(TAG2, AmpSocialShare, CSS3);
})();
