(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-ad-custom",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-a4a/0.1/amp-ad-type-defs.js
  var FailureType = {
  ...
  var Validator = /* @__PURE__ */ function() {
    ...
    _proto.validate = function validate(unusedContext, unusedContainerElement, unusedUnvalidatedBytes, unusedHeaders) {
    };
    return Validator2;
  }();
  var Renderer = /* @__PURE__ */ function() {
    ...
    var _proto2 = Renderer2.prototype;
    _proto2.render = function render(unusedContext, unusedContainerElement, unusedCreativeData) {
    };
    return Renderer2;
  }();
  ...
  var TAG = "amp-ad-util";
  function sendXhrRequest(win, url) {
  ...
  function getAmpAdMetadata(creative) {
    var metadataStart = -1;
    var metadataString;
  ...
  function _setPrototypeOf(o, p) {
    _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf9(o2, p2) {
      o2.__proto__ = p2;
      return o2;
    };
  ...
  function _getPrototypeOf(o) {
    _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf9(o2) {
      return o2.__proto__ || Object.getPrototypeOf(o2);
    };
    return _getPrototypeOf(o);
  }
  var TAG2 = "amp-ad-network-base";
  var AmpAdNetworkBase = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpAdNetworkBase2, _AMP$BaseElement);
    var _super = _createSuper(AmpAdNetworkBase2);
    function AmpAdNetworkBase2(element) {
      var _this;
      _this = _super.call(this, element);
      _this.adResponsePromise_ = null;
      _this.validators_ = map();
      _this.renderers_ = map();
      _this.recoveryModes_ = map();
      _this.context_ = {};
      for (var failureType in FailureType) {
        _this.recoveryModes_[failureType] = RecoveryModeType.COLLAPSE;
      }
      _this.retryLimit_ = 0;
      return _this;
    }
    var _proto = AmpAdNetworkBase2.prototype;
    ...
    _proto.layoutCallback = function layoutCallback() {
      var _this2 = this;
      devAssert2(this.adResponsePromise_, "layoutCallback invoked before XHR request!");
      return this.adResponsePromise_.then(function(response) {
        return _this2.invokeValidator_(response);
      }).then(function(validatorResult) {
        return _this2.invokeRenderer_(validatorResult);
      }).catch(function(error) {
        return _this2.handleFailure_(error.type, error.msg);
      });
    };
    _proto.onFailure = function onFailure(failure, recovery) {
      if (this.recoveryModes_[failure]) {
        dev().warn(TAG2, "Recovery mode for failure type " + failure + " already registered!");
      }
      this.recoveryModes_[failure] = recovery;
    };
    _proto.registerValidator = function registerValidator(validator2, type) {
      if (type === void 0) {
        type = "default";
      }
      if (this.validators_[type]) {
        dev().warn(TAG2, type + " validator already registered.");
      }
      this.validators_[type] = validator2;
    };
    _proto.registerRenderer = function registerRenderer(renderer, type) {
      if (this.renderers_[type]) {
        dev().warn(TAG2, "Rendering mode already registered for type '" + type + "'");
      }
    ...
    _proto.getRequestUrl = function getRequestUrl() {
    };
    _proto.setRequestRetries = function setRequestRetries(retries) {
      this.retryLimit_ = retries;
    };
    _proto.sendRequest_ = function sendRequest_() {
      var _this3 = this;
      this.adResponsePromise_ = this.getAmpDoc().whenFirstVisible().then(function() {
        var url = _this3.getRequestUrl();
        return sendXhrRequest(_this3.win, url);
      });
    };
    _proto.invokeValidator_ = function invokeValidator_(response) {
      var _this4 = this;
      if (!response.arrayBuffer) {
        return Promise.reject(this.handleFailure_(FailureType.INVALID_RESPONSE));
      }
      return response.arrayBuffer().then(function(unvalidatedBytes) {
        var validatorType = response.headers.get("AMP-Ad-Response-Type") || "default";
        devAssert2(_this4.validators_[validatorType], "Validator never registered!");
        return _this4.validators_[validatorType].validate(_this4.context_, _this4.element, unvalidatedBytes, response.headers).catch(function(err) {
          return Promise.reject({
            type: FailureType.VALIDATOR_ERROR,
            msg: err
          });
        });
      });
    };
    _proto.invokeRenderer_ = function invokeRenderer_(validatorOutput) {
      var renderer = this.renderers_[validatorOutput.type];
      devAssert2(renderer, "Renderer for AMP creatives never registered!");
      return renderer.render(this.context_, this.element, validatorOutput.creativeData).catch(function(err) {
        return Promise.reject({
          type: FailureType.RENDERER_ERROR,
          msg: err
        });
      });
    };
    _proto.handleFailure_ = function handleFailure_(failureType, error) {
      var recoveryMode = this.recoveryModes_[failureType];
      if (error) {
        dev().warn(TAG2, error);
      }
      switch (recoveryMode) {
        ...
        case RecoveryModeType.RETRY:
          ...
          break;
        default:
          dev().error(TAG2, "Invalid recovery mode!");
      }
    };
    _proto.forceCollapse_ = function forceCollapse_() {
      this.attemptChangeSize(0, 0);
    };
    return AmpAdNetworkBase2;
  }(AMP.BaseElement);
  ...
  function _setPrototypeOf2(o, p) {
    _setPrototypeOf2 = Object.setPrototypeOf || function _setPrototypeOf9(o2, p2) {
      o2.__proto__ = p2;
      return o2;
    };
  ...
  function _getPrototypeOf2(o) {
    _getPrototypeOf2 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf9(o2) {
      return o2.__proto__ || Object.getPrototypeOf(o2);
    };
    return _getPrototypeOf2(o);
  }
  var NameFrameRenderer = /* @__PURE__ */ function(_Renderer) {
    _inherits2(NameFrameRenderer2, _Renderer);
    var _super = _createSuper2(NameFrameRenderer2);
    function NameFrameRenderer2() {
      return _super.apply(this, arguments);
    }
    var _proto = NameFrameRenderer2.prototype;
    _proto.render = function render(context, element, crossDomainData) {
      crossDomainData = crossDomainData;
      if (!crossDomainData.creative && !crossDomainData.rawCreativeBytes) {
        return resolvedPromise();
      }
      var creative = crossDomainData.creative || utf8Decode(crossDomainData.rawCreativeBytes);
      var srcPath = getDefaultBootstrapBaseUrl(context.win, "nameframe");
      var contextMetadata = getContextMetadata(context.win, element, context.sentinel, crossDomainData.additionalContextMetadata);
      contextMetadata["creative"] = creative;
      var intersection = element.getIntersectionChangeEntry();
      ...
      var iframe = createElementWithAttributes(element.ownerDocument, "iframe", attributes);
      element.appendChild(iframe);
    };
    return NameFrameRenderer2;
  }(Renderer);
  ...
  var AmpAdTemplateHelper = /* @__PURE__ */ function() {
    function AmpAdTemplateHelper2(ampdoc2) {
      this.parentAmpdoc_ = ampdoc2;
      this.cache_ = new LruCache(5);
    }
    var _proto = AmpAdTemplateHelper2.prototype;
    _proto.fetch = function fetch(templateUrl) {
      ...
      devAssert2(templatePromise);
      return templatePromise;
    };
    _proto.render = function render(templateValues, element) {
      return Services.templatesForDoc(element).findAndRenderTemplate(element, templateValues);
    };
    _proto.insertAnalytics = function insertAnalytics(element, analyticsValue) {
    ...
    _proto.getTemplateProxyUrl_ = function getTemplateProxyUrl_(url) {
  ...
  var Expander = /* @__PURE__ */ function() {
        ...
        while (urlIndex < url.length && matchIndex <= matches2.length) {
          ...
          if (match && urlIndex === match.start) {
            ...
            if (_this.bindings_ && hasOwn(_this.bindings_, match.name)) {
              ...
              binding = _extends2({}, _this.variableSource_.get(match.name), {
                name: match.name,
                encode: encode
              });
            }
    ...
    _proto.evaluateBinding_ = function evaluateBinding_(bindingInfo, opt_args) {
      ...
      if (bindingInfo.prioritized != void 0) {
        ...
        user().error(TAG4, "ignoring async replacement key: ", bindingInfo.name);
        binding = "";
      } else {
    ...
    _proto.evaluateBindingSync_ = function evaluateBindingSync_(binding, name, opt_args) {
      try {
        ...
        if (value && typeof value.then == "function") {
          user().error(TAG4, "ignoring async macro resolution");
          result = "";
  ...
  function _setPrototypeOf3(o, p) {
    _setPrototypeOf3 = Object.setPrototypeOf || function _setPrototypeOf9(o2, p2) {
      o2.__proto__ = p2;
      return o2;
    };
  ...
  function _getPrototypeOf3(o) {
    _getPrototypeOf3 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf9(o2) {
      return o2.__proto__ || Object.getPrototypeOf(o2);
    };
    return _getPrototypeOf3(o);
  }
  var TAG5 = "UrlReplacements";
  ...
  var GlobalVariableSource = /* @__PURE__ */ function(_VariableSource) {
        ...
        return Services.cidForDoc(_this3.ampdoc).then(function(cid) {
          ...
          if (cid && cookieName == "_ga") {
            if (typeof cid === "string") {
              ...
              dev().error(TAG5, "non-string cid, what is it?", Object.keys(cid));
            }
          }
          clientIds[scope] = cid;
          return cid;
    ...
    _proto.getAccessValue_ = function getAccessValue_(getter, expr) {
      ...
      return Promise.all([Services.accessServiceForDocOrNull(element), Services.subscriptionsServiceForDocOrNull(element)]).then(function(services) {
        ...
        if (!service) {
          user().error(TAG5, "Access or subsciptions service is not installed to access: ", expr);
          return null;
        }
  ...
  var UrlReplacements = /* @__PURE__ */ function() {
    ...
    _proto2.ensureProtocolMatches_ = function ensureProtocolMatches_(url, replacement) {
      ...
      if (newProtocol != oldProtocol) {
        user().error(TAG5, "Illegal replacement of the protocol: ", url);
        return url;
      }
  ...
  function _setPrototypeOf4(o, p) {
    _setPrototypeOf4 = Object.setPrototypeOf || function _setPrototypeOf9(o2, p2) {
      o2.__proto__ = p2;
      return o2;
    };
  ...
  function _getPrototypeOf4(o) {
    _getPrototypeOf4 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf9(o2) {
      return o2.__proto__ || Object.getPrototypeOf(o2);
    };
  ...
  var A4AVariableSource = /* @__PURE__ */ function(_VariableSource) {
    _inherits4(A4AVariableSource2, _VariableSource);
    var _super = _createSuper4(A4AVariableSource2);
    ...
    _proto.htmlAttributeBinding_ = function htmlAttributeBinding_(cssSelector, var_args) {
      ...
      if (attributeNames.length > HTML_ATTR_MAX_ATTRS) {
        user().error(TAG15, "At most " + HTML_ATTR_MAX_ATTRS + " may be requested.");
        return "[]";
      }
      ...
      try {
        ...
        user().error(TAG15, "Invalid selector: " + cssSelector);
        return "[]";
      }
      if (elements2.length > HTML_ATTR_MAX_ELEMENTS_TO_TRAVERSE) {
        user().error(TAG15, "CSS selector may match at most " + (HTML_ATTR_MAX_ELEMENTS_TO_TRAVERSE + " elements."));
        return "[]";
      }
      var result = [];
  ...
  var Resource = /* @__PURE__ */ function() {
    ...
    _proto.maybeReportErrorOnBuildFailure = function maybeReportErrorOnBuildFailure(reason) {
      if (!isBlockedByConsent(reason)) {
        dev().error(TAG6, "failed to build:", this.debugid, reason);
      }
    };
    ...
    _proto.startLayout = function startLayout() {
      ...
      if (this.layoutCount_ > 0 && !this.element.isRelayoutNeeded()) {
        dev().fine(TAG6, "layout canceled since it wasn't requested:", this.debugid, this.state_);
        this.state_ = ResourceState_Enum.LAYOUT_COMPLETE;
        return resolvedPromise();
      }
      dev().fine(TAG6, "start layout:", this.debugid, "count:", this.layoutCount_);
      this.layoutCount_++;
      this.state_ = ResourceState_Enum.LAYOUT_SCHEDULED;
    ...
    _proto.layoutComplete_ = function layoutComplete_(success, signal, opt_reason) {
      ...
      if (success) {
        dev().fine(TAG6, "layout complete:", this.debugid);
      } else {
        dev().fine(TAG6, "loading failed:", this.debugid, opt_reason);
  ...
  function _setPrototypeOf5(o, p) {
    _setPrototypeOf5 = Object.setPrototypeOf || function _setPrototypeOf9(o2, p2) {
      o2.__proto__ = p2;
      return o2;
    };
  ...
  function _getPrototypeOf5(o) {
    _getPrototypeOf5 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf9(o2) {
      return o2.__proto__ || Object.getPrototypeOf(o2);
    };
  ...
  var StartupTask = /* @__PURE__ */ function(_Task) {
    _inherits5(StartupTask2, _Task);
    var _super = _createSuper5(StartupTask2);
  ...
  function onDocumentFormSubmit_(e) {
    ...
    if (method == "GET") {
      ...
      if (action) {
        var TAG15 = "form";
        user().error(TAG15, "action attribute is invalid for method=POST: %s", form);
      }
      if (!actionXhr) {
        e.preventDefault();
  ...
  function renderCreativeIntoFriendlyFrame(adUrl, size, element, creativeMetadata) {
    var iframe = createElementWithAttributes(element.ownerDocument, "iframe", dict({
      "height": size.height,
      "width": size.width,
      "frameborder": "0",
      "allowfullscreen": "",
    ...
    return installFriendlyIframeEmbed(iframe, element, {
      host: element,
      url: adUrl,
      ...
      var parentAmpdoc = element.getAmpDoc();
  ...
  // extensions/amp-a4a/0.1/template-renderer.js
  ...
  function _setPrototypeOf6(o, p) {
    _setPrototypeOf6 = Object.setPrototypeOf || function _setPrototypeOf9(o2, p2) {
      o2.__proto__ = p2;
      return o2;
    };
  ...
  function _getPrototypeOf6(o) {
    _getPrototypeOf6 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf9(o2) {
      return o2.__proto__ || Object.getPrototypeOf(o2);
    };
    return _getPrototypeOf6(o);
  }
  var TemplateRenderer = /* @__PURE__ */ function(_Renderer) {
    _inherits6(TemplateRenderer2, _Renderer);
    var _super = _createSuper6(TemplateRenderer2);
    function TemplateRenderer2() {
      return _super.call(this);
    }
    var _proto = TemplateRenderer2.prototype;
    _proto.getDocument = function getDocument(iframe) {
      return iframe.contentDocument || iframe.contentWindow.document;
    };
    _proto.render = function render(context, element, creativeData) {
      var _this = this;
      creativeData = creativeData;
      var adUrl = context.adUrl, size = context.size;
      var _creativeData = creativeData, creativeMetadata = _creativeData.creativeMetadata;
      devAssert2(size, "missing creative size");
      devAssert2(adUrl, "missing ad request url");
      return renderCreativeIntoFriendlyFrame(adUrl, size, element, creativeMetadata).then(function(iframe) {
        var templateData = creativeData.templateData;
        var data = templateData.data;
        if (!data) {
          return resolvedPromise();
        }
        var templateHelper = getAmpAdTemplateHelper(element);
        return templateHelper.render(data, _this.getDocument(iframe).body).then(function(renderedElement) {
          var analytics = templateData.analytics;
          if (analytics) {
            templateHelper.insertAnalytics(renderedElement, analytics);
          }
          var templateElement = _this.getDocument(iframe).querySelector("template");
          templateElement.parentNode.replaceChild(renderedElement, templateElement);
        });
      });
    };
    return TemplateRenderer2;
  }(Renderer);
  ...
  function _setPrototypeOf7(o, p) {
    _setPrototypeOf7 = Object.setPrototypeOf || function _setPrototypeOf9(o2, p2) {
      o2.__proto__ = p2;
      return o2;
    };
  ...
  function _getPrototypeOf7(o) {
    _getPrototypeOf7 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf9(o2) {
      return o2.__proto__ || Object.getPrototypeOf(o2);
    };
    return _getPrototypeOf7(o);
  }
  var AMP_TEMPLATED_CREATIVE_HEADER_NAME = "AMP-Ad-Template-Extension";
  var DEPRECATED_AMP_TEMPLATED_CREATIVE_HEADER_NAME = "AMP-template-amp-creative";
  var TemplateValidator = /* @__PURE__ */ function(_Validator) {
    _inherits7(TemplateValidator2, _Validator);
    var _super = _createSuper7(TemplateValidator2);
    function TemplateValidator2() {
      return _super.apply(this, arguments);
    }
    var _proto = TemplateValidator2.prototype;
    _proto.validate = function validate(context, containerElement, unvalidatedBytes, headers) {
      var body = utf8Decode(unvalidatedBytes);
      var parsedResponseBody = tryParseJson(body);
      if (!parsedResponseBody || !headers || headers.get(AMP_TEMPLATED_CREATIVE_HEADER_NAME) !== "amp-mustache" && headers.get(DEPRECATED_AMP_TEMPLATED_CREATIVE_HEADER_NAME) !== "amp-mustache") {
        return Promise.resolve({
          creativeData: {
            creative: body
          },
      ...
      return getAmpAdTemplateHelper(containerElement).fetch(parsedResponseBody.templateUrl).then(function(template) {
        var creativeMetadata = getAmpAdMetadata(template);
        creativeMetadata["extensions"] = creativeMetadata["extensions"] || [];
        var extensions = creativeMetadata["extensions"];
        mergeExtensionsMetadata(extensions, creativeMetadata["customElementExtensions"]);
        if (parsedResponseBody.analytics && !extensionsHasElement(extensions, "amp-analytics")) {
          extensions.push({
        ...
        var extensionsInfo = getExtensionsFromMetadata(creativeMetadata);
    ...
    return TemplateValidator2;
  }(Validator);

  // extensions/amp-ad-custom/0.1/amp-ad-custom.js
  ...
  function _setPrototypeOf8(o, p) {
    _setPrototypeOf8 = Object.setPrototypeOf || function _setPrototypeOf9(o2, p2) {
      o2.__proto__ = p2;
      return o2;
    };
  ...
  function _getPrototypeOf8(o) {
    _getPrototypeOf8 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf9(o2) {
      return o2.__proto__ || Object.getPrototypeOf(o2);
    };
    return _getPrototypeOf8(o);
  }
  var validator = new TemplateValidator();
  var nameFrameRenderer = new NameFrameRenderer();
  var DATA_REQUEST_PARAM_PREFIX = "requestParam";
  var AmpAdTemplate = /* @__PURE__ */ function(_AmpAdNetworkBase) {
    _inherits8(AmpAdTemplate2, _AmpAdNetworkBase);
    var _super = _createSuper8(AmpAdTemplate2);
    function AmpAdTemplate2(element) {
      var _this;
      _this = _super.call(this, element);
      _this.registerValidator(validator, AdResponseType.TEMPLATE);
      _this.registerRenderer(new TemplateRenderer(), ValidatorResult.AMP);
      _this.registerRenderer(nameFrameRenderer, ValidatorResult.NON_AMP);
      _this.baseRequestUrl_ = _this.element.getAttribute("src");
      devAssert2(_this.baseRequestUrl_, "Invalid network configuration: no request URL specified");
      _this.getContext().win = _this.win;
      return _this;
    }
    var _proto = AmpAdTemplate2.prototype;
    ...
    _proto.getRequestUrl = function getRequestUrl() {
      var _this2 = this;
      var url = this.baseRequestUrl_;
      Object.keys(this.element.dataset).forEach(function(dataField) {
        if (dataField.startsWith(DATA_REQUEST_PARAM_PREFIX)) {
          var requestParamName = dataField.slice(DATA_REQUEST_PARAM_PREFIX.length, dataField.length);
          if (requestParamName) {
            var finalParamName = requestParamName.charAt(0).toLowerCase() + requestParamName.slice(1);
            url = addParamToUrl(url, finalParamName, _this2.element.dataset[dataField]);
          }
        }
      });
    ...
    return AmpAdTemplate2;
  }(AmpAdNetworkBase);
  var TAG14 = "amp-ad-custom";
  AMP.registerElement(TAG14, AmpAdTemplate);
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
})});
//# sourceMappingURL=amp-ad-custom-0.1.max.js.map
