(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-selector",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function SelectorWithRef(_ref, ref) {
    ...
    var toggle = useCallback(function(option, select) {
  ...
  var BentoSelector = forwardRef(SelectorWithRef);
  BentoSelector.displayName = "BentoSelector";
  function BentoSelectorOption(_ref2) {
    var _objstr;
    var _propName2 = propName("class"), _propName3 = propName("tabIndex"), _ref2$as = _ref2.as, Comp = _ref2$as === void 0 ? "div" : _ref2$as, _ref2$disabled = _ref2.disabled, disabled = _ref2$disabled === void 0 ? false : _ref2$disabled, customFocus = _ref2.focus, index = _ref2.index, option = _ref2.option, _ref2$role = _ref2.role, role = _ref2$role === void 0 ? "option" : _ref2$role, _ref2$_propName = _ref2[_propName2], className = _ref2$_propName === void 0 ? "" : _ref2$_propName, tabIndex = _ref2[_propName3], rest = _objectWithoutPropertiesLoose2(_ref2, ["as", "disabled", "focus", "index", "option", "role", _propName2, _propName3].map(_toPropertyKey));
    var ref = useRef(null);
    ...
    var focus = useCallback(function() {
      customFocus == null ? void 0 : customFocus();
      if (ref.current) {
    ...
    var onKeyDown = useCallback(function(e3) {
      if (e3.key === Keys_Enum.ENTER || e3.key === Keys_Enum.SPACE) {
        trySelect();
      }
    }, [trySelect]);
    var isSelected = selected.includes(option);
    return createElement(Comp, _extends6({}, rest, {
      ...
      class: obj_str_default((_objstr = {}, _objstr[className] = !!className, _objstr[$option] = true, _objstr[$selected] = isSelected && !selectorMultiple, _objstr[$multiselected] = isSelected && selectorMultiple, _objstr[$disabled] = disabled || selectorDisabled, _objstr)),
      disabled: disabled,
      onClick: onClick,
  ...
  function getOptions(element, mu) {
    ...
    optionChildren.filter(function(el) {
      ...
      return !closestAncestorElementBySelector(devAssert(((_el$parentElement = el.parentElement) == null ? void 0 : _el$parentElement.nodeType) == 1, "Expected an element"), "[option]");
      ...
      var optionChild = createElement(BentoSelectorOption, _extends7({}, props));
      options.push(option);
  ...
  function OptionShim(_ref) {
    var disabled = _ref.disabled, onClick = _ref.onClick, onFocus = _ref.onFocus, onKeyDown = _ref.onKeyDown, _ref$role = _ref.role, role = _ref$role === void 0 ? "option" : _ref$role, selected = _ref.selected, shimDomElement = _ref.shimDomElement, tabIndex = _ref[propName("tabIndex")];
  ...
  function SelectorShim(_ref2) {
    var children = _ref2.children, disabled = _ref2.disabled, form = _ref2.form, multiple = _ref2.multiple, name = _ref2.name, onKeyDown = _ref2.onKeyDown, _ref2$role = _ref2.role, role = _ref2$role === void 0 ? "listbox" : _ref2$role, shimDomElement = _ref2.shimDomElement, value = _ref2.value, tabIndex = _ref2[propName("tabIndex")];
    ...
    useLayoutEffect(function() {
      ...
      return function() {
        return shimDomElement.removeEventListener("keydown", devAssert(onKeyDown));
      };
  ...
  BaseElement2["Component"] = BentoSelector;
  ...
  var AmpSelector = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpSelector2, _BaseElement);
    var _super = _createSuper4(AmpSelector2);
    ...
    _proto.triggerEvent = function triggerEvent(element, eventName, detail) {
      var event = createCustomEvent(getWin(element), "amp-selector." + eventName, detail);
  ...
  AMP.registerElement(TAG2, AmpSelector, CSS2);
})();
