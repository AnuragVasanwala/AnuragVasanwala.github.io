(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-reach-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpReachPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpReachPlayer2, _AMP$BaseElement);
    var _super = _createSuper(AmpReachPlayer2);
    function AmpReachPlayer2(element) {
      var _this;
    ...
    var _proto = AmpReachPlayer2.prototype;
    ...
    _proto.pauseCallback = function pauseCallback() {
      if (this.iframe_ && this.iframe_.contentWindow) {
        this.iframe_.contentWindow.postMessage("pause", "https://player-cdn.beachfrontmedia.com");
      }
    };
    return AmpReachPlayer2;
  }(AMP.BaseElement);
