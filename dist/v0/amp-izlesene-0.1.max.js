(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-izlesene",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpIzlesene = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpIzlesene2, _AMP$BaseElement);
    var _super = _createSuper(AmpIzlesene2);
    function AmpIzlesene2(element) {
      var _this;
    ...
    var _proto = AmpIzlesene2.prototype;
    ...
    _proto.buildCallback = function buildCallback() {
      ...
      this.videoid_ = userAssert2(this.element.getAttribute("data-videoid"), "The data-videoid attribute is required for <amp-izlesene> %s", this.element);
    };
    ...
    _proto.pauseCallback = function pauseCallback() {
      if (this.iframe_ && this.iframe_.contentWindow) {
        this.iframe_.contentWindow.postMessage(dict({
          "command": "pause"
        }), "*");
      }
    };
