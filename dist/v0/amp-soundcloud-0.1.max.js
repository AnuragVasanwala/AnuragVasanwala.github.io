(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-soundcloud",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpSoundcloud = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpSoundcloud2, _AMP$BaseElement);
    var _super = _createSuper(AmpSoundcloud2);
    function AmpSoundcloud2(element) {
      var _this;
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      var mediaid = userAssert2(this.element.getAttribute("data-trackid") || this.element.getAttribute("data-playlistid"), "data-trackid or data-playlistid is required for <amp-soundcloud> %s", this.element);
