(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-brightcove",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  function getBrightcoveIframeSrc(account, player, embed, playlistId, videoId, referrer, additionalParams) {
    ...
    return addParamsToUrl("https://players.brightcove.net/" + encodeURIComponent(account) + ("/" + encodeURIComponent(player)) + ("_" + encodeURIComponent(embed) + "/index.html") + "?amp=1" + playlistOrVideoParam, _extends({}, additionalParams, {
      referrer: referrer,
      playsinline: true,
      autoplay: void 0
    }));
  ...
  var AmpBrightcove = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.getConsents_ = function getConsents_() {
      var _this3 = this;
    ...
    _proto.handlePlayerMessage_ = function handlePlayerMessage_(event) {
      ...
      if (redispatch(element, eventType, _extends2({
    ...
    _proto.getIframeSrc_ = function getIframeSrc_() {
      ...
      if (this.consentSharedData_) {
        urlParams["ampConsentSharedData"] = JSON.stringify(this.consentSharedData_);
      }
      ...
      var _el$dataset = el.dataset, _el$dataset$embed = _el$dataset["embed"], embed = _el$dataset$embed === void 0 ? "default" : _el$dataset$embed, playlistId = _el$dataset["playlistId"], referrer = _el$dataset["referrer"], videoId = _el$dataset["videoId"];
      return getBrightcoveIframeSrc(account, this.playerId_, embed, playlistId, videoId, referrer != null ? this.urlReplacements_.expandUrlSync(referrer) : referrer, _extends2({}, urlParams, getDataParamsFromAttributes(el)));
    };
  ...
  AMP.registerElement(TAG2, AmpBrightcove);
})();
