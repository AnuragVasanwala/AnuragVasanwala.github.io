(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-google-document-embed",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-google-document-embed/0.1/amp-google-document-embed.js
  ...
  var AmpDriveViewer = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpDriveViewer2, _AMP$BaseElement);
    var _super = _createSuper(AmpDriveViewer2);
    function AmpDriveViewer2(element) {
      var _this;
      _this = _super.call(this, element);
      _this.iframe_ = null;
      return _this;
    }
    var _proto = AmpDriveViewer2.prototype;
    ...
    _proto.buildCallback = function buildCallback() {
      userAssert2(this.element.getAttribute("src"), "The src attribute is required for <amp-google-document-embed> %s", this.element);
    };
    ...
    _proto.mutatedAttributesCallback = function mutatedAttributesCallback(mutations) {
      ...
      var iframe = dev().assertElement(this.iframe_);
      propagateAttributes(attrs, this.element, iframe, true);
    ...
    _proto.getSrc_ = function getSrc_(src) {
      ...
      return addParamToUrl("https://docs.google.com/gview?embedded=true", "url", src);
    };
