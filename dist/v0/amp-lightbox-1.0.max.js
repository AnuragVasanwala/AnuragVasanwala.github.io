(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-lightbox",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-lightbox/1.0/base-element.js
  ...
  BaseElement2["Component"] = BentoLightbox;
  BaseElement2["props"] = {
    "animation": {
      attr: "animation",
      media: true,
  ...
  // build/amp-lightbox-1.0.css.js
  var CSS3 = "amp-lightbox[hidden]{display:none!important}amp-lightbox{width:100%;height:100%;position:fixed;box-sizing:border-box;background-color:rgba(0,0,0,0.9);color:#fff;visibility:hidden}amp-lightbox::part(lightbox){background:inherit;color:inherit}\n/*# sourceURL=/extensions/amp-lightbox/1.0/amp-lightbox.css*/";
  ...
  // extensions/amp-lightbox/1.0/amp-lightbox.js
  ...
  var TAG2 = "amp-lightbox";
  var AmpLightbox = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpLightbox2, _BaseElement);
    var _super = _createSuper4(AmpLightbox2);
    ...
    _proto.init = function init() {
      ...
      this.registerApiAction(DEFAULT_ACTION, function(api) {
        return api.open();
    ...
    _proto.triggerEvent = function triggerEvent(element, eventName, detail) {
      var event = createCustomEvent(getWin(element), "amp-lightbox." + eventName, detail);
    ...
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-lightbox"), 'expected global "bento" or specific "bento-lightbox" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    _proto.afterOpen = function afterOpen() {
  ...
  AMP.registerElement(TAG2, AmpLightbox, CSS3);
})();
...
//# sourceMappingURL=amp-lightbox-1.0.max.js.map
