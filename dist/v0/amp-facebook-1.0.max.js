(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-facebook",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function ProxyIframeEmbedWithRef(_ref, ref) {
    ...
    return createElement(IframeEmbed, _extends9({
      allow: allow,
  ...
  var _excluded4 = ["action", "colorscheme", "embedAs", "hideCover", "hideCta", "href", "includeCommentParent", "kdSite", "layout", "locale", "numPosts", "onLoad", "orderBy", "refLabel", "requestResize", "share", "showFacepile", "showText", "size", "smallHeader", "style", "tabs", "title"];
  function _extends10() {
  ...
  function BentoFacebookWithRef(_ref, ref) {
    var action = _ref.action, colorscheme = _ref.colorscheme, embedAs = _ref.embedAs, hideCover = _ref.hideCover, hideCta = _ref.hideCta, href = _ref.href, includeCommentParent = _ref.includeCommentParent, kdSite = _ref.kdSite, layout = _ref.layout, localeProp = _ref.locale, numPosts = _ref.numPosts, onLoad = _ref.onLoad, orderBy = _ref.orderBy, refLabel = _ref.refLabel, requestResize = _ref.requestResize, share = _ref.share, showFacepile = _ref.showFacepile, showText = _ref.showText, size = _ref.size, smallHeader = _ref.smallHeader, style = _ref.style, tabs = _ref.tabs, _ref$title = _ref.title, title = _ref$title === void 0 ? DEFAULT_TITLE : _ref$title, rest = _objectWithoutPropertiesLoose6(_ref, _excluded4);
    ...
    return createElement(ProxyIframeEmbed, _extends10({
      options: options,
      ref: ref,
      title: title
    }, rest, {
      ...
      messageHandler: messageHandler,
      type: TYPE,
      style: height ? _extends10({}, style, {
        height: height
      }) : style
    }));
  }
  var BentoFacebook = forwardRef(BentoFacebookWithRef);
  BentoFacebook.displayName = "BentoFacebook";

  // extensions/amp-facebook/1.0/base-element.js
  ...
  BaseElement2["Component"] = BentoFacebook;
  ...
  function parseEmbed(element) {
    var embedAs = element.getAttribute("data-embed-as");
    userAssert(!embedAs || ["post", "video", "comment", "comments", "like", "page"].indexOf(embedAs) !== -1, 'Attribute data-embed-as for <amp-facebook> value is wrong, should be "post", "video", "comment", "comments", "like", or "page", but was: %s', embedAs);
    return embedAs;
  }
  BaseElement2["layoutSizeDefined"] = true;
  BaseElement2["usesShadowDom"] = true;
  var CommentsBaseElement = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(CommentsBaseElement2, _BaseElement);
    var _super2 = _createSuper3(CommentsBaseElement2);
    function CommentsBaseElement2() {
      return _super2.apply(this, arguments);
    }
    return CommentsBaseElement2;
  }(BaseElement2);
  CommentsBaseElement["staticProps"] = {
    "embedAs": "comments"
  };
  var LikeBaseElement = /* @__PURE__ */ function(_BaseElement2) {
    _inherits3(LikeBaseElement2, _BaseElement2);
    var _super3 = _createSuper3(LikeBaseElement2);
    function LikeBaseElement2() {
      return _super3.apply(this, arguments);
    }
    return LikeBaseElement2;
  }(BaseElement2);
  LikeBaseElement["staticProps"] = {
    "embedAs": "like"
  };
  var PageBaseElement = /* @__PURE__ */ function(_BaseElement3) {
    _inherits3(PageBaseElement2, _BaseElement3);
    var _super4 = _createSuper3(PageBaseElement2);
    function PageBaseElement2() {
      return _super4.apply(this, arguments);
    }
    return PageBaseElement2;
  }(BaseElement2);
  PageBaseElement["staticProps"] = {
    "embedAs": "page"
  };
  ...
  // extensions/amp-facebook/1.0/amp-facebook.js
  ...
  var TAG2 = "amp-facebook";
  var COMMENTS_TAG = "amp-facebook-comments";
  var LIKE_TAG = "amp-facebook-like";
  var PAGE_TAG = "amp-facebook-page";
  var TYPE2 = "facebook";
  function AmpFacebookMixin(clazz1) {
    return /* @__PURE__ */ function(_clazz) {
      _inherits4(_class, _clazz);
      var _super = _createSuper4(_class);
      function _class() {
        return _super.apply(this, arguments);
      }
      _class.createLoaderLogoCallback = function createLoaderLogoCallback(element) {
        return createLoaderLogo(element);
      };
      _class.getPreconnects = function getPreconnects(element) {
      ...
      _proto.init = function init() {
        ...
        return dict({
          "requestResize": function requestResize(height) {
            return _this.attemptChangeHeight(height);
          }
        });
      };
      _proto.isLayoutSupported = function isLayoutSupported(layout) {
        userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-facebook"), 'expected global "bento" or specific "bento-facebook" experiment to be enabled');
        return _clazz.prototype.isLayoutSupported.call(this, layout);
      };
      return _class;
    }(clazz1);
  }
  var AmpFacebook = /* @__PURE__ */ function(_AmpFacebookMixin) {
    _inherits4(AmpFacebook2, _AmpFacebookMixin);
    var _super2 = _createSuper4(AmpFacebook2);
    function AmpFacebook2() {
      return _super2.apply(this, arguments);
    }
    return AmpFacebook2;
  }(AmpFacebookMixin(BaseElement2));
  var AmpFacebookComments = /* @__PURE__ */ function(_AmpFacebookMixin2) {
    _inherits4(AmpFacebookComments2, _AmpFacebookMixin2);
    var _super3 = _createSuper4(AmpFacebookComments2);
    function AmpFacebookComments2() {
      return _super3.apply(this, arguments);
    }
    return AmpFacebookComments2;
  }(AmpFacebookMixin(CommentsBaseElement));
  var AmpFacebookLike = /* @__PURE__ */ function(_AmpFacebookMixin3) {
    _inherits4(AmpFacebookLike2, _AmpFacebookMixin3);
    var _super4 = _createSuper4(AmpFacebookLike2);
    function AmpFacebookLike2() {
      return _super4.apply(this, arguments);
    }
    return AmpFacebookLike2;
  }(AmpFacebookMixin(LikeBaseElement));
  var AmpFacebookPage = /* @__PURE__ */ function(_AmpFacebookMixin4) {
    _inherits4(AmpFacebookPage2, _AmpFacebookMixin4);
    var _super5 = _createSuper4(AmpFacebookPage2);
    function AmpFacebookPage2() {
      return _super5.apply(this, arguments);
    }
    return AmpFacebookPage2;
  }(AmpFacebookMixin(PageBaseElement));
  AMP.registerElement(TAG2, AmpFacebook);
...
//# sourceMappingURL=amp-facebook-1.0.max.js.map
