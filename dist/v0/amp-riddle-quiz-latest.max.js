(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-riddle-quiz",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpRiddleQuiz = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    var _proto = AmpRiddleQuiz2.prototype;
    _proto.handleMessage_ = function handleMessage_(event) {
    ...
    _proto.layoutCallback = function layoutCallback() {
      this.riddleId_ = userAssert2(this.element.getAttribute("data-riddle-id"), "The data-riddle-id attribute is required for <amp-riddle-quiz> %s", this.element);
    ...
    _proto.riddleHeightChanged_ = function riddleHeightChanged_(height) {
