(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-facebook-page",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TYPE = "facebook";
  var AmpFacebookPage = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpFacebookPage2, _AMP$BaseElement);
    var _super = _createSuper(AmpFacebookPage2);
    AmpFacebookPage2.createLoaderLogoCallback = function createLoaderLogoCallback(element) {
      return createLoaderLogo(element);
    };
    function AmpFacebookPage2(element) {
      var _this;
    ...
    var _proto = AmpFacebookPage2.prototype;
