(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-date-countdown",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-date-countdown/0.1/amp-date-countdown.js
  ...
  var AmpDateCountdown = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpDateCountdown2, _AMP$BaseElement);
    var _super = _createSuper(AmpDateCountdown2);
    ...
    _proto.buildCallback = function buildCallback() {
      ...
      this.getAmpDoc().whenFirstVisible().then(function() {
        var EPOCH = _this2.getEpoch_() + _this2.offsetSeconds_ * 1e3;
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      var differentBetween = new Date(EPOCH) - new Date() - DELAY;
    ...
    _proto.tickCountDown_ = function tickCountDown_(differentBetween) {
      var items = {};
      var DIFF = this.getYDHMSFromMs_(differentBetween, this.countUp_) || {};
      if (this.whenEnded_ === "stop" && differentBetween < 1e3) {
        Services.actionServiceForDoc(this.element).trigger(this.element, "timeout", null, ActionTrust_Enum.LOW);
        this.win.clearInterval(this.countDownTimer_);
      }
    ...
    _proto.getEpoch_ = function getEpoch_() {
      ...
      userAssert2(!isNaN(epoch), "One of end-date, timeleft-ms, timestamp-ms, timestamp-seconds is required");
      return epoch;
    };
    _proto.getLocaleWord_ = function getLocaleWord_(locale) {
    ...
    _proto.getYDHMSFromMs_ = function getYDHMSFromMs_(ms, countUp) {
      var TimeUnit = {
        DAYS: 1,
        HOURS: 2,
        MINUTES: 3,
    ...
    _proto.supportBackDate_ = function supportBackDate_(input) {
      if (input < 0) {
        return input + 1;
      }
      return input;
    ...
    _proto.rendered_ = function rendered_(element) {
      ...
      return this.mutateElement(function() {
        var template = _this4.templates_.findTemplate(_this4.element);
        var isChildTemplate = _this4.element.contains(template);
        removeChildren(_this4.element);
        if (isChildTemplate) {
