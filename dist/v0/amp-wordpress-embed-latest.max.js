(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-wordpress-embed",ev:"1.0",l:true,f:(function(AMP,_){
(function() {
  ...
  var _excluded3 = ["onLoad", "requestResize", "title", "url"];
  function _extends9() {
  ...
  var useCallback2 = useCallback;
  var useEffect2 = useEffect;
  var useMemo2 = useMemo;
  var useRef2 = useRef;
  var useState2 = useState;
  var NO_HEIGHT_STYLE = dict();
  function BentoWordPressEmbedWithRef(_ref, ref) {
    var onLoad = _ref.onLoad, requestResize = _ref.requestResize, _ref$title = _ref.title, title = _ref$title === void 0 ? "WordPress Embed" : _ref$title, url = _ref.url, rest = _objectWithoutPropertiesLoose5(_ref, _excluded3);
    ...
    var contentRef = useRef2(null);
    var _useState3 = useState2(null), win = _useState3[0], setWin = _useState3[1];
    var onLoadRef = useValueRef(onLoad);
    var iframeURL = useMemo2(function() {
      return addParamToUrl(url, "embed", "true");
    }, [url]);
    var matchesMessagingOrigin = useCallback2(function(testURL) {
    ...
    useEffect2(function() {
      ...
      setWin((_contentRef$current = contentRef.current) == null ? void 0 : (_contentRef$current$o = _contentRef$current.ownerDocument) == null ? void 0 : _contentRef$current$o.defaultView);
    }, []);
    if (!checkProps(url)) {
      return null;
    }
  ...
  var BentoWordPressEmbed = forwardRef(BentoWordPressEmbedWithRef);
  BentoWordPressEmbed.displayName = "BentoWordPressEmbed";
  ...
  BaseElement2["Component"] = BentoWordPressEmbed;
  BaseElement2["props"] = {
    url: {
      attr: "data-url",
      default: ""
  ...
  var TAG2 = "amp-wordpress-embed";
  var AmpWordPressEmbed = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpWordPressEmbed2, _BaseElement);
    var _super = _createSuper4(AmpWordPressEmbed2);
    function AmpWordPressEmbed2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpWordPressEmbed2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-wordpress-embed"), 'expected global "bento" or specific "bento-wordpress-embed" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    _proto.init = function init() {
      var _this = this;
      return dict({
        "requestResize": function requestResize(height) {
          return _this.attemptChangeHeight(height).catch(function() {
          });
        }
      });
    };
    return AmpWordPressEmbed2;
  }(BaseElement2);
  AMP.registerElement(TAG2, AmpWordPressEmbed);
})();
...
//# sourceMappingURL=amp-wordpress-embed-1.0.max.js.map
