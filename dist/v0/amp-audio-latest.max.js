(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-audio",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpAudio = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    var _proto = AmpAudio2.prototype;
    ...
    _proto.mutatedAttributesCallback = function mutatedAttributesCallback(mutations) {
      ...
      if (src !== void 0 || controlsList !== void 0 || loop !== void 0) {
        ...
        propagateAttributes(["src", "loop", "controlsList"], this.element, this.audio_);
      }
    ...
    _proto.buildAudioElement = function buildAudioElement() {
      var _this2 = this;
      ...
      propagateAttributes(["src", "preload", "autoplay", "muted", "loop", "aria-label", "aria-describedby", "aria-labelledby", "controlsList"], this.element, audio);
      applyFillContent(audio);
      realChildNodes(this.element).forEach(function(child) {
    ...
    _proto.updateMetadata_ = function updateMetadata_() {
    ...
    _proto.getElementAttribute_ = function getElementAttribute_(attr) {
    ...
    _proto.isInvocationValid_ = function isInvocationValid_() {
      return !!this.audio_;
    };
    ...
    _proto.setPlayingStateForTesting_ = function setPlayingStateForTesting_(isPlaying) {
      if (getMode().test) {
        this.isPlaying = isPlaying;
      }
    };
    _proto.audioPlaying_ = function audioPlaying_() {
      var _this3 = this;
      var playHandler = function playHandler2() {
        tryPlay(_this3.audio_);
