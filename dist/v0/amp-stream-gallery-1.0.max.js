(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-stream-gallery",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  var _excluded2 = ["animation", "children", "closeButtonAs", "onAfterClose", "onAfterOpen", "onBeforeOpen"];
  function _extends7() {
  ...
  function BentoLightboxWithRef(_ref, ref) {
    var _ref$animation = _ref.animation, animation = _ref$animation === void 0 ? "fade-in" : _ref$animation, children = _ref.children, closeButtonAs = _ref.closeButtonAs, onAfterClose = _ref.onAfterClose, onAfterOpen = _ref.onAfterOpen, onBeforeOpen = _ref.onBeforeOpen, rest = _objectWithoutPropertiesLoose4(_ref, _excluded2);
    ...
    return mounted && createElement(ContainWrapper, _extends7({
      ref: lightboxRef,
      size: true,
      layout: true,
      paint: true,
  ...
  function BentoLightboxGalleryProviderWithRef(_ref, ref) {
    ...
    return createElement(Fragment, null, createElement(BentoLightbox, {
      ...
      class: obj_str_default((_objstr4 = {}, _objstr4[$gallery2] = true, _objstr4[$grid] = true, _objstr4))
  ...
  function NavButtonIcon(_ref4) {
    ...
    return createElement("svg", {
      "aria-disabled": ariaDisabled,
      class: obj_str_default((_objstr6 = {}, _objstr6[$arrow3] = true, _objstr6[$control] = true, _objstr6[$prevArrow] = by < 0, _objstr6[$nextArrow] = by > 0, _objstr6)),
      disabled: disabled,
      onClick: onClick,
      role: "button",
      tabIndex: "0",
  ...
  var _excluded3 = ["alt", "aria-label", "as", "caption", "children", "enableActivation", "group", "onMount", "render", "srcset"];
  function _extends9() {
  ...
  function WithBentoLightboxGallery(_ref) {
    ...
    return createElement(Comp, _extends9({}, activationProps, {
      srcset: srcset
    }, rest), children);
  }
  ...
  function BentoBaseCarouselWithRef(_ref, ref) {
    ...
    return createElement(ContainWrapper, _extends10({
      ...
      }, cloneElement(child, _extends10({}, child.props, {
        thumbnailSrc: void 0
      })));
  ...
  function BentoStreamGalleryWithRef(props, ref) {
    var _objstr;
    var _propName = propName("class"), _props$arrowPrevAs = props.arrowPrevAs, arrowPrevAs = _props$arrowPrevAs === void 0 ? DefaultArrow2 : _props$arrowPrevAs, _props$arrowNextAs = props.arrowNextAs, arrowNextAs = _props$arrowNextAs === void 0 ? DefaultArrow2 : _props$arrowNextAs, children = props.children, className = props[_propName], extraSpace = props.extraSpace, _props$maxItemWidth = props.maxItemWidth, maxItemWidth = _props$maxItemWidth === void 0 ? Number.MAX_VALUE : _props$maxItemWidth, _props$minItemWidth = props.minItemWidth, minItemWidth = _props$minItemWidth === void 0 ? 1 : _props$minItemWidth, _props$maxVisibleCoun = props.maxVisibleCount, maxVisibleCount = _props$maxVisibleCoun === void 0 ? Number.MAX_VALUE : _props$maxVisibleCoun, _props$minVisibleCoun = props.minVisibleCount, minVisibleCount = _props$minVisibleCoun === void 0 ? 1 : _props$minVisibleCoun, outsetArrows = props.outsetArrows, _props$peek = props.peek, peek = _props$peek === void 0 ? 0 : _props$peek, _props$slideAlign = props.slideAlign, slideAlign = _props$slideAlign === void 0 ? "start" : _props$slideAlign, rest = _objectWithoutPropertiesLoose7(props, ["arrowPrevAs", "arrowNextAs", "children", _propName, "extraSpace", "maxItemWidth", "minItemWidth", "maxVisibleCount", "minVisibleCount", "outsetArrows", "peek", "slideAlign"].map(_toPropertyKey3));
    var carouselRef = useRef(null);
    var _useState = useState(DEFAULT_VISIBLE_COUNT), visibleCount = _useState[0], setVisibleCount = _useState[1];
    var _toChildArray = toChildArray(children), length = _toChildArray.length;
    var measure = useCallback(function(containerWidth) {
      return getVisibleCount(maxItemWidth, minItemWidth, maxVisibleCount, minVisibleCount, length, outsetArrows, peek, containerWidth, carouselRef.current.node);
    }, [maxItemWidth, minItemWidth, maxVisibleCount, minVisibleCount, length, outsetArrows, peek]);
    useImperativeHandle(ref, function() {
      return {
        goToSlide: function goToSlide(index) {
    ...
    return createElement(BentoBaseCarousel, _extends11({
      advanceCount: Math.floor(visibleCount),
      arrowPrevAs: arrowPrevAs,
      arrowNextAs: arrowNextAs,
      class: obj_str_default((_objstr = {}, _objstr[className] = !!className, _objstr[$gallery] = true, _objstr[$extraSpace] = extraSpace === "around", _objstr)),
      outsetArrows: outsetArrows,
  ...
  var BentoStreamGallery = forwardRef(BentoStreamGalleryWithRef);
  BentoStreamGallery.displayName = "StreamGallery";
  function DefaultArrow2(_ref) {
    var _objstr2;
    var ariaDisabled = _ref["aria-disabled"], by = _ref.by, disabled = _ref.disabled, onClick = _ref.onClick, outsetArrows = _ref.outsetArrows, className = _ref[propName("class")];
    return createElement("div", {
      class: className
    }, createElement("button", {
      "aria-disabled": ariaDisabled,
      "aria-hidden": "true",
      class: obj_str_default((_objstr2 = {}, _objstr2[$arrow2] = true, _objstr2[$arrowPrev2] = by < 0, _objstr2[$arrowNext2] = by > 0, _objstr2[$outsetArrow2] = outsetArrows, _objstr2[$insetArrow2] = !outsetArrows, _objstr2)),
      disabled: disabled,
      onClick: onClick
    }, createElement("svg", {
      viewBox: "0 0 24 24",
  ...
  BaseElement2["Component"] = BentoStreamGallery;
  ...
  var CSS4 = "amp-stream-gallery{display:block;overflow:hidden;position:relative}amp-stream-gallery:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-stream-gallery/1.0/amp-stream-gallery.css*/";
  ...
  function experimentToggles(win) {
    ...
    var buildExperimentConfigs = _extends12({}, (_win$AMP_CONFIG3 = win.AMP_CONFIG) != null ? _win$AMP_CONFIG3 : {}, (_win$AMP_EXP = win.AMP_EXP) != null ? _win$AMP_EXP : parseJson(((_win$__AMP_EXP = win.__AMP_EXP) == null ? void 0 : _win$__AMP_EXP.textContent) || "{}"));
  ...
  var AmpStreamGallery = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpStreamGallery2, _BaseElement);
    var _super = _createSuper4(AmpStreamGallery2);
    ...
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert2(isExperimentOn(this.win, "bento-stream-gallery") || isExperimentOn(this.win, "bento"), 'expected global "bento" or specific "bento-stream-gallery" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    _proto.triggerEvent = function triggerEvent(element, eventName, detail) {
      var event = createCustomEvent(getWin(element), "amp-stream-gallery." + eventName, detail);
      Services.actionServiceForDoc(element).trigger(element, eventName, event, ActionTrust_Enum.HIGH);
      _BaseElement.prototype.triggerEvent.call(this, element, eventName, detail);
    };
    return AmpStreamGallery2;
  }(BaseElement2);
  AMP.registerElement(TAG2, AmpStreamGallery, CSS4);
})();
