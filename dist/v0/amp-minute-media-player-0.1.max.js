(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-minute-media-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TAG2 = "amp-minute-media-player";
  var AmpMinuteMediaPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpMinuteMediaPlayer2, _AMP$BaseElement);
    var _super = _createSuper(AmpMinuteMediaPlayer2);
    function AmpMinuteMediaPlayer2(element) {
      var _this;
      ...
      _this.contentId_ = "";
      _this.scannedElementType_ = "";
      _this.scannedElement_ = "";
      _this.tags_ = "";
      _this.minimumDateFactor_ = "";
      _this.scopedKeywords_ = "";
    ...
    var _proto = AmpMinuteMediaPlayer2.prototype;
    ...
    _proto.initFields_ = function initFields_() {
      var element = this.element;
      this.contentType_ = userAssert2(element.getAttribute("data-content-type"), "The data-content-type must be specified for <amp-minute-media-player> %s", element);
      if (this.contentType_ != "semantic") {
        this.contentId_ = userAssert2(element.getAttribute("data-content-id"), "The data-content-id must be specified for %s data-content-type in <amp-minute-media-player> %s", this.contentType_, element);
      } else {
        this.initSemanticFields_();
      }
    };
    _proto.initSemanticFields_ = function initSemanticFields_() {
      var element = this.element;
      this.scannedElement_ = element.getAttribute("data-scanned-element") || "";
      this.tags_ = element.getAttribute("data-tags") || "";
      this.minimumDateFactor_ = element.getAttribute("data-minimum-date-factor") || "";
      this.scannedElementType_ = element.getAttribute("data-scanned-element-type") || "";
      this.scopedKeywords_ = element.getAttribute("data-scoped-keywords") || "";
    };
    _proto.handleMinuteMediaPlayerMessage_ = function handleMinuteMediaPlayerMessage_(event) {
    ...
    _proto.iframeSource_ = function iframeSource_() {
      var baseUrl = "https://www.oo-syringe.com/prod/AMP/minute-media-player.html";
      var moreQueryParams = dict({
        "content_type": this.contentType_ || void 0,
        "content_id": this.contentId_ || void 0,
        "scanned_element_type": this.scannedElementType_ || void 0,
        "scanned_element": this.scannedElement_ || void 0,
        "tags": this.tags_ || void 0,
        "minimum_date_factor": this.minimumDateFactor_ || void 0,
        "scoped_keywords": this.scopedKeywords_ || void 0,
        "player_id": this.playerId_ || void 0
      });
    ...
    _proto.layoutCallback = function layoutCallback() {
      var _this2 = this;
      var element = this.element;
      var iframe = createFrameFor(this, this.iframeSource_());
      this.iframe_ = iframe;
      this.unlistenMessage_ = listen(this.win, "message", function(event) {
        return _this2.handleMinuteMediaPlayerMessage_(event);
      });
    ...
    _proto.sendCommand_ = function sendCommand_(message) {
      var _this3 = this;
      this.playerReadyPromise_.then(function() {
        if (_this3.iframe_ && _this3.iframe_.contentWindow) {
          _this3.iframe_.contentWindow.postMessage(message, "https://www.oo-syringe.com");
        }
      });
    };
    _proto.supportsPlatform = function supportsPlatform() {
    ...
    return AmpMinuteMediaPlayer2;
  }(AMP.BaseElement);
  AMP.registerElement(TAG2, AmpMinuteMediaPlayer);
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
})});
//# sourceMappingURL=amp-minute-media-player-0.1.max.js.map
