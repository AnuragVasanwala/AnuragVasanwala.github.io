(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-ad-network-adzerk-impl",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TAG15 = "amp-ad-network-adzerk-impl";
  ...
  var AmpAdNetworkAdzerkImpl = /* @__PURE__ */ function(_AmpA4A) {
    ...
    var _proto = AmpAdNetworkAdzerkImpl2.prototype;
    _proto.isValidElement = function isValidElement() {
    ...
    _proto.getAdUrl = function getAdUrl() {
      ...
      devAssert2(data, "Expected data-r attribte on amp-ad tag");
    ...
    _proto.maybeValidateAmpCreative = function maybeValidateAmpCreative(bytes, headers) {
      ...
      return tryResolve(function() {
        ...
        return ampAdTemplateHelper.fetch(_this2.ampCreativeJson_.templateUrl).then(function(parsedTemplate) {
          ...
          dev().warn(TAG15, "Error fetching/expanding template", _this2.ampCreativeJson_, error);
          _this2.forceCollapse();
          return Promise.reject(NO_CONTENT_RESPONSE);
        });
      });
    };
    _proto.parseMetadataFromCreative = function parseMetadataFromCreative(creative) {
    ...
    _proto.getAmpAdMetadata = function getAmpAdMetadata(unusedCreative) {
    ...
    _proto.onCreativeRender = function onCreativeRender(unusedMetadata) {
      var _this3 = this;
