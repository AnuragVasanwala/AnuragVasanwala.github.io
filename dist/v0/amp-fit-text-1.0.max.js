(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-fit-text",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  // extensions/amp-fit-text/1.0/component.jss.js
  ...
  function resetStyles(element, properties) {
    for (var i4 = 0; i4 < properties.length; i4++) {
      setStyle(element, properties[i4], null);
    }
  }
  ...
  // extensions/amp-fit-text/1.0/component.js
  var _excluded2 = ["children", "maxFontSize", "minFontSize"];
  function _extends3() {
  ...
  function BentoFitText(_ref) {
    var children = _ref.children, _ref$maxFontSize = _ref.maxFontSize, maxFontSize = _ref$maxFontSize === void 0 ? 72 : _ref$maxFontSize, _ref$minFontSize = _ref.minFontSize, minFontSize = _ref$minFontSize === void 0 ? 6 : _ref$minFontSize, rest = _objectWithoutPropertiesLoose4(_ref, _excluded2);
    ...
    var resize = useCallback(function() {
      ...
      var fontSize = calculateFontSize(measurerRef.current, clientHeight, clientWidth, minFontSize, maxFontSize);
    ...
    return createElement(ContainWrapper, _extends3({
      ...
      contentClassName: $fitTextContentWrapper
    }, rest), createElement("div", {
      ref: measurerRef,
      class: $fitTextContent
    }, createElement("div", {
      ref: heightRef,
      class: $minContentHeight
    }, children)));
  }
  function calculateFontSize(measurer, expectedHeight, expectedWidth, minFontSize, maxFontSize) {
    ...
    while (maxFontSize - minFontSize > 1) {
      ...
      var width = measurer.scrollWidth;
      var height = measurer.scrollHeight;
  ...
  function setOverflowStyle(measurer, maxHeight, fontSize) {
    var overflowed = measurer.scrollHeight > maxHeight;
  ...
  BaseElement2["Component"] = BentoFitText;
  BaseElement2["props"] = {
    "children": {
      passthrough: true
    },
  ...
  // build/amp-fit-text-1.0.css.js
  var CSS3 = "amp-fit-text{display:block;overflow:hidden;position:relative}amp-fit-text:not(.i-amphtml-built){color:transparent!important}amp-fit-text:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-fit-text/1.0/amp-fit-text.css*/";
  ...
  // extensions/amp-fit-text/1.0/amp-fit-text.js
  ...
  var TAG2 = "amp-fit-text";
  var AmpFitText = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpFitText2, _BaseElement);
    var _super = _createSuper4(AmpFitText2);
    function AmpFitText2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpFitText2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-fit-text"), 'expected global "bento" or specific "bento-fit-text" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpFitText2;
  }(BaseElement2);
  AMP.registerElement(TAG2, AmpFitText, CSS3);
})();
...
//# sourceMappingURL=amp-fit-text-1.0.max.js.map
