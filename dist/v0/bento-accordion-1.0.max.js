...
(function() {
  ...
  function BentoAccordionWithRef(_ref, ref) {
    ...
    var registerSection = useCallback(function(id2, defaultExpanded, _ref2) {
      ...
      eventMapRef.current = _extends7({}, eventMapRef.current, (_extends22 = {}, _extends22[id2] = onExpandStateChange, _extends22));
      return function() {
        setExpandedMap(function(expandedMap2) {
    ...
    return createElement(Comp, _extends7({
      id: id
  ...
  function setExpanded(id, value, expandedMap, expandSingleSection) {
    ...
    if (expandSingleSection && value) {
      ...
      var _extends32;
      newExpandedMap = _extends7({}, expandedMap, (_extends32 = {}, _extends32[id] = value, _extends32));
    }
    return newExpandedMap;
  }
  function BentoAccordionSection(_ref3) {
    ...
    return createElement(Comp, _extends7({}, rest), createElement(SectionContext.Provider, {
      value: context2
    }, children));
  }
  ...
  function BentoAccordionContent(_ref5) {
    ...
    return createElement(WithAmpContext, {
      renderable: expanded
    }, createElement(Comp, _extends7({}, rest, {
      ref: ref,
  ...
  function getState(element, mu, getExpandStateTrigger) {
    ...
    var children = sections.map(function(section) {
      ...
      return createElement(BentoAccordionSection, _extends8({}, sectionProps), createElement(BentoAccordionHeader, _extends8({}, headerProps)), createElement(BentoAccordionContent, _extends8({}, contentProps)));
    });
    return dict({
      "children": children
    });
  ...
  // extensions/amp-accordion/1.0/build/bento-accordion.js
  function defineElement() {
    customElements.define("bento-accordion", BaseElement2.CustomElement(BaseElement2));
  }
  defineElement();
})();
...
//# sourceMappingURL=bento-accordion-1.0.max.js.map
