(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-base-carousel",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function BentoLightboxWithRef(_ref, ref) {
    ...
    return mounted && createElement(ContainWrapper, _extends3({
      ref: lightboxRef,
      size: true,
      layout: true,
      paint: true,
  ...
  function WithBentoLightboxGallery(_ref) {
    ...
    var activationProps = useMemo(function() {
      return enableActivation && _extends5({}, DEFAULT_ACTIVATION_PROPS, {
        onClick: function onClick() {
          open2(Number(genKey) - 1, group);
        }
      });
    }, [enableActivation, genKey, group, open2]);
    return createElement(Comp, _extends5({}, activationProps, {
      srcset: srcset
    }, rest), children);
  }
  ...
  function BentoBaseCarouselWithRef(_ref, ref) {
    ...
    return createElement(ContainWrapper, _extends6({
      size: true,
      layout: true,
      paint: true,
      contentStyle: {
      ...
      }, cloneElement(child, _extends6({}, child.props, {
        thumbnailSrc: void 0
      })));
  ...
  // extensions/amp-base-carousel/1.0/base-element.js
    ...
    _proto.init = function init() {
      ...
      return dict({
        ...
        "onSlideChange": function onSlideChange(index) {
          _this2.triggerEvent(element, "slideChange", dict({
            "index": index
          }));
        }
      });
  ...
  BaseElement2["Component"] = BentoBaseCarousel;
  ...
  BaseElement2["useContexts"] = [CarouselContextProp];

  // build/amp-base-carousel-1.0.css.js
  var CSS3 = "amp-base-carousel{display:block;overflow:hidden;position:relative}amp-base-carousel:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-base-carousel/1.0/amp-base-carousel.css*/";
  ...
  var AmpBaseCarousel = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpBaseCarousel2, _BaseElement);
    var _super = _createSuper4(AmpBaseCarousel2);
    function AmpBaseCarousel2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpBaseCarousel2.prototype;
    _proto.init = function init() {
    ...
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-carousel"), 'expected global "bento" or specific "bento-carousel" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    _proto.triggerEvent = function triggerEvent(element, eventName, detail) {
      var event = createCustomEvent(getWin(element), "amp-base-carousel." + eventName, detail);
  ...
  AMP.registerElement(TAG2, AmpBaseCarousel, CSS3);
})();
