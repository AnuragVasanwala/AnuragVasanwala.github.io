(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-jwplayer",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function parsePropDefs(Ctor, props, propDefs, element, mediaQueryProps) {
    ...
    for (var _name in propDefs) {
      ...
      devAssert2(!!_def.attr + !!_def.attrs + !!_def.attrMatches + !!_def.selector + !!_def.passthrough + !!_def.passthroughNonEmpty <= 1, ONE_OF_ERROR_MESSAGE);
      var value = void 0;
      if (_def.passthrough) {
        ...
        devAssert2(_def.attrs || _def.attrMatches);
  ...
  function createParseAttrsWithPrefix(prefix) {
    var attrMatches = function attrMatches2(name) {
      return (name == null ? void 0 : name.startsWith(prefix)) && name !== prefix;
    };
    var parseAttrs = function parseAttrs2(element) {
      var currObj;
      ...
      for (var i4 = 0; i4 < attrs.length; i4++) {
        ...
        if (attrMatches(attrib.name)) {
          ...
          currObj[dashToCamelCase(attrib.name.slice(prefix.length))] = attrib.value;
        }
      }
      return currObj;
    };
  ...
  // extensions/amp-jwplayer/1.0/jwplayer-api.js
  function _extends5() {
  ...
  function makeJwplayerIframeSrc(playerId, playlistId, mediaId, contentSearch, contentRecency, contentBackfill, queryParams, consentParams) {
    if (!playerId) {
      return null;
    }
    var pid = encodeURIComponent(playerId);
    var cid = encodeURIComponent(playlistId || mediaId);
    if (cid === "outstream") {
      cid = "oi7pAMI1";
    }
    var url = "https://content.jwplatform.com/players/" + cid + "-" + pid + ".html";
    var policyInfo = consentParams.policyInfo, policyMetadata = consentParams.policyMetadata, policyState = consentParams.policyState;
    url = addParamsToUrl(url, _extends5({}, queryParams, {
      "search": contentSearch || void 0,
      "recency": contentRecency || void 0,
      "backfill": contentBackfill || void 0,
      "isAMP": true,
      "consentState": policyState || void 0,
      "consentValue": policyInfo || void 0,
      "consentGdpr": (policyMetadata == null ? void 0 : policyMetadata.gdprApplies) || void 0
    }));
    return url;
  }
  var JwplayerEvents = {
  ...
  var JwplayerToDom = {
    "play": JwplayerEvents.PLAYING,
    "pause": JwplayerEvents.PAUSE,
    "complete": JwplayerEvents.ENDED,
    "visible": JwplayerEvents.VISIBILITY,
    "adImpression": JwplayerEvents.AD_START,
    "adComplete": JwplayerEvents.AD_END
  };
  ...
  var VideoInterface = /* @__PURE__ */ function() {
    ...
    _proto.getMetadata = function getMetadata3() {
    };
  ...
  var getMetadata = function getMetadata2(player, props) {
    return Object.assign(dict({
      "title": props.title || props["aria-label"] || document.title,
      "artist": props.artist || "",
      "album": props.album || "",
      "artwork": [{
        "src": props.artwork || props.poster || parseSchemaImage(document) || parseOgImage(document) || parseFavicon(document) || ""
      }]
    }), player && player.getMetadata ? player.getMetadata() : Object.create(null));
  };
  function VideoWrapperWithRef(_ref, ref) {
    var _propName = propName("class"), _ref$autoplay = _ref.autoplay, autoplay = _ref$autoplay === void 0 ? false : _ref$autoplay, _ref$component = _ref.component, Component = _ref$component === void 0 ? "video" : _ref$component, _ref$controls = _ref.controls, controls = _ref$controls === void 0 ? false : _ref$controls, loadingProp = _ref.loading, _ref$loop = _ref.loop, loop = _ref$loop === void 0 ? false : _ref$loop, _ref$mediasession = _ref.mediasession, mediasession = _ref$mediasession === void 0 ? true : _ref$mediasession, _ref$noaudio = _ref.noaudio, noaudio = _ref$noaudio === void 0 ? false : _ref$noaudio, onPlayingState = _ref.onPlayingState, onReadyState = _ref.onReadyState, poster = _ref.poster, sources = _ref.sources, src = _ref.src, style = _ref.style, className = _ref[_propName], rest = _objectWithoutPropertiesLoose4(_ref, ["autoplay", "component", "controls", "loading", "loop", "mediasession", "noaudio", "onPlayingState", "onReadyState", "poster", "sources", "src", "style", _propName].map(_toPropertyKey3));
    useResourcesNotify();
    var _useAmpContext = useAmpContext(), playable = _useAmpContext.playable;
    var loading = useLoading(loadingProp);
    var load = loading !== Loading_Enum.UNLOAD;
    var _useState = useState(autoplay), muted = _useState[0], setMuted = _useState[1];
    var _useState2 = useState(false), playing = _useState2[0], setPlaying_ = _useState2[1];
    var _useState3 = useState(null), metadata = _useState3[0], setMetadata = _useState3[1];
    var _useState4 = useState(!autoplay), hasUserInteracted = _useState4[0], setHasUserInteracted = _useState4[1];
    var wrapperRef = useRef(null);
    var playerRef = useRef(null);
    var readyDeferred = useMemo(function() {
      return new Deferred();
    }, []);
    var readyStateRef = useRef(ReadyState_Enum.LOADING);
    var onReadyStateRef = useValueRef(onReadyState);
    var setReadyState = useCallback(function(state, opt_failure) {
    ...
    var setPlayingState = useCallback(function(playing2) {
      setPlaying_(playing2);
      var onPlayingState2 = onPlayingStateRef.current;
      if (onPlayingState2) {
        onPlayingState2(playing2);
      }
    }, [onPlayingStateRef]);
    useLayoutEffect(function() {
      if (!load) {
    ...
    var play = useCallback(function() {
      return readyDeferred.promise.then(function() {
        return tryPlay(playerRef.current);
      });
    }, [readyDeferred]);
    var pause3 = useCallback(function() {
      readyDeferred.promise.then(function() {
        var _playerRef$current;
        return (_playerRef$current = playerRef.current) == null ? void 0 : _playerRef$current.pause();
      });
    }, [readyDeferred]);
    ...
    useLayoutEffect(function() {
      ...
      var readyState = (_playerRef$current2 = playerRef.current) == null ? void 0 : _playerRef$current2.readyState;
      if (readyState != null) {
        setReadyState(readyState > 0 ? ReadyState_Enum.COMPLETE : ReadyState_Enum.LOADING);
      }
    }, [setReadyState]);
    useLayoutEffect(function() {
      if (mediasession && playing && metadata) {
        setMediaSession(window, metadata, play, pause3);
      }
      return function() {
      };
    }, [mediasession, playing, metadata, play, pause3]);
    useEffect(function() {
      if (!playable) {
        pause3();
      }
    ...
    }, [play, pause3, requestFullscreen, userInteracted, hasUserInteracted, autoplay, controls, loop]);
    return createElement(ContainWrapper, {
      ...
      layout: true,
      paint: true
    }, load && createElement(Component, _extends8({}, rest, {
      ref: playerRef,
      loading: loading,
      muted: muted,
      loop: loop,
      ...
      onError: function onError(e3) {
        setReadyState(ReadyState_Enum.ERROR, e3);
        readyDeferred.reject(e3);
      },
      class: $fillStretch,
      src: src,
      poster: poster
    }), sources), autoplay && !hasUserInteracted && createElement(Autoplay, {
      metadata: metadata,
      playing: playing,
  ...
  function Autoplay(_ref2) {
    var _objstr, _objstr2;
    var displayIcon = _ref2.displayIcon, displayOverlay = _ref2.displayOverlay, metadata = _ref2.metadata, onOverlayClick = _ref2.onOverlayClick, pause3 = _ref2.pause, play = _ref2.play, playing = _ref2.playing, wrapperRef = _ref2.wrapperRef;
    ...
    }, [wrapperRef, play, pause3, playable]);
    return createElement(Fragment, null, displayIcon && createElement("div", {
      class: obj_str_default((_objstr = {}, _objstr[$eq] = true, _objstr[$eqPlaying] = playing, _objstr))
    }, createElement(AutoplayIconContent, null)), displayOverlay && createElement("button", {
      "aria-label": metadata && metadata.title || "Unmute video",
      tabIndex: "0",
      class: obj_str_default((_objstr2 = {}, _objstr2[$autoplayMaskButton] = true, _objstr2[$fillContentOverlay] = true, _objstr2)),
      onClick: onOverlayClick
    }));
  }
  var AutoplayIconContent = once(function() {
    return [1, 2, 3, 4].map(function(i4) {
  ...
  var DEFAULT_SANDBOX = ["allow-scripts", "allow-same-origin", "allow-popups", "allow-popups-to-escape-sandbox", "allow-top-navigation-by-user-activation"].join(" ");
  ...
  function postWhenReady(iframe, ready, makeMessageCb) {
    ...
    ready.then(function() {
      iframe.contentWindow.postMessage(makeMessageCb(), "*");
    });
  }
  function VideoIframeInternalWithRef(_ref, ref) {
    ...
    var postMethodMessage = useCallback(function(method) {
      postWhenReady(iframeRef == null ? void 0 : iframeRef.current, readyDeferred.promise, function() {
        return makeMethodMessageRef.current(method);
      });
    }, [readyDeferred.promise]);
    var makeFullscreenMessageRef = useRef(makeFullscreenMessageProp);
    var postFullscreenMessage = useCallback(function() {
      return postWhenReady(iframeRef == null ? void 0 : iframeRef.current, readyDeferred.promise, makeFullscreenMessageRef.current);
    }, [readyDeferred.promise]);
    useImperativeHandle(ref, function() {
      return {
        get currentTime() {
          var _playerStateRef$curre, _playerStateRef$curre2;
          return (_playerStateRef$curre = playerStateRef == null ? void 0 : (_playerStateRef$curre2 = playerStateRef.current) == null ? void 0 : _playerStateRef$curre2["currentTime"]) != null ? _playerStateRef$curre : NaN;
        },
        get duration() {
          var _playerStateRef$curre3, _playerStateRef$curre4;
          return (_playerStateRef$curre3 = playerStateRef == null ? void 0 : (_playerStateRef$curre4 = playerStateRef.current) == null ? void 0 : _playerStateRef$curre4["duration"]) != null ? _playerStateRef$curre3 : NaN;
        },
        ...
        play: function play() {
          return postMethodMessage("play");
        },
        pause: function pause3() {
          if (unloadOnPause) {
    ...
    }, [playerStateRef, postMethodMessage, postFullscreenMessage, readyDeferred.promise, unloadOnPause]);
    ...
    useLayoutEffect(function() {
      ...
      function handleMessage(event) {
        ...
        if (origin && !origin.test(event.origin) || event.source != iframeRef.current.contentWindow) {
          return;
        }
    ...
    return createElement("iframe", _extends9({}, rest, {
      ref: iframeRef,
      ...
      onLoad: function onLoad(event) {
        onIframeLoad == null ? void 0 : onIframeLoad(event);
      }
    }));
  }
  ...
  function VideoIframeWithRef(props, ref) {
    return createElement(VideoWrapper, _extends9({
      ref: ref
    }, props, {
      component: VideoIframeInternal
    }));
  }
  var VideoIframe = forwardRef(VideoIframeWithRef);
  VideoIframe.displayName = "VideoIframe";

  // extensions/amp-jwplayer/1.0/component.js
  var _excluded3 = ["adCustParams", "adMacros", "autoplay", "config", "consentParams", "contentBackfill", "contentRecency", "contentSearch", "mediaId", "onLoad", "onPlayingState", "playerId", "playlistId", "queryParams"];
  var _excluded22 = ["json"];
  function _extends10() {
  ...
  var JWPLAYER_ORIGIN = /https:\/\/content\.jwplatform\.com/;
  function hasFullScreenApi(win) {
    return !!win.document.body.requestFullscreen;
  }
  function BentoJwplayerWithRef(props, ref) {
    var adCustParams = props.adCustParams, adMacros = props.adMacros, autoplay = props.autoplay, config = props.config, _props$consentParams = props.consentParams, consentParams = _props$consentParams === void 0 ? {} : _props$consentParams, _props$contentBackfil = props.contentBackfill, contentBackfill = _props$contentBackfil === void 0 ? true : _props$contentBackfil, contentRecency = props.contentRecency, contentSearch = props.contentSearch, mediaId = props.mediaId, onLoad = props.onLoad, onPlayingState = props.onPlayingState, playerId = props.playerId, playlistId = props.playlistId, queryParams = props.queryParams, rest = _objectWithoutPropertiesLoose6(props, _excluded3);
    var playerStateRef = useRef({});
    var src = useMemo(function() {
      return makeJwplayerIframeSrc(playerId, playlistId, mediaId, contentSearch, contentRecency, contentBackfill, queryParams, consentParams);
    }, [playerId, playlistId, mediaId, contentSearch, contentRecency, contentBackfill, queryParams, consentParams]);
    var onMessage = useCallback(function(e3) {
      return onMessage_(e3, {
        config: config,
        adCustParams: adCustParams,
        adMacros: adMacros,
    ...
    var makeMethodMessage = useCallback(function(method) {
      return makeMessage(method, {
        autoplay: autoplay
      });
    }, [autoplay]);
    var makeFullscreenMessage = useMemo(function() {
      return !hasFullScreenApi(window) ? function() {
    ...
    return createElement(VideoIframe, _extends10({
      ref: ref,
      playerStateRef: playerStateRef,
      src: src,
  ...
  var BentoJwplayer = forwardRef(BentoJwplayerWithRef);
  BentoJwplayer.displayName = "BentoJwPlayer";
  function makeMessage(apiMethod, options) {
    var jwplayerMethod, optParams;
    switch (apiMethod) {
      case "play": {
    ...
    var message = {
      method: jwplayerMethod,
      optParams: optParams
    };
    return JSON.stringify(message);
  }
  function onMessage_(event, options) {
    var currentTarget = event.currentTarget, messageData = event.data;
    var adCustParams = options.adCustParams, adMacros = options.adMacros, config = options.config, onLoad = options.onLoad, onPlayingState = options.onPlayingState, playerStateRef = options.playerStateRef;
    if (!isJsonOrObj(messageData)) {
      return;
    }
    var data = objOrParseJson(messageData);
    var eventDetail = data.detail, eventType = data.event;
    if (eventType === "setup") {
    ...
    switch (eventType) {
      case "play":
      case "adPlay": {
        onPlayingState == null ? void 0 : onPlayingState(true);
        break;
      }
      case "pause":
      case "complete": {
        onPlayingState == null ? void 0 : onPlayingState(false);
        break;
      }
    }
  ...
  function onSetup(iframe, config, adCustParamsJson, adMacros) {
    var _ref = config || {}, jsonConfig = _ref.json, restConfig = _objectWithoutPropertiesLoose6(_ref, _excluded22);
    var config_ = _extends10({}, tryParseJson(jsonConfig) || {}, restConfig);
  ...
  function postCommandMessage(iframe, method, optParams) {
    ...
    iframe.contentWindow.postMessage(JSON.stringify(dict({
      "method": method,
      "optParams": optParams
    })), "*");
  }
  function checkProps(props) {
    var mediaId = props.mediaId, playerId = props.playerId, playlistId = props.playlistId;
    var requiredProps = playerId && (mediaId || playlistId);
    if (!requiredProps) {
      console.warn("playerId and one of: mediaId or playlistId are required for <Jwplayer>");
      return false;
    }
    return true;
  }
  ...
  function _setPrototypeOf(o3, p3) {
    _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf7(o4, p4) {
      o4.__proto__ = p4;
      return o4;
    };
  ...
  function _getPrototypeOf(o3) {
    _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf7(o4) {
  ...
  if (typeof AMP !== "undefined" && AMP.BaseElement) {
    ...
    CeBaseElement = /* @__PURE__ */ function() {
      ...
      CeBaseElement2["CustomElement"] = function CustomElement(BaseElement4) {
        return /* @__PURE__ */ function(_ExtendableHTMLElemen) {
          ...
          function CustomElement2() {
            ...
            _this.implementation = new BaseElement4(_assertThisInitialized(_this));
            return _this;
          }
  ...
  function _setPrototypeOf2(o3, p3) {
    _setPrototypeOf2 = Object.setPrototypeOf || function _setPrototypeOf7(o4, p4) {
      o4.__proto__ = p4;
      return o4;
    };
  ...
  function _getPrototypeOf2(o3) {
    _getPrototypeOf2 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf7(o4) {
      return o4.__proto__ || Object.getPrototypeOf(o4);
    };
  ...
  var PreactBaseElement = /* @__PURE__ */ function(_BaseElement) {
    ...
    _proto.buildCallback = function buildCallback() {
      ...
      this.observer.observe(this.element, _extends11({
        attributes: true
    ...
    _proto.rerender_ = function rerender_() {
      ...
      var v3 = createElement(WithAmpContext, _extends11({}, this.context_), comp);
  ...
  function shouldMutationBeRerendered(Ctor, m3) {
    ...
    if (type == "attributes") {
      ...
      for (var name in props) {
        var def = props[name];
        if (m3.attributeName == def.attr || def.attrs && def.attrs.includes(devAssert2(m3.attributeName)) || def.attrMatches != null && def.attrMatches(m3.attributeName)) {
          return true;
        }
      }
      return false;
  ...
  function _setPrototypeOf3(o3, p3) {
    _setPrototypeOf3 = Object.setPrototypeOf || function _setPrototypeOf7(o4, p4) {
      o4.__proto__ = p4;
      return o4;
    };
  ...
  function _getPrototypeOf3(o3) {
    _getPrototypeOf3 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf7(o4) {
      return o4.__proto__ || Object.getPrototypeOf(o4);
    };
    return _getPrototypeOf3(o3);
  }
  var BaseElement2 = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits3(BaseElement4, _PreactBaseElement);
    var _super = _createSuper3(BaseElement4);
    function BaseElement4() {
      return _super.apply(this, arguments);
    }
    return BaseElement4;
  }(PreactBaseElement);
  BaseElement2["Component"] = VideoWrapper;
  BaseElement2["loadable"] = true;
  ...
  BaseElement2["shadowCss"] = CSS3 + CSS2;
  BaseElement2["usesShadowDom"] = true;

  // extensions/amp-video/1.0/video-base-element.js
  ...
  function _setPrototypeOf4(o3, p3) {
    _setPrototypeOf4 = Object.setPrototypeOf || function _setPrototypeOf7(o4, p4) {
      o4.__proto__ = p4;
      return o4;
    };
  ...
  function _getPrototypeOf4(o3) {
    _getPrototypeOf4 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf7(o4) {
      return o4.__proto__ || Object.getPrototypeOf(o4);
    };
    return _getPrototypeOf4(o3);
  }
  var VideoBaseElement = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(VideoBaseElement2, _BaseElement);
    var _super = _createSuper4(VideoBaseElement2);
    function VideoBaseElement2() {
      return _super.apply(this, arguments);
    }
    var _proto = VideoBaseElement2.prototype;
    _proto.init = function init() {
      this.registerApiAction_("play", function(api) {
        return api.play();
      });
      this.registerApiAction_("pause", function(api) {
        return api.pause();
      });
      this.registerApiAction_("mute", function(api) {
        return api.mute();
      });
      this.registerApiAction_("unmute", function(api) {
        return api.unmute();
      });
      var requestFullscreen = function requestFullscreen2(api) {
    ...
    _proto.registerApiAction_ = function registerApiAction_(alias, handler, minTrust) {
      if (minTrust === void 0) {
        minTrust = ActionTrust_Enum.HIGH;
      }
      this.registerApiAction(alias, function(api, invocation) {
    ...
    return VideoBaseElement2;
  }(BaseElement2);

  // extensions/amp-jwplayer/1.0/base-element.js
  function _createForOfIteratorHelperLoose6(o3, allowArrayLike) {
    var it = typeof Symbol !== "undefined" && o3[Symbol.iterator] || o3["@@iterator"];
    if (it)
      return (it = it.call(o3)).next.bind(it);
  ...
  function _setPrototypeOf5(o3, p3) {
    _setPrototypeOf5 = Object.setPrototypeOf || function _setPrototypeOf7(o4, p4) {
      o4.__proto__ = p4;
      return o4;
    };
    return _setPrototypeOf5(o3, p3);
  }
  ...
  function _getPrototypeOf5(o3) {
    _getPrototypeOf5 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf7(o4) {
      return o4.__proto__ || Object.getPrototypeOf(o4);
    };
    return _getPrototypeOf5(o3);
  }
  var BaseElement3 = /* @__PURE__ */ function(_VideoBaseElement) {
    _inherits5(BaseElement4, _VideoBaseElement);
    var _super = _createSuper5(BaseElement4);
    function BaseElement4() {
      return _super.apply(this, arguments);
    }
    var _proto = BaseElement4.prototype;
    _proto.init = function init() {
      _VideoBaseElement.prototype.init.call(this);
      return dict({
        "queryParams": this.mergeQueryParams(getDataParamsFromAttributes(this.element, null, /^playerParam(.+)/), this.element.getAttribute("data-player-querystring")),
        "contentSearch": this.getContextualSearch(this.element.getAttribute("data-content-search"))
      });
    };
    _proto.getContextualSearch = function getContextualSearch(searchVal) {
      if (searchVal !== "__CONTEXTUAL__") {
        return searchVal;
      }
      var _this$element$ownerDo = this.element.ownerDocument, head = _this$element$ownerDo.head, title = _this$element$ownerDo.title;
      var ogTitleElement = head.querySelector('meta[property="og:title"]');
      var ogTitle = ogTitleElement ? ogTitleElement.getAttribute("content") : null;
      return ogTitle || title || "";
    };
    _proto.mergeQueryParams = function mergeQueryParams(playerParams, playerQueryString) {
      var addEntries = function addEntries2(acc, entries) {
        for (var _iterator = _createForOfIteratorHelperLoose6(entries), _step; !(_step = _iterator()).done; ) {
          var entry = _step.value;
          acc[entry[0]] = entry[1];
        }
      };
      var p1 = new URLSearchParams(playerParams || "");
      var p22 = new URLSearchParams(playerQueryString || "");
      var params = {};
      addEntries(params, p1.entries());
      addEntries(params, p22.entries());
      return params;
    };
    return BaseElement4;
  }(VideoBaseElement);
  BaseElement3["Component"] = BentoJwplayer;
  BaseElement3["props"] = {
    "playerId": {
      attr: "data-player-id"
    },
    ...
    "contentRecency": {
      attr: "data-content-recency"
    },
    "contentBackfill": {
      attr: "data-content-backfill",
      type: "boolean"
    },
    "adCustParams": {
      attr: "data-ad-cust-params"
    },
  ...
  BaseElement3["layoutSizeDefined"] = true;
  BaseElement3["usesShadowDom"] = true;
  BaseElement3["loadable"] = true;
  ...
  // extensions/amp-jwplayer/1.0/amp-jwplayer.js
  ...
  function _setPrototypeOf6(o3, p3) {
    _setPrototypeOf6 = Object.setPrototypeOf || function _setPrototypeOf7(o4, p4) {
      o4.__proto__ = p4;
      return o4;
    };
    return _setPrototypeOf6(o3, p3);
  }
  ...
  function _getPrototypeOf6(o3) {
    _getPrototypeOf6 = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf7(o4) {
      return o4.__proto__ || Object.getPrototypeOf(o4);
    };
    return _getPrototypeOf6(o3);
  }
  var TAG2 = "amp-jwplayer";
  var AmpJwplayer = /* @__PURE__ */ function(_BaseElement) {
    _inherits6(AmpJwplayer2, _BaseElement);
    var _super = _createSuper6(AmpJwplayer2);
    function AmpJwplayer2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpJwplayer2.prototype;
    _proto.init = function init() {
      var _this = this;
      var consentPolicy = this.getConsentPolicy();
      if (consentPolicy) {
        this.getConsentInfo().then(function(consentInfo) {
          var policyState = consentInfo[0];
          var policyInfo = consentInfo[1];
          var policyMetadata = consentInfo[2];
    ...
    _proto.getConsentInfo = function getConsentInfo(policy) {
      return Promise.all([getConsentPolicyState(this.element, policy), getConsentPolicyInfo(this.element, policy), getConsentMetadata(this.element, policy)]);
    };
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-jwplayer"), 'expected global "bento" or specific "bento-jwplayer" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpJwplayer2;
  }(BaseElement3);
  AMP.registerElement(TAG2, AmpJwplayer);
})();
...
//# sourceMappingURL=amp-jwplayer-1.0.max.js.map
