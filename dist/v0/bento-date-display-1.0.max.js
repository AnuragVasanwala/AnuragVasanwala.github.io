...
(function() {
  ...
  function getTimeZoneName(date, locale, options, format) {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose5(parts), _step; !(_step = _iterator()).done; ) {
  ...
  function getLocaleString_(date, locale, localeOptions) {
    try {
      ...
      user().error(TAG, "localeOptions", e3);
    }
  }
  ...
  function getVariablesInUTC(date, locale, localeOptions) {
    ...
    var localeOptionsInUTC = _extends7({}, localeOptions, {
      timeZone: "UTC"
    });
    return {
  ...
  // extensions/amp-date-display/1.0/build/bento-date-display.js
  function defineElement() {
    customElements.define("bento-date-display", BaseElement2.CustomElement(BaseElement2));
  }
  defineElement();
})();
...
//# sourceMappingURL=bento-date-display-1.0.max.js.map
