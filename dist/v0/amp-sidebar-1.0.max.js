(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-sidebar",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-sidebar/1.0/sidebar-config.js
  var Side = {
    LEFT: "left",
    RIGHT: "right"
  };
  ...
  var ANIMATION_EASE_IN = "cubic-bezier(0,0,.21,1)";
  var ANIMATION_KEYFRAMES_FADE_IN = [{
    "opacity": "0"
  }, {
    "opacity": "1"
  }];
  var ANIMATION_KEYFRAMES_SLIDE_IN_LEFT = [{
    "transform": "translateX(-100%)"
  }, {
    "transform": "translateX(0)"
  }];
  var ANIMATION_KEYFRAMES_SLIDE_IN_RIGHT = [{
    "transform": "translateX(100%)"
  }, {
    "transform": "translateX(0)"
  }];
  var ANIMATION_STYLES_SIDEBAR_LEFT_INIT = {
    "transform": "translateX(-100%)"
  };
  var ANIMATION_STYLES_SIDEBAR_RIGHT_INIT = {
    "transform": "translateX(100%)"
  };
  var ANIMATION_STYLES_BACKDROP_INIT = {
    "opacity": "0"
  };
  var ANIMATION_STYLES_SIDEBAR_FINAL = {
    "transform": ""
  };
  var ANIMATION_STYLES_BACKDROP_FINAL = {
    "opacity": ""
  };
  function safelySetStyles(element, styles) {
    setStyles(element, assertDoesNotContainDisplay(styles));
  }
  function useSidebarAnimation(mounted, opened, onAfterOpen, onAfterClose, side, sidebarRef, backdropRef, setMounted) {
    var onAfterOpenRef = useValueRef(onAfterOpen);
    var onAfterCloseRef = useValueRef(onAfterClose);
    var sidebarAnimationRef = useRef(null);
    var backdropAnimationRef = useRef(null);
    var currentlyAnimatingRef = useRef(false);
    useLayoutEffect(function() {
      var sidebarElement = sidebarRef.current;
      var backdropElement = backdropRef.current;
      ...
      var postInvisibleAnim = function postInvisibleAnim2() {
        onAfterCloseRef.current == null ? void 0 : onAfterCloseRef.current();
        sidebarAnimationRef.current = null;
        backdropAnimationRef.current = null;
        currentlyAnimatingRef.current = false;
        setMounted(false);
      ...
      if (currentlyAnimatingRef.current) {
        var sidebarAnimation = sidebarAnimationRef.current;
        if (sidebarAnimation) {
          sidebarAnimation.reverse();
          sidebarAnimation.onfinish = opened ? postVisibleAnim : postInvisibleAnim;
        }
        var backdropAnimation = backdropAnimationRef.current;
      ...
      if (opened) {
        ...
        safelySetStyles(sidebarElement, side === Side.LEFT ? ANIMATION_STYLES_SIDEBAR_LEFT_INIT : ANIMATION_STYLES_SIDEBAR_RIGHT_INIT);
        safelySetStyles(backdropElement, ANIMATION_STYLES_BACKDROP_INIT);
        var _sidebarAnimation = sidebarElement.animate(side === Side.LEFT ? ANIMATION_KEYFRAMES_SLIDE_IN_LEFT : ANIMATION_KEYFRAMES_SLIDE_IN_RIGHT, {
          duration: ANIMATION_DURATION,
          fill: "both",
          easing: ANIMATION_EASE_IN
        });
        _sidebarAnimation.onfinish = postVisibleAnim;
        var _backdropAnimation = backdropElement.animate(ANIMATION_KEYFRAMES_FADE_IN, {
          duration: ANIMATION_DURATION,
          fill: "both",
          easing: ANIMATION_EASE_IN
        });
        sidebarAnimationRef.current = _sidebarAnimation;
        backdropAnimationRef.current = _backdropAnimation;
        ...
        var _sidebarAnimation2 = sidebarElement.animate(side === Side.LEFT ? ANIMATION_KEYFRAMES_SLIDE_IN_LEFT : ANIMATION_KEYFRAMES_SLIDE_IN_RIGHT, {
          duration: ANIMATION_DURATION,
          direction: "reverse",
          fill: "both",
          easing: ANIMATION_EASE_IN
        });
        _sidebarAnimation2.onfinish = postInvisibleAnim;
        var _backdropAnimation2 = backdropElement.animate(ANIMATION_KEYFRAMES_FADE_IN, {
          duration: ANIMATION_DURATION,
          direction: "reverse",
          fill: "both",
          easing: ANIMATION_EASE_IN
        });
        sidebarAnimationRef.current = _sidebarAnimation2;
        backdropAnimationRef.current = _backdropAnimation2;
        currentlyAnimatingRef.current = true;
      }
    }, [mounted, opened, onAfterOpenRef, onAfterCloseRef, side, sidebarRef, backdropRef, setMounted]);
  }

  // extensions/amp-sidebar/1.0/sidebar-toolbar-hook.js
  function useToolbarHook(ref, mediaQueryProp, toolbarTargetProp) {
    var _useState = useState(null), mediaQuery = _useState[0], setMediaQuery = _useState[1];
    var _useState2 = useState(null), toolbarTarget = _useState2[0], setToolbarTarget = _useState2[1];
    var _useState3 = useState(null), targetEl = _useState3[0], setTargetEl = _useState3[1];
    useEffect(function() {
      var _ref$current;
      var doc = (_ref$current = ref.current) == null ? void 0 : _ref$current.ownerDocument;
      if (!doc) {
        return;
      }
      var sanitizedToolbarTarget = escapeCssSelectorIdent(toolbarTargetProp);
      setToolbarTarget(sanitizedToolbarTarget);
      setTargetEl(doc.getElementById(sanitizedToolbarTarget));
    }, [toolbarTargetProp, ref]);
    useEffect(function() {
      var _ref$current2, _ref$current2$ownerDo;
      var win = (_ref$current2 = ref.current) == null ? void 0 : (_ref$current2$ownerDo = _ref$current2.ownerDocument) == null ? void 0 : _ref$current2$ownerDo.defaultView;
      if (!win) {
        return;
      }
    ...
    useEffect(function() {
      ...
      var doc = (_ref$current3 = ref.current) == null ? void 0 : _ref$current3.ownerDocument;
      if (!doc || !targetEl || mediaQuery == null) {
        return;
      }
      var clone = element.cloneNode(true);
      var style = doc.createElement("style");
      style.textContent = "#" + toolbarTarget + "{display: none;}" + ("@media " + mediaQuery + "{#" + toolbarTarget + "{display: initial;}}");
  ...
  // extensions/amp-sidebar/1.0/component.js
  var _excluded2 = ["as", "backdropClassName", "backdropStyle", "children", "onAfterClose", "onAfterOpen", "onBeforeOpen", "side"];
  function _extends7() {
  ...
  function BentoSidebarWithRef(_ref, ref) {
    var _objstr, _objstr2, _objstr3;
    var _ref$as = _ref.as, Comp = _ref$as === void 0 ? "div" : _ref$as, backdropClassName = _ref.backdropClassName, backdropStyle = _ref.backdropStyle, children = _ref.children, onAfterClose = _ref.onAfterClose, onAfterOpen = _ref.onAfterOpen, onBeforeOpen = _ref.onBeforeOpen, sideProp = _ref.side, rest = _objectWithoutPropertiesLoose4(_ref, _excluded2);
    var _useState = useState(false), mounted = _useState[0], setMounted = _useState[1];
    var _useState2 = useState(false), opened = _useState2[0], setOpened = _useState2[1];
    var _useState3 = useState(sideProp), side = _useState3[0], setSide = _useState3[1];
    ...
    var toggle2 = useCallback(function() {
    ...
    useSidebarAnimation(mounted, opened, onAfterOpen, onAfterClose, side, sidebarRef, backdropRef, setMounted);
    useEffect(function() {
      var sidebarElement = sidebarRef.current;
      var backdropElement = backdropRef.current;
      ...
      var document2 = sidebarElement.ownerDocument;
      if (!document2) {
        return;
      }
      var keydownCallback = function keydownCallback2(event) {
      ...
      document2.addEventListener("keydown", keydownCallback);
      return function() {
        document2.removeEventListener("keydown", keydownCallback);
      };
    }, [opened, close]);
    return createElement("div", {
      class: obj_str_default((_objstr = {}, _objstr[$unmounted] = !mounted, _objstr)),
      part: "wrapper"
    }, createElement(ContainWrapper, _extends7({
      as: Comp,
      ref: sidebarRef,
      size: false,
      layout: true,
      paint: true,
      part: "sidebar",
      wrapperClassName: obj_str_default((_objstr2 = {}, _objstr2[$sidebar] = true, _objstr2[$defaultSidebarStyles] = true, _objstr2[$left] = side === Side.LEFT, _objstr2[$right] = side !== Side.LEFT, _objstr2)),
      role: "menu",
      tabIndex: "-1",
      hidden: !side
    }, rest), children), createElement("div", {
      ref: backdropRef,
      ...
      part: "backdrop",
      style: backdropStyle,
      class: obj_str_default((_objstr3 = {}, _objstr3[$backdrop] = true, _objstr3[$defaultBackdropStyles] = true, _objstr3[backdropClassName] = backdropClassName, _objstr3)),
      hidden: !side
    }, createElement("div", {
      class: $backdropOverscrollBlocker
    })));
  }
  var BentoSidebar = forwardRef(BentoSidebarWithRef);
  BentoSidebar.displayName = "BentoSidebar";

  // extensions/amp-sidebar/1.0/base-element.js
  ...
  var BaseElement2 = /* @__PURE__ */ function(_PreactBaseElement) {
    ...
    BaseElement3.deferredMount = function deferredMount(unusedElement) {
      return false;
    };
    ...
    _proto.updatePropsForRendering = function updatePropsForRendering(props) {
      realChildNodes(this.element).map(function(child) {
        if (child.nodeName === "NAV" && child.hasAttribute("toolbar") && child.hasAttribute("toolbar-target")) {
          props["children"].push(createElement(ToolbarShim, {
    ...
    _proto.afterClose = function afterClose() {
      ...
      pauseAll(this.element, false);
    };
    _proto.mutationObserverCallback = function mutationObserverCallback() {
      var open = this.element.hasAttribute("open");
      if (open === this.open_) {
        return;
      }
      this.open_ = open;
  ...
  BaseElement2["Component"] = BentoSidebar;
  ...
  function ToolbarShim(_ref) {
    var domElement = _ref.domElement, mediaQueryProp = _ref.toolbar, toolbarTargetProp = _ref.toolbarTarget;
    var ref = useValueRef(domElement);
    useToolbarHook(ref, mediaQueryProp, toolbarTargetProp);
  }

  // build/amp-sidebar-1.0.css.js
  var CSS3 = "amp-sidebar[hidden]{display:none!important}amp-sidebar{color:#000;background-color:#efefef;height:100vh;top:0;max-height:100vh!important;max-width:80vw;min-width:45px!important;outline:none;z-index:2147483647}amp-sidebar::part(c),amp-sidebar::part(sidebar),amp-sidebar::part(wrapper){color:inherit;background-color:inherit;height:inherit;top:inherit;max-height:inherit;max-width:inherit;min-width:inherit;outline:inherit;z-index:inherit;width:inherit;padding:inherit;border:inherit}amp-sidebar{visibility:hidden!important;position:fixed!important}amp-sidebar::part(c){visibility:visible!important}\n/*# sourceURL=/extensions/amp-sidebar/1.0/amp-sidebar.css*/";
  ...
  function experimentToggles(win) {
    ...
    var buildExperimentConfigs = _extends8({}, (_win$AMP_CONFIG3 = win.AMP_CONFIG) != null ? _win$AMP_CONFIG3 : {}, (_win$AMP_EXP = win.AMP_EXP) != null ? _win$AMP_EXP : parseJson(((_win$__AMP_EXP = win.__AMP_EXP) == null ? void 0 : _win$__AMP_EXP.textContent) || "{}"));
  ...
  // extensions/amp-sidebar/1.0/amp-sidebar.js
  ...
  var TAG2 = "amp-sidebar";
  var AmpSidebar = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpSidebar2, _BaseElement);
    var _super = _createSuper4(AmpSidebar2);
    ...
    _proto.init = function init() {
      ...
      this.registerApiAction("toggle", function(api) {
        return api.toggle();
      });
      this.registerApiAction("open", function(api) {
        return api.open();
      });
      this.registerApiAction("close", function(api) {
        return api.close();
      });
      return _BaseElement.prototype.init.call(this);
    };
    _proto.attachedCallback = function attachedCallback() {
      _BaseElement.prototype.attachedCallback.call(this);
    ...
    _proto.isLayoutSupported = function isLayoutSupported(unusedLayout) {
      userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-sidebar"), 'expected global "bento" or specific "bento-sidbar" experiment to be enabled');
      return true;
    };
    _proto.afterOpen = function afterOpen() {
      var _this$setAsContainer, _this2 = this;
      _BaseElement.prototype.afterOpen.call(this);
      var sidebar = this.element.shadowRoot.querySelector("[part=sidebar]");
      (_this$setAsContainer = this.setAsContainer) == null ? void 0 : _this$setAsContainer.call(this, sidebar);
      this.history_.push(function() {
        return _this2.api().close();
      }).then(function(historyId) {
        return _this2.historyId_ = historyId;
      });
    };
    _proto.afterClose = function afterClose() {
  ...
  AMP.registerElement(TAG2, AmpSidebar, CSS3);
})();
