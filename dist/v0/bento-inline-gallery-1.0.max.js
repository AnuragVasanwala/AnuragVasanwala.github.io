...
(function() {
  ...
  function BentoInlineGallery(_ref) {
    var children = _ref.children, rest = _objectWithoutPropertiesLoose4(_ref, _excluded2);
  ...
  function createSlot(element, name, defaultProps, as) {
    ...
    if (!as) {
      return createElement(Slot, _extends5({}, defaultProps || EMPTY, {
        name: name
      }));
    }
  ...
  function Slot(props) {
    ...
    return createElement("slot", _extends5({}, props, {
      ref: ref
    }));
  }
  ...
  function collectProps(Ctor, element, ref, defaultProps, mediaQueryProps) {
    ...
    var props = _extends6({}, defaultProps, {
      ref: ref
    });
    if (lightDomTag) {
  ...
  var PreactBaseElement = /* @__PURE__ */ function(_BaseElement) {
    ...
    _proto.buildCallback = function buildCallback() {
      ...
      this.observer.observe(this.element, _extends7({
        attributes: true
    ...
    _proto.rerender_ = function rerender_() {
      ...
      var v3 = createElement(WithAmpContext, _extends7({}, this.context_), comp);
  ...
  var CSS3 = ".thumbnails-d78822a{height:100px}.slide-d78822a{-o-object-fit:fill;object-fit:fill;background-color:#999}";
  ...
  function WithBentoLightboxGallery(_ref) {
    ...
    var activationProps = useMemo(function() {
      return enableActivation && _extends10({}, DEFAULT_ACTIVATION_PROPS, {
        onClick: function onClick() {
          open2(Number(genKey) - 1, group);
        }
      });
    }, [enableActivation, genKey, group, open2]);
    return createElement(Comp, _extends10({}, activationProps, {
      srcset: srcset
    }, rest), children);
  }
  ...
  function BentoBaseCarouselWithRef(_ref, ref) {
    ...
    return createElement(ContainWrapper, _extends11({
      size: true,
      layout: true,
      paint: true,
      contentStyle: {
      ...
      }, cloneElement(child, _extends11({}, child.props, {
        thumbnailSrc: void 0
      })));
  ...
  function BentoInlineGalleryThumbnails(_ref) {
    ...
    return createElement(BentoBaseCarousel, _extends12({
  ...
  var TAG2 = "bento-inline-gallery-thumbnails";
  var ThumbnailsBaseElement = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits4(ThumbnailsBaseElement2, _PreactBaseElement);
    var _super = _createSuper4(ThumbnailsBaseElement2);
  ...
  ThumbnailsBaseElement["shadowCss"] = CSS2 + CSS3;
  ...
  function BentoInlineGalleryPagination(_ref) {
    var inset = _ref.inset, rest = _objectWithoutPropertiesLoose9(_ref, _excluded6);
    ...
    return createElement(Wrapper, _extends13({
      "aria-hidden": "true",
  ...
  var TAG3 = "bento-inline-gallery-pagination";
  var PaginationBaseElement = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits5(PaginationBaseElement2, _PreactBaseElement);
    var _super = _createSuper5(PaginationBaseElement2);
  ...
  PaginationBaseElement["shadowCss"] = CSS4;
  PaginationBaseElement["usesShadowDom"] = true;
  PaginationBaseElement["useContexts"] = [CarouselContextProp];

  // extensions/amp-inline-gallery/1.0/web-component.js
  function defineElement() {
    customElements.define(TAG, BaseElement2.CustomElement(BaseElement2));
    defineThumbnailsElement();
    definePaginationElement();
  }
  function definePaginationElement() {
    customElements.define(TAG3, PaginationBaseElement.CustomElement(PaginationBaseElement));
  }
  function defineThumbnailsElement() {
    customElements.define(TAG2, ThumbnailsBaseElement.CustomElement(ThumbnailsBaseElement));
  }

  // extensions/amp-inline-gallery/1.0/bento-inline-gallery.js
  defineElement();
})();
...
//# sourceMappingURL=bento-inline-gallery-1.0.max.js.map
