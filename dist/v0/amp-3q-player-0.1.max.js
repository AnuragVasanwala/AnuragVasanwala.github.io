(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-3q-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TAG2 = "amp-3q-player";
  var Amp3QPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(Amp3QPlayer2, _AMP$BaseElement);
    var _super = _createSuper(Amp3QPlayer2);
    function Amp3QPlayer2(element) {
      var _this;
    ...
    var _proto = Amp3QPlayer2.prototype;
    ...
    _proto.buildCallback = function buildCallback() {
      var el = this.element;
      this.dataId = userAssert2(el.getAttribute("data-id"), "The data-id attribute is required for <amp-3q-player> %s", el);
      var deferred = new Deferred();
    ...
    _proto.generateIframeSrc_ = function generateIframeSrc_() {
      var _this2 = this;
      var explicitParamsAttributes = ["key", "timestamp", "controls", "userToken", "userGroup", "player"];
      var iframeSrc = "https://playout.3qsdn.com/";
      if (this.element.getAttribute("data-datasource")) {
        iframeSrc += "config_by_metadata/" + this.element.getAttribute("data-project") + "/" + this.element.getAttribute("data-datafield") + "/";
      }
      iframeSrc += dev().assertString(this.dataId) + "?autoplay=false&amp=true";
      explicitParamsAttributes.forEach(function(explicitParam) {
        var val = _this2.element.getAttribute("data-" + explicitParam);
        if (val) {
    ...
    _proto.layoutCallback = function layoutCallback() {
      var _this3 = this;
      var iframe = createFrameFor(this, this.generateIframeSrc_());
      this.iframe_ = iframe;
      this.unlistenMessage_ = listen(this.win, "message", this.sdnBridge_.bind(this));
    ...
    _proto.sdnBridge_ = function sdnBridge_(event) {
      if (event.source) {
    ...
    _proto.sdnPostMessage_ = function sdnPostMessage_(message) {
      var _this4 = this;
  ...
  AMP.registerElement(TAG2, Amp3QPlayer);
})();
