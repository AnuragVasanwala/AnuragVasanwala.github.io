(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-powr-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TAG2 = "amp-powr-player";
  var PLAYER_EVENT_MAP = {
  ...
  var AmpPowrPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpPowrPlayer2, _AMP$BaseElement);
    var _super = _createSuper(AmpPowrPlayer2);
    function AmpPowrPlayer2(element) {
      var _this;
      _this = _super.call(this, element);
      _this.iframe_ = null;
      _this.playing_ = false;
      _this.muted_ = false;
      _this.frameHasAmpSupport_ = false;
    ...
    var _proto = AmpPowrPlayer2.prototype;
    ...
    _proto.layoutCallback = function layoutCallback() {
      var _this2 = this;
      var iframe = createFrameFor(this, this.getIframeSrc_());
      this.iframe_ = iframe;
      this.unlistenMessage_ = listen(this.win, "message", function(e) {
        return _this2.handlePlayerMessage_(e);
      });
    ...
    _proto.sendCommand_ = function sendCommand_(command, arg) {
      var _this3 = this;
      this.playerReadyPromise_.then(function() {
        if (_this3.iframe_ && _this3.iframe_.contentWindow) {
          _this3.iframe_.contentWindow.postMessage(JSON.stringify(dict({
            "command": command,
            "args": arg
    ...
    _proto.onReady_ = function onReady_(data) {
      this.frameHasAmpSupport_ = true;
      var element = this.element;
      installVideoManagerForDoc(element);
      Services.videoManagerForDoc(element).register(this);
      this.playerReadyResolver_(this.iframe_);
      dev().info(TAG2, "Player %s ready. Powr Player version: %s IFrame Support version: %s", this.playerId_, data["powrVersion"], data["iframeVersion"]);
    };
    _proto.getIframeSrc_ = function getIframeSrc_() {
      var el = this.element;
      var account = userAssert2(el.getAttribute("data-account"), "The data-account attribute is required for <amp-powr-player> %s", el);
      this.playerId_ = userAssert2(el.getAttribute("data-player"), "The data-player attribute is required for <amp-powr-player> %s", el);
      var video = el.getAttribute("data-video");
      var terms = el.getAttribute("data-terms");
      userAssert2(video || terms, "The data-video or data-terms attribute is required for <amp-powr-player> %s", el);
      var srcPrefix = "https://player.powr.com/iframe.html";
      var srcParams = dict({
        "account": account,
      ...
      var src = addParamsToUrl(srcPrefix, srcParams);
      var customReferrer = el.getAttribute("data-referrer");
      if (customReferrer) {
        el.setAttribute("data-param-referrer", this.urlReplacements_.expandUrlSync(customReferrer));
      }
    ...
    _proto.mutatedAttributesCallback = function mutatedAttributesCallback(mutations) {
      ...
      var video = mutations["data-video"];
      if (account !== void 0 || playerId !== void 0 || video !== void 0) {
        if (this.iframe_) {
    ...
    _proto.pauseCallback = function pauseCallback() {
      if (this.iframe_ && this.iframe_.contentWindow && this.frameHasAmpSupport_ && this.playing_) {
        this.pause();
      }
    };
    ...
    return AmpPowrPlayer2;
  }(AMP.BaseElement);
  AMP.registerElement(TAG2, AmpPowrPlayer);
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
})});
//# sourceMappingURL=amp-powr-player-0.1.max.js.map
