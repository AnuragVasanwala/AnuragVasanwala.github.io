...
(function() {
  ...
  var TAG = "bento-facebook";
  var COMMENTS_TAG = "bento-facebook-comments";
  var LIKE_TAG = "bento-facebook-like";
  var PAGE_TAG = "bento-facebook-page";
  ...
  // extensions/amp-facebook/1.0/web-component.js
  ...
  function defineCommentsElement() {
    customElements.define(COMMENTS_TAG, CommentsBaseElement.CustomElement(CommentsBaseElement));
  }
  function defineLikeElement() {
    customElements.define(LIKE_TAG, LikeBaseElement.CustomElement(LikeBaseElement));
  }
  function definePageElement() {
    customElements.define(PAGE_TAG, PageBaseElement.CustomElement(PageBaseElement));
  }

  // extensions/amp-facebook/1.0/bento-facebook.js
  defineElement();
})();
...
//# sourceMappingURL=bento-facebook-1.0.max.js.map
