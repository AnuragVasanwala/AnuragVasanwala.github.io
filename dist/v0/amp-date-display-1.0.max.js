(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-date-display",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function getTimeZoneName(date, locale, options, format) {
    var _Intl;
    if (format === void 0) {
      format = "long";
    }
    if (!((_Intl = Intl) != null && _Intl.DateTimeFormat)) {
      return "";
    }
    ...
    var parts = (formatter.formatToParts == null ? void 0 : formatter.formatToParts(date)) || [];
    for (var _iterator = _createForOfIteratorHelperLoose6(parts), _step; !(_step = _iterator()).done; ) {
  ...
  // extensions/amp-date-display/1.0/component.js
  var _excluded2 = ["datetime", "displayIn", "locale", "localeOptions", "render"];
  function _extends8() {
  ...
  var DEFAULT_RENDER = function DEFAULT_RENDER2(data) {
    return data["localeString"];
  };
  function BentoDateDisplay(_ref) {
    var datetime2 = _ref.datetime, _ref$displayIn = _ref.displayIn, displayIn = _ref$displayIn === void 0 ? DEFAULT_DISPLAY_IN : _ref$displayIn, _ref$locale = _ref.locale, locale = _ref$locale === void 0 ? DEFAULT_LOCALE : _ref$locale, localeOptions = _ref.localeOptions, _ref$render = _ref.render, render2 = _ref$render === void 0 ? DEFAULT_RENDER : _ref$render, rest = _objectWithoutPropertiesLoose4(_ref, _excluded2);
    var date = getDate(datetime2);
    var data = useMemo(function() {
      return getDataForTemplate(new Date(date), displayIn, locale, localeOptions);
  ...
  function getDataForTemplate(date, displayIn, locale, localeOptions) {
    var basicData = displayIn.toLowerCase() === "utc" ? getVariablesInUTC(date, locale, localeOptions) : getVariablesInLocal(date, locale, localeOptions);
  ...
  function getLocaleString_(date, locale, localeOptions) {
    try {
      ...
      user().error(TAG2, "localeOptions", e3);
    }
  }
  function getVariablesInLocal(date, locale, localeOptions) {
    if (localeOptions === void 0) {
  ...
  function getVariablesInUTC(date, locale, localeOptions) {
    if (localeOptions === void 0) {
      localeOptions = DEFAULT_DATETIME_OPTIONS;
    }
    var localeOptionsInUTC = _extends8({}, localeOptions, {
      timeZone: "UTC"
    });
    return {
      ...
      "timeZoneNameShort": getTimeZoneName(date, locale, localeOptionsInUTC, "short")
    };
  }

  // extensions/amp-date-display/1.0/base-element.js
  ...
  BaseElement2["Component"] = BentoDateDisplay;
  BaseElement2["props"] = {
    "datetime": {
  ...
  // extensions/amp-date-display/1.0/amp-date-display.js
  ...
  var TAG3 = "amp-date-display";
  var AmpDateDisplay = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpDateDisplay2, _BaseElement);
    var _super = _createSuper4(AmpDateDisplay2);
    function AmpDateDisplay2(element) {
      var _this;
      _this = _super.call(this, element);
    ...
    var _proto = AmpDateDisplay2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-date-display"), 'expected global "bento" or specific "bento-date-display" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    _proto.checkPropsPostMutations = function checkPropsPostMutations() {
      var _this2 = this;
      ...
      if (template != this.template_) {
        ...
        if (template) {
          templates.whenReady(template).then(function() {
            if (template != _this2.template_) {
              return;
            }
            _this2.mutateProps(dict({
              "render": function render2(data) {
                return templates.renderTemplateAsString(dev().assertElement(template), data).then(function(html) {
                  return dict({
                    "__html": html
                  });
                });
    ...
    return AmpDateDisplay2;
  }(BaseElement2);
  AMP.registerElement(TAG3, AmpDateDisplay);
})();
...
//# sourceMappingURL=amp-date-display-1.0.max.js.map
