(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-lightbox-gallery",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function installLightboxGallery(ampdoc2) {
    return ampdoc2.whenReady().then(function() {
      return ampdoc2.getBody();
    }).then(function(body) {
      var existingGallery = elementByTag(ampdoc2.getRootNode(), TAG2);
      if (!existingGallery) {
        var gallery = createElementWithAttributes(ampdoc2.win.document, TAG2, {
          "layout": "nodisplay",
