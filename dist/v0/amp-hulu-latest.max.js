(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-hulu",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpHulu = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpHulu2, _AMP$BaseElement);
    var _super = _createSuper(AmpHulu2);
    function AmpHulu2(element) {
      var _this;
    ...
    _proto.buildCallback = function buildCallback() {
      ...
      this.eid_ = userAssert2(this.element.getAttribute("data-eid"), "The data-eid attribute is required for <amp-hulu> %s", this.element);
    };
    _proto.getVideoIframeSrc_ = function getVideoIframeSrc_() {
      devAssert2(this.eid_);
