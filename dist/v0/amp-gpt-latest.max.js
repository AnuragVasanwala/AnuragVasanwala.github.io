(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-gpt",ev:"1.0",l:true,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-gpt/1.0/component.jss.js
  var $loader = "loader-4756543";
  var $loaderWrapper = "loader-wrapper-4756543";
  var CSS2 = ".loader-4756543{top:calc(50% - 24px);left:calc(50% - 24px);width:48px;height:48px;position:absolute;animation:keyframes-spin-4756543 2s linear infinite;border:1px solid #fff;border-top:2px solid #a3a3a3;border-radius:50%}.loader-wrapper-4756543{width:100%;height:100%;position:absolute;background-color:#eeee}@keyframes keyframes-spin-4756543{0%{transform:rotate(0deg)}to{transform:rotate(360deg)}}";

  // 3p/3p.js
  function loadScript(win, url, opt_cb, opt_errorCb) {
    var s3 = win.document.createElement("script");
    s3.src = url;
    if (opt_cb) {
      s3.onload = opt_cb;
    }
    if (opt_errorCb) {
      s3.onerror = opt_errorCb;
    }
    win.document.body.appendChild(s3);
  }
  ...
  // extensions/amp-gpt/1.0/component.js
  var _excluded2 = ["as"];
  var _excluded22 = ["adUnitPath", "disableInitialLoad", "fallback", "height", "optDiv", "style", "targeting", "width"];
  function _extends8() {
  ...
  function DisplayAsWithRef(_ref, ref) {
    var _ref$as = _ref.as, Comp = _ref$as === void 0 ? "div" : _ref$as, rest = _objectWithoutPropertiesLoose4(_ref, _excluded2);
  ...
  function BentoGptWithRef(_ref2, ref) {
    var adUnitPath = _ref2.adUnitPath, _ref2$disableInitialL = _ref2.disableInitialLoad, disableInitialLoad = _ref2$disableInitialL === void 0 ? false : _ref2$disableInitialL, fallback = _ref2.fallback, height = _ref2.height, optDiv = _ref2.optDiv, style = _ref2.style, targeting = _ref2.targeting, width = _ref2.width, rest = _objectWithoutPropertiesLoose4(_ref2, _excluded22);
    height = !height ? style.height : height;
    width = !width ? style.width : width;
    var _useState = useState(false), errorOnScriptLoad = _useState[0], setErrorOnScriptLoad = _useState[1];
    var _useState2 = useState(false), isLoading = _useState2[0], setIsLoading = _useState2[1];
    var gptAdDivRef = useRef(null);
    var gptAdSlotRef = useRef(null);
    var containerRef = useRef(ref);
    var fallbackDivRef = useRef(null);
    var fallbackTimerRef = useRef(null);
    var gptAdResponcereceivedRef = useRef(false);
    var inObRef = null;
    var showFallback = useCallback(function(show) {
      setErrorOnScriptLoad(show);
    }, [setErrorOnScriptLoad]);
    var ioCallback2 = useCallback(function(_ref3) {
      var isIntersecting = _ref3.isIntersecting;
      if (!isIntersecting || disableInitialLoad) {
        return;
      }
      if (global.googletag) {
        var _global$googletag;
        (_global$googletag = global.googletag) == null ? void 0 : _global$googletag.pubads().refresh([gptAdSlotRef.current]);
      } else {
        setTimeout(function() {
          var _global$googletag2;
          (_global$googletag2 = global.googletag) == null ? void 0 : _global$googletag2.pubads().refresh([gptAdSlotRef.current]);
        }, 250);
      }
      inObRef(null);
    }, [disableInitialLoad, inObRef]);
    inObRef = useIntersectionObserver(ioCallback2);
    var parsedSize = useMemo(function() {
      return [parseInt(width, 10), parseInt(height, 10)];
    }, [width, height]);
    var parsedTarget = isString2(targeting) ? JSON.parse(targeting) : targeting;
    var initializeTargets = useCallback(function(adSlot) {
      if (parsedTarget) {
        for (var key in parsedTarget) {
          adSlot.setTargeting(key, parsedTarget[key]);
        }
      }
    }, [parsedTarget]);
    var display = useCallback(function() {
      global.googletag.display(gptAdDivRef.current);
    }, []);
    var refresh = useCallback(function() {
      var _global$googletag3;
      (_global$googletag3 = global.googletag) == null ? void 0 : _global$googletag3.pubads().refresh([gptAdSlotRef.current]);
    }, []);
    var initialiseGpt = useCallback(function() {
      global.googletag = global.googletag || {
        cmd: []
      };
      global.googletag.cmd.push(function() {
        global.bentoids.push(optDiv);
        gptAdSlotRef.current = global.googletag.defineSlot(adUnitPath, parsedSize, optDiv).addService(global.googletag.pubads());
        ...
        global.googletag.pubads().addEventListener("slotResponseReceived", function() {
    ...
    }, [adUnitPath, display, gptAdSlotRef, initializeTargets, optDiv, parsedSize, showFallback]);
    ...
    useEffect(function() {
      ...
      if (!global.bentogpt) {
        ...
        loadScript(global, "https://www.googletagservices.com/tag/js/gpt.js", function() {
    ...
    return createElement(ContainWrapper, _extends8({
      ...
      class: $loader
    })), !errorOnScriptLoad && createElement("div", {
      id: optDiv,
      ref: gptAdDivRef,
      style: {
        height: height,
    ...
    }), errorOnScriptLoad && createElement(DisplayAs, {
      as: fallback,
      ref: fallbackDivRef
    }));
  }
  var BentoGpt = forwardRef(BentoGptWithRef);
  BentoGpt.displayName = "BentoGpt";

  // extensions/amp-gpt/1.0/base-element.js
  ...
  BaseElement2["Component"] = BentoGpt;
  BaseElement2["props"] = {
    adUnitPath: {
      attr: "ad-unit-path",
      type: "string"
  ...
  // build/amp-gpt-1.0.css.js
  var CSS3 = "amp-gpt{display:block;overflow:hidden;position:relative}amp-gpt:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-gpt/1.0/amp-gpt.css*/";

  // extensions/amp-gpt/1.0/amp-gpt.js
  ...
  var TAG2 = "amp-gpt";
  var AmpGpt = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpGpt2, _BaseElement);
    var _super = _createSuper4(AmpGpt2);
    function AmpGpt2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpGpt2.prototype;
    _proto.init = function init() {
      this.registerApiAction("display", function(api) {
        return api.display();
      });
    ...
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-gpt"), 'expected global "bento" or specific "bento-gpt" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpGpt2;
  }(BaseElement2);
  AMP.registerElement(TAG2, AmpGpt, CSS3);
})();
...
//# sourceMappingURL=amp-gpt-1.0.max.js.map
