(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-embedly-card",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  var EmbedlyKeyBaseElement = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits3(EmbedlyKeyBaseElement2, _PreactBaseElement);
    var _super = _createSuper3(EmbedlyKeyBaseElement2);
  ...
  // extensions/amp-embedly-card/1.0/amp-embedly-key.js
  ...
  var TAG2 = "amp-embedly-key";
  var AmpEmbedlyKey = /* @__PURE__ */ function(_EmbedlyKeyBaseElemen) {
    _inherits4(AmpEmbedlyKey2, _EmbedlyKeyBaseElemen);
    var _super = _createSuper4(AmpEmbedlyKey2);
    function AmpEmbedlyKey2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpEmbedlyKey2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-embedly-card"), 'expected global "bento" or specific "bento-embedly-card" experiment to be enabled');
      return layout === Layout_Enum.NODISPLAY;
    };
    return AmpEmbedlyKey2;
  ...
  function IframeEmbedWithRef(_ref, ref) {
    ...
    return createElement(ContainWrapper, _extends8({}, rest, {
      layout: true,
      size: true,
      paint: true
  ...
  var BaseElement2 = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits5(BaseElement3, _PreactBaseElement);
    var _super = _createSuper5(BaseElement3);
  ...
  function BentoEmbedlyCardWithContext(props) {
    ...
    return createElement(BentoEmbedlyContext.Provider, {
      value: apiKey
    }, createElement(BentoEmbedlyCard, _extends11({}, props)));
  }
  BaseElement2["props"] = {
    "title": {
      attr: "title"
  ...
  // extensions/amp-embedly-card/1.0/amp-embedly-card.js
  ...
  var TAG3 = "amp-embedly-card";
  var AmpEmbedlyCard = /* @__PURE__ */ function(_BaseElement) {
    _inherits6(AmpEmbedlyCard2, _BaseElement);
    var _super = _createSuper6(AmpEmbedlyCard2);
    function AmpEmbedlyCard2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpEmbedlyCard2.prototype;
    _proto.init = function init() {
      var _this = this;
      return dict({
    ...
    AmpEmbedlyCard2.getPreconnects = function getPreconnects() {
    ...
    return AmpEmbedlyCard2;
  }(BaseElement2);
  AMP.registerElement(TAG3, AmpEmbedlyCard);
  AMP.registerElement(TAG2, AmpEmbedlyKey);
})();
...
//# sourceMappingURL=amp-embedly-card-1.0.max.js.map
