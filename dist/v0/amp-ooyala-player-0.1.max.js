(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-ooyala-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TAG2 = "amp-ooyala-player";
  var AmpOoyalaPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpOoyalaPlayer2, _AMP$BaseElement);
    var _super = _createSuper(AmpOoyalaPlayer2);
    function AmpOoyalaPlayer2(element) {
      var _this;
    ...
    var _proto = AmpOoyalaPlayer2.prototype;
    ...
    _proto.buildCallback = function buildCallback() {
      var el = this.element;
      this.embedCode_ = userAssert2(el.getAttribute("data-embedcode"), "The data-embedcode attribute is required for %s", el);
      this.pCode_ = userAssert2(el.getAttribute("data-pcode"), "The data-pcode attribute is required for %s", el);
      this.playerId_ = userAssert2(el.getAttribute("data-playerid"), "The data-playerid attribute is required for %s", el);
      var deferred = new Deferred();
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      if (playerVersion.toLowerCase() == "v4") {
        src = "https://player.ooyala.com/static/v4/production/latest/skin-plugin/amp_iframe.html?pcode=" + encodeURIComponent(this.pCode_);
        var configUrl = el.getAttribute("data-config");
        if (configUrl) {
          src += "&options[skin.config]=" + encodeURIComponent(configUrl);
        }
      }
      src += "&ec=" + encodeURIComponent(this.embedCode_) + "&pbid=" + encodeURIComponent(this.playerId_);
    ...
    _proto.handleOoyalaMessage_ = function handleOoyalaMessage_(event) {
    ...
    _proto.sendCommand_ = function sendCommand_(command) {
      ...
      this.playerReadyPromise_.then(function() {
        if (_this3.iframe_ && _this3.iframe_.contentWindow) {
          _this3.iframe_.contentWindow.postMessage(command, "*");
        }
      });
    };
    _proto.play = function play(unusedIsAutoplay) {
    ...
    return AmpOoyalaPlayer2;
  }(AMP.BaseElement);
  AMP.registerElement(TAG2, AmpOoyalaPlayer);
})();
