(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-wistia-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TAG2 = "amp-wistia-player";
  var AmpWistiaPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpWistiaPlayer2, _AMP$BaseElement);
    var _super = _createSuper(AmpWistiaPlayer2);
    function AmpWistiaPlayer2(element) {
      var _this;
    ...
    var _proto = AmpWistiaPlayer2.prototype;
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      var mediaId = userAssert2(element.getAttribute("data-media-hashed-id"), "The data-media-hashed-id attribute is required for <amp-wistia-player> %s", element);
      var iframe = createFrameFor(this, "https://fast.wistia.net/embed/iframe/" + encodeURIComponent(mediaId));
      iframe.setAttribute("title", element.getAttribute("title") || "Wistia Video Player");
      iframe.setAttribute("scrolling", "no");
      iframe.setAttribute("allowtransparency", "");
      this.iframe_ = iframe;
      this.unlistenMessage_ = listen(this.win, "message", this.handleWistiaMessage_.bind(this));
    ...
    _proto.handleWistiaMessage_ = function handleWistiaMessage_(event) {
      ...
      var playerEvent = data["args"] ? data["args"][0] : void 0;
      if (playerEvent === "statechange") {
        var state = data["args"] ? data["args"][1] : void 0;
      ...
      if (playerEvent == "mutechange") {
        var isMuted = data["args"] ? data["args"][1] : void 0;
    ...
    return AmpWistiaPlayer2;
  }(AMP.BaseElement);
  AMP.registerElement(TAG2, AmpWistiaPlayer);
})();
