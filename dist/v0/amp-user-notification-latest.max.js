(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-user-notification",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpUserNotification = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto2.buildCallback = function buildCallback() {
      ...
      var userNotificationManagerPromise = getServicePromiseForDoc(ampdoc2, SERVICE_ID);
  ...
  var UserNotificationManager = /* @__PURE__ */ function() {
    function UserNotificationManager2(ampdoc2) {
      this.ampdoc = ampdoc2;
  ...
  function installUserNotificationManagerForTesting(ampdoc2) {
    registerServiceBuilderForDoc(ampdoc2, SERVICE_ID, UserNotificationManager);
  }
