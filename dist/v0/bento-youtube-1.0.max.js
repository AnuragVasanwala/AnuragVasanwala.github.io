...
(function() {
  ...
  function VideoWrapperWithRef(_ref, ref) {
    ...
    return createElement(ContainWrapper, {
      ...
      layout: true,
      paint: true
    }, load && createElement(Component, _extends6({}, rest, {
      ref: playerRef,
      loading: loading,
      muted: muted,
      loop: loop,
  ...
  function VideoIframeInternalWithRef(_ref, ref) {
    ...
    return createElement("iframe", _extends7({}, rest, {
      ref: iframeRef,
  ...
  function VideoIframeWithRef(props, ref) {
    return createElement(VideoWrapper, _extends7({
      ref: ref
    }, props, {
  ...
  function BentoYoutubeWithRef(_ref, ref) {
    ...
    return createElement(VideoIframe, _extends8({
      ref: ref
    }, rest, {
      autoplay: autoplay,
      src: src,
  ...
  // extensions/amp-youtube/1.0/build/bento-youtube.js
  function defineElement() {
    customElements.define("bento-youtube", BaseElement3.CustomElement(BaseElement3));
  }
  defineElement();
})();
...
//# sourceMappingURL=bento-youtube-1.0.max.js.map
