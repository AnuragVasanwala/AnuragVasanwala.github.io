...
(function() {
  ...
  function forEachContained(node, callback, includeSelf) {
    ...
    if (closest2.node == node) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose4(closest2.children), _step2; !(_step2 = _iterator2()).done; ) {
  ...
  function getOptions(element, mu) {
    ...
    optionChildren.filter(function(el) {
      ...
      var optionChild = createElement(BentoSelectorOption, _extends6({}, props));
      options.push(option);
  ...
  // extensions/amp-selector/1.0/build/bento-selector.js
  function defineElement() {
    customElements.define("bento-selector", BaseElement2.CustomElement(BaseElement2));
  }
  defineElement();
})();
...
//# sourceMappingURL=bento-selector-1.0.max.js.map
