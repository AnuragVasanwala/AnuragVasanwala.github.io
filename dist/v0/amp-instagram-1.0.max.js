(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-instagram",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  var _excluded3 = ["captioned", "onLoad", "requestResize", "shortcode", "title"];
  function _extends9() {
  ...
  var MATCHES_MESSAGING_ORIGIN = function MATCHES_MESSAGING_ORIGIN2(origin) {
    return origin === "https://www.instagram.com";
  };
  function BentoInstagramWithRef(_ref, ref) {
    var captioned = _ref.captioned, onLoad = _ref.onLoad, requestResize = _ref.requestResize, shortcode = _ref.shortcode, _ref$title = _ref.title, title = _ref$title === void 0 ? "Instagram" : _ref$title, rest = _objectWithoutPropertiesLoose5(_ref, _excluded3);
    var _useState = useState(NO_HEIGHT_STYLE), heightStyle = _useState[0], setHeightStyle = _useState[1];
    var _useState2 = useState(0), opacity = _useState2[0], setOpacity = _useState2[1];
    ...
    return createElement(IframeEmbed, _extends9({
      ...
      ref: ref,
      src: "https://www.instagram.com/p/" + encodeURIComponent(shortcode) + "/embed/" + (captioned ? "captioned/" : "") + "?cr=1&v=12",
      title: title,
      wrapperStyle: heightStyle
    }, rest));
  }
  var BentoInstagram = forwardRef(BentoInstagramWithRef);
  BentoInstagram.displayName = "Instagram";

  // extensions/amp-instagram/1.0/base-element.js
  ...
  BaseElement2["Component"] = BentoInstagram;
  BaseElement2["loadable"] = true;
  BaseElement2["unloadOnPause"] = true;
  BaseElement2["props"] = {
    "captioned": {
      attr: "data-captioned"
    },
  ...
  // build/amp-instagram-1.0.css.js
  var CSS2 = "amp-instagram{display:block;overflow:hidden;position:relative}amp-instagram:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-instagram/1.0/amp-instagram.css*/";

  // extensions/amp-instagram/1.0/amp-instagram.js
  ...
  var TAG2 = "amp-instagram";
  var AmpInstagram = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpInstagram2, _BaseElement);
    var _super = _createSuper4(AmpInstagram2);
    function AmpInstagram2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpInstagram2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-instagram"), 'expected global "bento" or specific "bento-instagram" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    _proto.init = function init() {
      var _this = this;
    ...
    return AmpInstagram2;
  }(BaseElement2);
  AMP.registerElement(TAG2, AmpInstagram, CSS2);
})();
...
//# sourceMappingURL=amp-instagram-1.0.max.js.map
