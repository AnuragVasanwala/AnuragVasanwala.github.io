(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-story-auto-analytics",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var buildGtagConfig = function buildGtagConfig2(gtagId) {
    return {
      "vars": {
        "gtag_id": gtagId
      },
  ...
  var buildAutoAnalyticsTemplate = function buildAutoAnalyticsTemplate2(element) {
    var html2 = htmlFor(element);
    return html2(_templateObject || (_templateObject = _taggedTemplateLiteralLoose([' <amp-analytics data-credentials="include" type="gtag">\n    <script type="application/json"><\/script>\n  </amp-analytics>'])));
  };
  var AmpStoryAutoAnalytics = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpStoryAutoAnalytics2, _AMP$BaseElement);
    var _super = _createSuper(AmpStoryAutoAnalytics2);
    function AmpStoryAutoAnalytics2(element) {
      return _super.call(this, element);
    }
    var _proto = AmpStoryAutoAnalytics2.prototype;
    _proto.buildCallback = function buildCallback() {
      Services.extensionsFor(this.win).installExtensionForDoc(this.getAmpDoc(), "amp-analytics");
      var analyticsEl = buildAutoAnalyticsTemplate(this.element);
      var configEl = analyticsEl.querySelector("script");
      var gtagId = devAssert2(this.element.getAttribute("gtag-id"));
      var analyticsJson = buildGtagConfig(gtagId);
    ...
    return AmpStoryAutoAnalytics2;
  }(AMP.BaseElement);
  AMP.registerElement("amp-story-auto-analytics", AmpStoryAutoAnalytics);
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
})});
//# sourceMappingURL=amp-story-auto-analytics-0.1.max.js.map
