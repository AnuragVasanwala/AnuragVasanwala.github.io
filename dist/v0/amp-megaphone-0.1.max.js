(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-megaphone",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpMegaphone = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    var _proto = AmpMegaphone2.prototype;
    _proto.preconnectCallback = function preconnectCallback(opt_onLayout) {
      ...
      preconnect.url(ampdoc2, this.baseUrl_, opt_onLayout);
      preconnect.url(ampdoc2, "https://assets.megaphone.fm", opt_onLayout);
      preconnect.url(ampdoc2, "https://megaphone.imgix.net", opt_onLayout);
    };
    ...
    _proto.getIframeSrc_ = function getIframeSrc_() {
      this.updateBaseUrl_();
      var mediaid = userAssert2(this.element.getAttribute("data-playlist") || this.element.getAttribute("data-episode"), "data-playlist or data-episode is required for <amp-megaphone> %s", this.element);
    ...
    _proto.updateBaseUrl_ = function updateBaseUrl_() {
    ...
    _proto.handleMegaphoneMessages_ = function handleMegaphoneMessages_(event) {
