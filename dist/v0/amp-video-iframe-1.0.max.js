(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-video-iframe",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
    ...
    if (!observer) {
      observer = createViewportObserver(function(entries) {
        ...
        for (var i4 = entries.length - 1; i4 >= 0; i4--) {
          var target = entries[i4].target;
          if (seen.has(target)) {
            continue;
          }
          seen.add(target);
          observer.unobserve(target);
          intersectionDeferreds.get(target).resolve(entries[i4]);
  ...
  function VideoIframeInternalWithRef(_ref, ref) {
    ...
    var onMessageRef = usePropRef(onMessage2);
    useLayoutEffect(function() {
  ...
  var PreactBaseElement = /* @__PURE__ */ function(_BaseElement) {
    ...
    _proto.buildCallback = function buildCallback() {
      ...
      this.observer.observe(this.element, _extends9({
        attributes: true
    ...
    _proto.rerender_ = function rerender_() {
      ...
      var v3 = createElement(WithAmpContext, _extends9({}, this.context_), comp);
  ...
  // extensions/amp-video-iframe/1.0/base-element.js
  ...
  BaseElement3["Component"] = VideoIframe;
  BaseElement3["props"] = {
    "autoplay": {
      attr: "autoplay",
      type: "boolean"
  ...
  // build/amp-video-iframe-1.0.css.js
  var CSS4 = "amp-video-iframe{display:block;overflow:hidden;position:relative}amp-video-iframe:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-video-iframe/1.0/amp-video-iframe.css*/";
  ...
  var BUBBLE_MESSAGE_EVENTS = [VideoEvents_Enum.PLAYING, VideoEvents_Enum.PAUSE, VideoEvents_Enum.ENDED, VideoEvents_Enum.MUTED, VideoEvents_Enum.UNMUTED, VideoEvents_Enum.AD_START, VideoEvents_Enum.AD_END];

  // extensions/amp-video-iframe/1.0/amp-video-iframe.js
  ...
  var TAG2 = "amp-video-iframe";
  function getIntersectionRatioMinAutoplay(element) {
    return measureIntersection(element).then(function(_ref) {
      var intersectionRatio = _ref.intersectionRatio;
      return intersectionRatio < MIN_VISIBILITY_RATIO_FOR_AUTOPLAY ? 0 : intersectionRatio;
    });
  }
  var AmpVideoIframe = /* @__PURE__ */ function(_BaseElement) {
    _inherits6(AmpVideoIframe2, _BaseElement);
    var _super = _createSuper6(AmpVideoIframe2);
    function AmpVideoIframe2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpVideoIframe2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-video-iframe"), 'expected global "bento" or specific "bento-video-iframe" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpVideoIframe2;
  }(BaseElement3);
  function onMessage(e3) {
    var _e$data, _e$data2, _e$data3;
    var currentTarget = e3.currentTarget;
    var method = (_e$data = e3.data) == null ? void 0 : _e$data["method"];
    var messageId = (_e$data2 = e3.data) == null ? void 0 : _e$data2["id"];
    if (method) {
      if (method == "getIntersection") {
        getIntersectionRatioMinAutoplay(currentTarget).then(function(intersectionRatio) {
          postMessageWhenAvailable(currentTarget, JSON.stringify(dict({
            "id": messageId,
    ...
    var event = (_e$data3 = e3.data) == null ? void 0 : _e$data3["event"];
    if (!event) {
      return;
    }
    if (event === "analytics") {
    ...
    if (event === "error" || event === "canplay" || BUBBLE_MESSAGE_EVENTS.indexOf(event) > -1) {
      currentTarget.dispatchEvent(createCustomEvent(window, event, null, {
        bubbles: true,
        cancelable: true
      }));
      return;
  ...
  var makeMethodMessage = function makeMethodMessage2(method) {
  ...
  AMP.registerElement(TAG2, AmpVideoIframe, CSS4);
})();
...
//# sourceMappingURL=amp-video-iframe-1.0.max.js.map
