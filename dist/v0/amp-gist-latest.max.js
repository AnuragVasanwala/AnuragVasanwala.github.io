(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-gist",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpGist = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpGist2, _AMP$BaseElement);
    var _super = _createSuper(AmpGist2);
    function AmpGist2(element) {
      var _this;
      _this = _super.call(this, element);
      _this.iframe_ = null;
      return _this;
    }
    var _proto = AmpGist2.prototype;
    ...
    _proto.layoutCallback = function layoutCallback() {
      var _this2 = this;
      var iframe = getIframe(this.win, this.element, "github");
