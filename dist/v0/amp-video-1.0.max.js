(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-video",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  // build/amp-video-1.0.css.js
  var CSS2 = "amp-video{display:block;overflow:hidden;position:relative}amp-video:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-video/1.0/amp-video.css*/";
  ...
  BaseElement2["shadowCss"] = CSS3 + CSS4;
  ...
  // extensions/amp-video/1.0/amp-video.js
  ...
  var TAG2 = "amp-video";
  var AmpVideo = /* @__PURE__ */ function(_VideoBaseElement) {
    _inherits5(AmpVideo2, _VideoBaseElement);
    var _super = _createSuper5(AmpVideo2);
    function AmpVideo2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpVideo2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert2(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-video"), 'expected global "bento" or specific "bento-video" experiment to be enabled');
      return _VideoBaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpVideo2;
  }(VideoBaseElement);
  AMP.registerElement(TAG2, AmpVideo, CSS2);
})();
...
//# sourceMappingURL=amp-video-1.0.max.js.map
