(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-kaltura-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpKaltura = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpKaltura2, _AMP$BaseElement);
    var _super = _createSuper(AmpKaltura2);
    function AmpKaltura2(element) {
      var _this;
    ...
    var _proto = AmpKaltura2.prototype;
    _proto.preconnectCallback = function preconnectCallback(opt_onLayout) {
      Services.preconnectFor(this.win).url(this.getAmpDoc(), "https://" + encodeURIComponent(this.serviceUrl_) + opt_onLayout);
    };
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      return isLayoutSizeDefined(layout);
    };
    _proto.buildCallback = function buildCallback() {
      this.partnerId_ = userAssert2(this.element.getAttribute("data-partner"), "The data-partner attribute is required for <amp-kaltura-player> %s", this.element);
      setIsMediaComponent(this.element);
      this.entryId_ = this.element.getAttribute("data-entryid") || "default";
      this.serviceUrl_ = this.element.getAttribute("data-service-url") || "cdnapisec.kaltura.com";
    };
    _proto.layoutCallback = function layoutCallback() {
      ...
      var src = "https://" + encodeURIComponent(this.serviceUrl_) + "/p/" + encodeURIComponent(this.partnerId_) + "/sp/" + encodeURIComponent(this.partnerId_) + "00/embedIframeJs/uiconf_id/" + encodeURIComponent(uiconfId) + "/partner_id/" + encodeURIComponent(this.partnerId_) + "?iframeembed=true&playerId=kaltura_player_amp&entry_id=" + encodeURIComponent(this.entryId_);
      var params = getDataParamsFromAttributes(this.element, function(key) {
    ...
    _proto.createPlaceholderCallback = function createPlaceholderCallback() {
      ...
      var src = "https://" + encodeURIComponent(this.serviceUrl_) + "/p/" + encodeURIComponent(this.partnerId_) + "/thumbnail/entry_id/" + encodeURIComponent(this.entryId_);
      if (width) {
        src += "/width/" + width;
      }
      if (height) {
