(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-springboard-player",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpSpringboardPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpSpringboardPlayer2, _AMP$BaseElement);
    var _super = _createSuper(AmpSpringboardPlayer2);
    function AmpSpringboardPlayer2(element) {
      var _this;
    ...
    var _proto = AmpSpringboardPlayer2.prototype;
    ...
    _proto.buildCallback = function buildCallback() {
      ...
      this.mode_ = userAssert2(this.element.getAttribute("data-mode"), "The data-mode attribute is required for <amp-springboard-player> %s", this.element);
      this.contentId_ = userAssert2(this.element.getAttribute("data-content-id"), "The data-content-id attribute is required for<amp-springboard-player> %s", this.element);
      this.domain_ = userAssert2(this.element.getAttribute("data-domain"), "The data-domain attribute is required for <amp-springboard-player> %s", this.element);
      this.siteId_ = userAssert2(this.element.getAttribute("data-site-id"), "The data-site-id attribute is required for<amp-springboard-player> %s", this.element);
      this.playerId_ = userAssert2(this.element.getAttribute("data-player-id"), "The data-player-id attribute is required for<amp-springboard-player> %s", this.element);
    };
    ...
    _proto.pauseCallback = function pauseCallback() {
      if (this.iframe_ && this.iframe_.contentWindow) {
        this.iframe_.contentWindow.postMessage("ampPause", "*");
      }
    };
    _proto.createPlaceholderCallback = function createPlaceholderCallback() {
      ...
      placeholder.setAttribute("src", "https://www.springboardplatform.com/storage/" + (this.mode_ == "playlist" ? "default/snapshots/default_snapshot.png" : encodeURIComponent(this.domain_) + "/snapshots/" + encodeURIComponent(this.contentId_) + ".jpg"));
      return placeholder;
    };
    return AmpSpringboardPlayer2;
  }(AMP.BaseElement);
