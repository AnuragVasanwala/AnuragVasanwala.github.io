(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-vimeo",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  function postMessageWhenAvailable(iframe, message) {
    var _iframe$contentWindow;
    iframe == null ? void 0 : (_iframe$contentWindow = iframe.contentWindow) == null ? void 0 : _iframe$contentWindow.postMessage(message, "*");
  }
  ...
  function VideoWrapperWithRef(_ref, ref) {
    ...
    return createElement(ContainWrapper, {
      ...
      layout: true,
      paint: true
    }, load && createElement(Component, _extends4({}, rest, {
      ref: playerRef,
      loading: loading,
      muted: muted,
      loop: loop,
  ...
  function VideoIframeInternalWithRef(_ref, ref) {
    ...
    return createElement("iframe", _extends5({}, rest, {
      ref: iframeRef,
  ...
  function VideoIframeWithRef(props, ref) {
    return createElement(VideoWrapper, _extends5({
      ref: ref
    }, props, {
  ...
  var getVimeoOriginRegExp = function getVimeoOriginRegExp2() {
    return /^(https?:)?\/\/((player|www)\.)?vimeo.com(?=$|\/)/;
  };
  var VIMEO_EVENTS = {
  ...
  function getVimeoIframeSrc(videoid, autoplay, doNotTrack) {
    return addParamsToUrl("https://player.vimeo.com/video/" + encodeURIComponent(videoid), dict({
      "dnt": doNotTrack ? "1" : void 0,
      "muted": autoplay ? "1" : void 0
    }));
  }
  function makeVimeoMessage(method, params) {
    if (params === void 0) {
      params = "";
    }
  ...
  function listenToVimeoEvents(iframe) {
    Object.keys(VIMEO_EVENTS).forEach(function(event) {
      postMessageWhenAvailable(iframe, makeVimeoMessage("addEventListener", event));
    });
  }

  // extensions/amp-vimeo/1.0/component.js
  var _excluded3 = ["autoplay", "doNotTrack", "onLoad", "videoid"];
  function _extends6() {
  ...
  function BentoVimeoWithRef(_ref, ref) {
    var _ref$autoplay = _ref.autoplay, autoplay = _ref$autoplay === void 0 ? false : _ref$autoplay, _ref$doNotTrack = _ref.doNotTrack, doNotTrack = _ref$doNotTrack === void 0 ? false : _ref$doNotTrack, onLoad = _ref.onLoad, videoid = _ref.videoid, rest = _objectWithoutPropertiesLoose6(_ref, _excluded3);
    var origin = useMemo(getVimeoOriginRegExp, []);
    var src = useMemo(function() {
      return getVimeoIframeSrc(videoid, autoplay, doNotTrack);
    ...
    var onMessage = useCallback(function(e3) {
      ...
      var data = objOrParseJson(e3.data);
      if (!data) {
        return;
      }
    ...
    var onIframeLoad = useCallback(function(e3) {
      postMessageWhenAvailable(e3.currentTarget, makeVimeoMessage("ping"));
    }, []);
  ...
  var BentoVimeo = forwardRef(BentoVimeoWithRef);
  BentoVimeo.displayName = "BentoVimeo";
  ...
  // extensions/amp-vimeo/1.0/base-element.js
  ...
  BaseElement3["Component"] = BentoVimeo;
  BaseElement3["props"] = {
    "autoplay": {
      attr: "autoplay",
      type: "boolean"
  ...
  // build/amp-vimeo-1.0.css.js
  var CSS4 = "amp-vimeo{display:block;overflow:hidden;position:relative}amp-vimeo:not(.i-amphtml-built)>:not([placeholder]):not([slot=i-amphtml-svc]){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-vimeo/1.0/amp-vimeo.css*/";

  // extensions/amp-vimeo/1.0/amp-vimeo.js
  ...
  var TAG2 = "amp-vimeo";
  var AmpVimeo = /* @__PURE__ */ function(_BaseElement) {
    _inherits6(AmpVimeo2, _BaseElement);
    var _super = _createSuper6(AmpVimeo2);
    function AmpVimeo2() {
      return _super.apply(this, arguments);
    }
    var _proto = AmpVimeo2.prototype;
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-vimeo"), 'expected global "bento" or specific "bento-vimeo" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpVimeo2;
  }(BaseElement3);
  AMP.registerElement(TAG2, AmpVimeo, CSS4);
})();
...
//# sourceMappingURL=amp-vimeo-1.0.max.js.map
