(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-facebook",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TYPE = "facebook";
  var AmpFacebook = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpFacebook2, _AMP$BaseElement);
    var _super = _createSuper(AmpFacebook2);
    AmpFacebook2.createLoaderLogoCallback = function createLoaderLogoCallback(element) {
      return createLoaderLogo(element);
    };
    function AmpFacebook2(element) {
      var _this;
    ...
    var _proto = AmpFacebook2.prototype;
    ...
    _proto.layoutCallback = function layoutCallback() {
      var _this2 = this;
      var embedAs = this.element.getAttribute("data-embed-as");
      userAssert(!embedAs || ["post", "video", "comment"].indexOf(embedAs) !== -1, 'Attribute data-embed-as for <amp-facebook> value is wrong, should be "post", "video" or "comment" but was: %s', embedAs);
