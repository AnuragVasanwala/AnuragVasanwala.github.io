(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-twitter",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var TYPE = "twitter";
  var AmpTwitter = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpTwitter2, _AMP$BaseElement);
    var _super = _createSuper(AmpTwitter2);
    ...
    _proto.preconnectCallback = function preconnectCallback(opt_onLayout) {
      ...
      preloadBootstrap(this.win, TYPE, ampdoc2, preconnect);
      preconnect.preload(ampdoc2, "https://platform.twitter.com/widgets.js", "script");
      preconnect.url(ampdoc2, "https://syndication.twitter.com", opt_onLayout);
      preconnect.url(ampdoc2, "https://pbs.twimg.com", opt_onLayout);
      preconnect.url(ampdoc2, "https://cdn.syndication.twimg.com", opt_onLayout);
    };
    ...
    _proto.layoutCallback = function layoutCallback() {
      var _this2 = this;
      var iframe = getIframe(this.win, this.element, TYPE, null, {
        allowFullscreen: true
      });
      iframe.title = this.element.title || "Twitter";
      applyFillContent(iframe);
      this.updateForLoadingState_();
      listenFor(iframe, MessageType_Enum.EMBED_SIZE, function(data) {
        _this2.updateForSuccessState_(data["height"]);
      }, true);
      listenFor(iframe, MessageType_Enum.NO_CONTENT, function() {
    ...
    _proto.updateForLoadingState_ = function updateForLoadingState_() {
      var _this3 = this;
      var height;
      this.measureMutateElement(function() {
        height = _this3.element.getBoundingClientRect().height;
      }, function() {
        _this3.forceChangeHeight(height);
      });
    };
    _proto.updateForSuccessState_ = function updateForSuccessState_(height) {
      var _this4 = this;
      this.mutateElement(function() {
        _this4.toggleLoading(false);
        if (_this4.userPlaceholder_) {
          _this4.togglePlaceholder(false);
        }
        _this4.forceChangeHeight(height);
      });
    };
    _proto.updateForFailureState_ = function updateForFailureState_() {
      var _this5 = this;
      ...
      this.mutateElement(function() {
        ...
        if (content) {
          _this5.forceChangeHeight(content.offsetHeight);
        }
      });
    };
