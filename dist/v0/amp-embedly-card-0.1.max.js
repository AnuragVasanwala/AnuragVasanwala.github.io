(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-embedly-card",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-embedly-card/0.1/amp-embedly-key.js
  ...
  var TAG = "amp-embedly-key";
  var AmpEmbedlyKey = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits(AmpEmbedlyKey2, _AMP$BaseElement);
    var _super = _createSuper(AmpEmbedlyKey2);
    function AmpEmbedlyKey2(element) {
      return _super.call(this, element);
    }
    var _proto = AmpEmbedlyKey2.prototype;
    _proto.buildCallback = function buildCallback() {
      userAssert2(this.element.getAttribute("value"), "The value attribute is required for <%s>", TAG, this.element);
    };
  ...
  var TAG4 = "amp-embedly-card";
  var API_KEY_ATTR_NAME = "data-card-key";
  var AmpEmbedlyCard = /* @__PURE__ */ function(_AMP$BaseElement) {
    _inherits2(AmpEmbedlyCard2, _AMP$BaseElement);
    var _super = _createSuper2(AmpEmbedlyCard2);
    function AmpEmbedlyCard2(element) {
      var _this;
    ...
    _proto.buildCallback = function buildCallback() {
      userAssert2(this.element.getAttribute("data-url"), "The data-url attribute is required for <%s> %s", TAG4, this.element);
      var ampEmbedlyKeyElement = document.querySelector(TAG);
    ...
    _proto.layoutCallback = function layoutCallback() {
      ...
      var iframe = getIframe(this.win, this.element, "embedly");
  ...
  // extensions/amp-embedly-card/0.1/amp-embedly-card.js
  AMP.registerElement(TAG4, AmpEmbedlyCard);
  AMP.registerElement(TAG, AmpEmbedlyKey);
})();
