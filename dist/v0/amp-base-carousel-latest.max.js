(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-base-carousel",ev:"0.1",l:true,f:(function(AMP,_){
(function() {
  ...
  var AmpCarousel = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _proto.onKeydown_ = function onKeydown_(event) {
      var isRight = event.key === Keys_Enum.RIGHT_ARROW;
      var isLeft = event.key === Keys_Enum.LEFT_ARROW;
      if (!isRight && !isLeft) {
        return;
      }
    ...
    _proto.goCallback = function goCallback(dir) {
      if (dir === 1) {
