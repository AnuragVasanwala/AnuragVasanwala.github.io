(self.AMP=self.AMP||[]).push({m:0,v:"2109221842260",n:"amp-twitter",ev:"1.0",l:false,f:(function(AMP,_){
(function() {
  ...
  // extensions/amp-twitter/1.0/component.js
  var _excluded4 = ["cards", "conversation", "limit", "momentid", "onError", "onLoad", "options", "requestResize", "style", "timelineScreenName", "timelineSourceType", "timelineUserId", "title", "tweetLimit", "tweetid"];
  function _extends10() {
  ...
  function BentoTwitterWithRef(_ref, ref) {
    var cards = _ref.cards, conversation = _ref.conversation, limit = _ref.limit, momentid = _ref.momentid, onError = _ref.onError, onLoad = _ref.onLoad, optionsProps = _ref.options, requestResize = _ref.requestResize, style = _ref.style, timelineScreenName = _ref.timelineScreenName, timelineSourceType = _ref.timelineSourceType, timelineUserId = _ref.timelineUserId, title = _ref.title, tweetLimit = _ref.tweetLimit, tweetid = _ref.tweetid, rest = _objectWithoutPropertiesLoose6(_ref, _excluded4);
    ...
    var messageHandler = useCallback(function(event) {
      ...
      if (data["type"] == MessageType_Enum.EMBED_SIZE) {
        ...
        onErrorRef.current == null ? void 0 : onErrorRef.current();
      }
    ...
    }, [cards, conversation, limit, momentid, optionsProps, timelineScreenName, timelineSourceType, timelineUserId, tweetLimit, tweetid]);
  ...
  var BentoTwitter = forwardRef(BentoTwitterWithRef);
  BentoTwitter.displayName = "BentoTwitter";

  // extensions/amp-twitter/1.0/base-element.js
  ...
  BaseElement2["Component"] = BentoTwitter;
  BaseElement2["props"] = {
    "title": {
      attr: "title"
    },
    ...
    "options": createParseAttrsWithPrefix("data-")
  };
  ...
  // extensions/amp-twitter/1.0/amp-twitter.js
  var _templateObject;
  ...
  var TAG2 = "amp-twitter";
  var TYPE2 = "twitter";
  var AmpTwitter = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpTwitter2, _BaseElement);
    var _super = _createSuper4(AmpTwitter2);
    function AmpTwitter2(element) {
      return _super.call(this, element);
    }
    AmpTwitter2.createLoaderLogoCallback = function createLoaderLogoCallback(element) {
    ...
    AmpTwitter2.getPreconnects = function getPreconnects(element) {
    ...
    var _proto = AmpTwitter2.prototype;
    _proto.init = function init() {
      var _this = this;
      return dict({
    ...
    _proto.isLayoutSupported = function isLayoutSupported(layout) {
      userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-twitter"), 'expected global "bento" or specific "bento-twitter" experiment to be enabled');
      return _BaseElement.prototype.isLayoutSupported.call(this, layout);
    };
    return AmpTwitter2;
  }(BaseElement2);
  AMP.registerElement(TAG2, AmpTwitter);
})();
...
//# sourceMappingURL=amp-twitter-1.0.max.js.map
