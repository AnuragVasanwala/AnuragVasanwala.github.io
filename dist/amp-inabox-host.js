(function() {
  ...
  var READ_ONLY_MESSAGES = [MessageType_Enum.SEND_POSITIONS];
  ...
  var InaboxMessagingHost = /* @__PURE__ */ function() {
    function InaboxMessagingHost2(win, iframes) {
      ...
      this.msgObservable_.listen(MessageType_Enum.SEND_POSITIONS, this.handleSendPositions_);
      this.msgObservable_.listen(MessageType_Enum.FULL_OVERLAY_FRAME, this.handleEnterFullOverlay_);
      this.msgObservable_.listen(MessageType_Enum.CANCEL_FULL_OVERLAY_FRAME, this.handleCancelFullOverlay_);
    }
    ...
    _proto2.sendPosition_ = function sendPosition_(request, source, data) {
      ...
      source.postMessage(serializeMessage(MessageType_Enum.POSITION, request.sentinel, data), "*");
    };
    _proto2.handleEnterFullOverlay_ = function handleEnterFullOverlay_(iframe, request, source, origin) {
      this.frameOverlayManager_.expandFrame(iframe, function(boxRect) {
        source.postMessage(serializeMessage(MessageType_Enum.FULL_OVERLAY_FRAME_RESPONSE, request.sentinel, dict({
          "success": true,
          "boxRect": boxRect
        })), origin);
      });
    ...
    _proto2.handleCancelFullOverlay_ = function handleCancelFullOverlay_(iframe, request, source, origin) {
      this.frameOverlayManager_.collapseFrame(iframe, function(boxRect) {
        source.postMessage(serializeMessage(MessageType_Enum.CANCEL_FULL_OVERLAY_FRAME_RESPONSE, request.sentinel, dict({
          "success": true,
          "boxRect": boxRect
        })), origin);
      });
  ...
  var InaboxHost = function InaboxHost2(win) {
    ...
    var processMessageFn = function(evt) {
      try {
